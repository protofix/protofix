...
package fix41listcancelrequest
...
var (
	FIX41ListCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41ListCancelRequest}
	FIX41ListCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41ListCancelRequest}
)

// FIX41ListCancelRequest is a FIX.4.1 format of the ListCancelRequest message which maps the codecs into individual fields.
var FIX41ListCancelRequest = f0.Format{
