...
var (
	FIX41DontKnowTradeMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41DontKnowTrade}
	FIX41DontKnowTradeUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41DontKnowTrade}
)

// FIX41DontKnowTrade is a FIX.4.1 format of the DontKnowTrade message which maps the codecs into individual fields.
var FIX41DontKnowTrade = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ExecID17:                f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{1}},
		DKReason127:             f0.Fld{Req, f0.ASCII, f0.String("A" /* UNKNOWN_SYMBOL */, "B" /* WRONG_SIDE */, "C" /* QUANTITY_EXCEEDS_ORDER */, "D" /* NO_MATCHING_ORDER */, "E" /* PRICE_EXCEEDS_LIMIT */, "Z" /* OTHER */), f0.Con{1}},
		...
		LastShares32:            f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
