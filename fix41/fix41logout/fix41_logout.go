...
var (
	FIX41LogoutMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41Logout}
	FIX41LogoutUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41Logout}
)

// FIX41Logout is a FIX.4.1 format of the Logout message which maps the codecs into individual fields.
var FIX41Logout = f0.Format{
