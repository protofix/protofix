...
var (
	FIX41TestRequestMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41TestRequest}
	FIX41TestRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41TestRequest}
)

// FIX41TestRequest is a FIX.4.1 format of the TestRequest message which maps the codecs into individual fields.
var FIX41TestRequest = f0.Format{
