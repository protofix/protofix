...
var (
	FIX41ListExecuteMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41ListExecute}
	FIX41ListExecuteUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41ListExecute}
)

// FIX41ListExecute is a FIX.4.1 format of the ListExecute message which maps the codecs into individual fields.
var FIX41ListExecute = f0.Format{
