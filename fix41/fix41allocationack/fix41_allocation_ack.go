...
var (
	FIX41AllocationACKMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41AllocationACK}
	FIX41AllocationACKUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41AllocationACK}
)

// FIX41AllocationACK is a FIX.4.1 format of the AllocationACK message which maps the codecs into individual fields.
var FIX41AllocationACK = f0.Format{
