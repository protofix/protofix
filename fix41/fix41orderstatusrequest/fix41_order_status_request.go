...
package fix41orderstatusrequest
...
var (
	FIX41OrderStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41OrderStatusRequest}
	FIX41OrderStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41OrderStatusRequest}
)

// FIX41OrderStatusRequest is a FIX.4.1 format of the OrderStatusRequest message which maps the codecs into individual fields.
var FIX41OrderStatusRequest = f0.Format{
