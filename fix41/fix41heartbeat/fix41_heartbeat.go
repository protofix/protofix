...
var (
	FIX41HeartbeatMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41Heartbeat}
	FIX41HeartbeatUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41Heartbeat}
)

// FIX41Heartbeat is a FIX.4.1 format of the Heartbeat message which maps the codecs into individual fields.
var FIX41Heartbeat = f0.Format{
	Fields: map[int]f0.Codec{
		...
		TestReqID112:            f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{1}},
