...
var (
	FIX41ResendRequestMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41ResendRequest}
	FIX41ResendRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41ResendRequest}
)

// FIX41ResendRequest is a FIX.4.1 format of the ResendRequest message which maps the codecs into individual fields.
var FIX41ResendRequest = f0.Format{
