...
package fix41indicationofinterest
...
var (
	FIX41IndicationofInterestMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41IndicationofInterest}
	FIX41IndicationofInterestUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41IndicationofInterest}
)

// FIX41IndicationofInterest is a FIX.4.1 format of the IndicationofInterest message which maps the codecs into individual fields.
var FIX41IndicationofInterest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		IOIid23:                 f0.Fld{Req, f0.ASCII, f0.String(), f0.Con{1}},
		IOITransType28:          f0.Fld{Req, f0.ASCII, f0.String("C" /* CANCEL */, "N" /* NEW */, "R" /* REPLACE */), f0.Con{1}},
		IOIRefID26:              f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{1}},
