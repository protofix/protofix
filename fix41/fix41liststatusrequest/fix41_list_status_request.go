...
package fix41liststatusrequest
...
var (
	FIX41ListStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41ListStatusRequest}
	FIX41ListStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41ListStatusRequest}
)

// FIX41ListStatusRequest is a FIX.4.1 format of the ListStatusRequest message which maps the codecs into individual fields.
var FIX41ListStatusRequest = f0.Format{
