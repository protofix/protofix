...
package fix41ordercancelreplacerequest
...
var (
	FIX41OrderCancelReplaceRequestMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41OrderCancelReplaceRequest}
	FIX41OrderCancelReplaceRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41OrderCancelReplaceRequest}
)

// FIX41OrderCancelReplaceRequest is a FIX.4.1 format of the OrderCancelReplaceRequest message which maps the codecs into individual fields.
var FIX41OrderCancelReplaceRequest = f0.Format{
