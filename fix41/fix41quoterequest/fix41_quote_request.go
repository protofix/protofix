...
var (
	FIX41QuoteRequestMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41QuoteRequest}
	FIX41QuoteRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41QuoteRequest}
)

// FIX41QuoteRequest is a FIX.4.1 format of the QuoteRequest message which maps the codecs into individual fields.
var FIX41QuoteRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteReqID131:           f0.Fld{Req, f0.ASCII, f0.String(), f0.Con{1}},
