...
var (
	FIX41QuoteMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41Quote}
	FIX41QuoteUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41Quote}
)

// FIX41Quote is a FIX.4.1 format of the Quote message which maps the codecs into individual fields.
var FIX41Quote = f0.Format{
	...
	Sort: []int{
		...
		BidSpotRate188,          // FLOAT
		OfferSpotRate190,        // FLOAT
		BidForwardPoints189,     // FLOAT
		OfferForwardPoints191,   // FLOAT
		TransactTime60,          // TIME
		FutSettDate64,           // DATE
		OrdType40,               // CHAR
...
const (
	...
	BidSpotRate188          = 188 // FLOAT
	OfferSpotRate190        = 190 // FLOAT
	BidForwardPoints189     = 189 // FLOAT
	OfferForwardPoints191   = 191 // FLOAT
