...
var (
	FIX41NewsMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41News}
	FIX41NewsUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41News}
)

// FIX41News is a FIX.4.1 format of the News message which maps the codecs into individual fields.
var FIX41News = f0.Format{
	Fields: map[int]f0.Codec{
		...
		Headline148:             f0.Fld{Req, f0.ASCII, f0.String(), f0.Con{1}},
