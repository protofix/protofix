...
var (
	FIX41NewOrderListMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41NewOrderList}
	FIX41NewOrderListUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41NewOrderList}
)

// FIX41NewOrderList is a FIX.4.1 format of the NewOrderList message which maps the codecs into individual fields.
var FIX41NewOrderList = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ListID66:                f0.Fld{Req, f0.ASCII, f0.String(), f0.Con{1}},
		WaveNo105:               f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{1}},
		ListSeqNo67:             f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		ListNoOrds68:            f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		ListExecInst69:          f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{1}},
