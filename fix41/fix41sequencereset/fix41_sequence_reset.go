...
var (
	FIX41SequenceResetMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41SequenceReset}
	FIX41SequenceResetUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41SequenceReset}
)

// FIX41SequenceReset is a FIX.4.1 format of the SequenceReset message which maps the codecs into individual fields.
var FIX41SequenceReset = f0.Format{
	Fields: map[int]f0.Codec{
		...
		GapFillFlag123:          f0.Fld{Opt, f0.ASCII, f0.String("N" /* NO */, "Y" /* YES */), f0.Con{1}},
