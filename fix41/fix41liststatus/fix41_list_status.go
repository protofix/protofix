...
var (
	FIX41ListStatusMarshaler   = marshfix.Marshal{Tag: "FIX41", Format: FIX41ListStatus}
	FIX41ListStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX41", Format: FIX41ListStatus}
)

// FIX41ListStatus is a FIX.4.1 format of the ListStatus message which maps the codecs into individual fields.
var FIX41ListStatus = f0.Format{
