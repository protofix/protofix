...
package fix44tradingsessionstatusrequest
...
var (
	FIX44TradingSessionStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44TradingSessionStatusRequest}
	FIX44TradingSessionStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44TradingSessionStatusRequest}
)

// FIX44TradingSessionStatusRequest is a FIX.4.4 format of the TradingSessionStatusRequest message which maps the codecs into individual fields.
var FIX44TradingSessionStatusRequest = f0.Format{
