...
package fix44collateralresponse
...
var (
	FIX44CollateralResponseMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44CollateralResponse}
	FIX44CollateralResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44CollateralResponse}
)

// FIX44CollateralResponse is a FIX.4.4 format of the CollateralResponse message which maps the codecs into individual fields.
var FIX44CollateralResponse = f0.Format{
