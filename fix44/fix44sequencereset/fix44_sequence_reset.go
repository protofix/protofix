...
var (
	FIX44SequenceResetMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44SequenceReset}
	FIX44SequenceResetUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44SequenceReset}
)

// FIX44SequenceReset is a FIX.4.4 format of the SequenceReset message which maps the codecs into individual fields.
var FIX44SequenceReset = f0.Format{
