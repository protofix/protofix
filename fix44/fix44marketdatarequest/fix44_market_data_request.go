...
package fix44marketdatarequest
...
var (
	FIX44MarketDataRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44MarketDataRequest}
	FIX44MarketDataRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44MarketDataRequest}
)

// FIX44MarketDataRequest is a FIX.4.4 format of the MarketDataRequest message which maps the codecs into individual fields.
var FIX44MarketDataRequest = f0.Format{
