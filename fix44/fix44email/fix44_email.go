...
var (
	FIX44EmailMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44Email}
	FIX44EmailUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44Email}
)

// FIX44Email is a FIX.4.4 format of the Email message which maps the codecs into individual fields.
var FIX44Email = f0.Format{
