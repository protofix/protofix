...
package fix44positionmaintenancerequest
...
var (
	FIX44PositionMaintenanceRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44PositionMaintenanceRequest}
	FIX44PositionMaintenanceRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44PositionMaintenanceRequest}
)

// FIX44PositionMaintenanceRequest is a FIX.4.4 format of the PositionMaintenanceRequest message which maps the codecs into individual fields.
var FIX44PositionMaintenanceRequest = f0.Format{
