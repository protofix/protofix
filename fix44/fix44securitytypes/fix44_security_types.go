...
var (
	FIX44SecurityTypesMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44SecurityTypes}
	FIX44SecurityTypesUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44SecurityTypes}
)

// FIX44SecurityTypes is a FIX.4.4 format of the SecurityTypes message which maps the codecs into individual fields.
var FIX44SecurityTypes = f0.Format{
