...
package fix44securitydefinition
...
var (
	FIX44SecurityDefinitionMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44SecurityDefinition}
	FIX44SecurityDefinitionUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44SecurityDefinition}
)

// FIX44SecurityDefinition is a FIX.4.4 format of the SecurityDefinition message which maps the codecs into individual fields.
var FIX44SecurityDefinition = f0.Format{
