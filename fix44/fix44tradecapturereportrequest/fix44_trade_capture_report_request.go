...
package fix44tradecapturereportrequest
...
var (
	FIX44TradeCaptureReportRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44TradeCaptureReportRequest}
	FIX44TradeCaptureReportRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44TradeCaptureReportRequest}
)

// FIX44TradeCaptureReportRequest is a FIX.4.4 format of the TradeCaptureReportRequest message which maps the codecs into individual fields.
var FIX44TradeCaptureReportRequest = f0.Format{
