...
var (
	FIX44DontKnowTradeMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44DontKnowTrade}
	FIX44DontKnowTradeUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44DontKnowTrade}
)

// FIX44DontKnowTrade is a FIX.4.4 format of the DontKnowTrade message which maps the codecs into individual fields.
var FIX44DontKnowTrade = f0.Format{
