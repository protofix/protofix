...
package fix44registrationinstructions
...
var (
	FIX44RegistrationInstructionsMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44RegistrationInstructions}
	FIX44RegistrationInstructionsUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44RegistrationInstructions}
)

// FIX44RegistrationInstructions is a FIX.4.4 format of the RegistrationInstructions message which maps the codecs into individual fields.
var FIX44RegistrationInstructions = f0.Format{
