...
var (
	FIX44ConfirmationAckMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44ConfirmationAck}
	FIX44ConfirmationAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44ConfirmationAck}
)

// FIX44ConfirmationAck is a FIX.4.4 format of the ConfirmationAck message which maps the codecs into individual fields.
var FIX44ConfirmationAck = f0.Format{
