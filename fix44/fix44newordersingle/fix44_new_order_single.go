...
var (
	FIX44NewOrderSingleMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44NewOrderSingle}
	FIX44NewOrderSingleUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44NewOrderSingle}
)

// FIX44NewOrderSingle is a FIX.4.4 format of the NewOrderSingle message which maps the codecs into individual fields.
var FIX44NewOrderSingle = f0.Format{
