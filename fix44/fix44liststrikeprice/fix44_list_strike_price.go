...
var (
	FIX44ListStrikePriceMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44ListStrikePrice}
	FIX44ListStrikePriceUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44ListStrikePrice}
)

// FIX44ListStrikePrice is a FIX.4.4 format of the ListStrikePrice message which maps the codecs into individual fields.
var FIX44ListStrikePrice = f0.Format{
