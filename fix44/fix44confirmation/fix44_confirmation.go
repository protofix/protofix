...
var (
	FIX44ConfirmationMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44Confirmation}
	FIX44ConfirmationUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44Confirmation}
)

// FIX44Confirmation is a FIX.4.4 format of the Confirmation message which maps the codecs into individual fields.
var FIX44Confirmation = f0.Format{
