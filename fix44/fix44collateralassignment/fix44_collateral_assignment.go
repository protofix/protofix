...
package fix44collateralassignment
...
var (
	FIX44CollateralAssignmentMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44CollateralAssignment}
	FIX44CollateralAssignmentUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44CollateralAssignment}
)

// FIX44CollateralAssignment is a FIX.4.4 format of the CollateralAssignment message which maps the codecs into individual fields.
var FIX44CollateralAssignment = f0.Format{
