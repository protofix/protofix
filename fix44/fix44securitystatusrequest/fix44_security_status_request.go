...
package fix44securitystatusrequest
...
var (
	FIX44SecurityStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44SecurityStatusRequest}
	FIX44SecurityStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44SecurityStatusRequest}
)

// FIX44SecurityStatusRequest is a FIX.4.4 format of the SecurityStatusRequest message which maps the codecs into individual fields.
var FIX44SecurityStatusRequest = f0.Format{
