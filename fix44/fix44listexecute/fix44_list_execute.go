...
var (
	FIX44ListExecuteMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44ListExecute}
	FIX44ListExecuteUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44ListExecute}
)

// FIX44ListExecute is a FIX.4.4 format of the ListExecute message which maps the codecs into individual fields.
var FIX44ListExecute = f0.Format{
