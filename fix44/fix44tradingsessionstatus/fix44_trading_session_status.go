...
package fix44tradingsessionstatus
...
var (
	FIX44TradingSessionStatusMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44TradingSessionStatus}
	FIX44TradingSessionStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44TradingSessionStatus}
)

// FIX44TradingSessionStatus is a FIX.4.4 format of the TradingSessionStatus message which maps the codecs into individual fields.
var FIX44TradingSessionStatus = f0.Format{
