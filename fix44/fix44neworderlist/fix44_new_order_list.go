...
var (
	FIX44NewOrderListMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44NewOrderList}
	FIX44NewOrderListUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44NewOrderList}
)

// FIX44NewOrderList is a FIX.4.4 format of the NewOrderList message which maps the codecs into individual fields.
var FIX44NewOrderList = f0.Format{
