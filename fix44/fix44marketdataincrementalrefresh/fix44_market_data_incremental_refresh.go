...
package fix44marketdataincrementalrefresh
...
var (
	FIX44MarketDataIncrementalRefreshMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44MarketDataIncrementalRefresh}
	FIX44MarketDataIncrementalRefreshUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44MarketDataIncrementalRefresh}
)

// FIX44MarketDataIncrementalRefresh is a FIX.4.4 format of the MarketDataIncrementalRefresh message which maps the codecs into individual fields.
var FIX44MarketDataIncrementalRefresh = f0.Format{
