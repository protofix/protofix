...
var (
	FIX44AdvertisementMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44Advertisement}
	FIX44AdvertisementUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44Advertisement}
)

// FIX44Advertisement is a FIX.4.4 format of the Advertisement message which maps the codecs into individual fields.
var FIX44Advertisement = f0.Format{
