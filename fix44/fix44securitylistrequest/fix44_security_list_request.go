...
package fix44securitylistrequest
...
var (
	FIX44SecurityListRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44SecurityListRequest}
	FIX44SecurityListRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44SecurityListRequest}
)

// FIX44SecurityListRequest is a FIX.4.4 format of the SecurityListRequest message which maps the codecs into individual fields.
var FIX44SecurityListRequest = f0.Format{
