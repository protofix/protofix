...
package fix44derivativesecuritylist
...
var (
	FIX44DerivativeSecurityListMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44DerivativeSecurityList}
	FIX44DerivativeSecurityListUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44DerivativeSecurityList}
)

// FIX44DerivativeSecurityList is a FIX.4.4 format of the DerivativeSecurityList message which maps the codecs into individual fields.
var FIX44DerivativeSecurityList = f0.Format{
