...
var (
	FIX44TestRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44TestRequest}
	FIX44TestRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44TestRequest}
)

// FIX44TestRequest is a FIX.4.4 format of the TestRequest message which maps the codecs into individual fields.
var FIX44TestRequest = f0.Format{
