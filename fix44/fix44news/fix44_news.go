...
var (
	FIX44NewsMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44News}
	FIX44NewsUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44News}
)

// FIX44News is a FIX.4.4 format of the News message which maps the codecs into individual fields.
var FIX44News = f0.Format{
