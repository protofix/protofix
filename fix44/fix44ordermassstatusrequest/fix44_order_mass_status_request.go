...
package fix44ordermassstatusrequest
...
var (
	FIX44OrderMassStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44OrderMassStatusRequest}
	FIX44OrderMassStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44OrderMassStatusRequest}
)

// FIX44OrderMassStatusRequest is a FIX.4.4 format of the OrderMassStatusRequest message which maps the codecs into individual fields.
var FIX44OrderMassStatusRequest = f0.Format{
