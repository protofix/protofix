...
package fix44collateralinquiryack
...
var (
	FIX44CollateralInquiryAckMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44CollateralInquiryAck}
	FIX44CollateralInquiryAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44CollateralInquiryAck}
)

// FIX44CollateralInquiryAck is a FIX.4.4 format of the CollateralInquiryAck message which maps the codecs into individual fields.
var FIX44CollateralInquiryAck = f0.Format{
