...
package fix44multilegordercancelreplace
...
var (
	FIX44MultilegOrderCancelReplaceMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44MultilegOrderCancelReplace}
	FIX44MultilegOrderCancelReplaceUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44MultilegOrderCancelReplace}
)

// FIX44MultilegOrderCancelReplace is a FIX.4.4 format of the MultilegOrderCancelReplace message which maps the codecs into individual fields.
var FIX44MultilegOrderCancelReplace = f0.Format{
