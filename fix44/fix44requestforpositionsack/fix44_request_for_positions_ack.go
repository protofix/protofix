...
package fix44requestforpositionsack
...
var (
	FIX44RequestForPositionsAckMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44RequestForPositionsAck}
	FIX44RequestForPositionsAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44RequestForPositionsAck}
)

// FIX44RequestForPositionsAck is a FIX.4.4 format of the RequestForPositionsAck message which maps the codecs into individual fields.
var FIX44RequestForPositionsAck = f0.Format{
