...
var (
	FIX44ListStatusMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44ListStatus}
	FIX44ListStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44ListStatus}
)

// FIX44ListStatus is a FIX.4.4 format of the ListStatus message which maps the codecs into individual fields.
var FIX44ListStatus = f0.Format{
