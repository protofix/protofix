...
package fix44securitydefinitionrequest
...
var (
	FIX44SecurityDefinitionRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44SecurityDefinitionRequest}
	FIX44SecurityDefinitionRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44SecurityDefinitionRequest}
)

// FIX44SecurityDefinitionRequest is a FIX.4.4 format of the SecurityDefinitionRequest message which maps the codecs into individual fields.
var FIX44SecurityDefinitionRequest = f0.Format{
