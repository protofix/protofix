...
package fix44ordercancelreject
...
var (
	FIX44OrderCancelRejectMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44OrderCancelReject}
	FIX44OrderCancelRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44OrderCancelReject}
)

// FIX44OrderCancelReject is a FIX.4.4 format of the OrderCancelReject message which maps the codecs into individual fields.
var FIX44OrderCancelReject = f0.Format{
