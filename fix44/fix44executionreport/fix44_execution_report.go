...
var (
	FIX44ExecutionReportMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44ExecutionReport}
	FIX44ExecutionReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44ExecutionReport}
)

// FIX44ExecutionReport is a FIX.4.4 format of the ExecutionReport message which maps the codecs into individual fields.
var FIX44ExecutionReport = f0.Format{
