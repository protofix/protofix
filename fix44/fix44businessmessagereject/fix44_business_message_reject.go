...
package fix44businessmessagereject
...
var (
	FIX44BusinessMessageRejectMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44BusinessMessageReject}
	FIX44BusinessMessageRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44BusinessMessageReject}
)

// FIX44BusinessMessageReject is a FIX.4.4 format of the BusinessMessageReject message which maps the codecs into individual fields.
var FIX44BusinessMessageReject = f0.Format{
