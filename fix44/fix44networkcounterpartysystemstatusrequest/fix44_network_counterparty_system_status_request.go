...
package fix44networkcounterpartysystemstatusrequest
...
var (
	FIX44NetworkCounterpartySystemStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44NetworkCounterpartySystemStatusRequest}
	FIX44NetworkCounterpartySystemStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44NetworkCounterpartySystemStatusRequest}
)

// FIX44NetworkCounterpartySystemStatusRequest is a FIX.4.4 format of the NetworkCounterpartySystemStatusRequest message which maps the codecs into individual fields.
var FIX44NetworkCounterpartySystemStatusRequest = f0.Format{
