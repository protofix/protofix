...
package fix44collateralrequest
...
var (
	FIX44CollateralRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44CollateralRequest}
	FIX44CollateralRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44CollateralRequest}
)

// FIX44CollateralRequest is a FIX.4.4 format of the CollateralRequest message which maps the codecs into individual fields.
var FIX44CollateralRequest = f0.Format{
