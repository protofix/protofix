...
var (
	FIX44SecurityStatusMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44SecurityStatus}
	FIX44SecurityStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44SecurityStatus}
)

// FIX44SecurityStatus is a FIX.4.4 format of the SecurityStatus message which maps the codecs into individual fields.
var FIX44SecurityStatus = f0.Format{
