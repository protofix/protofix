...
package fix44networkcounterpartysystemstatusresponse
...
var (
	FIX44NetworkCounterpartySystemStatusResponseMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44NetworkCounterpartySystemStatusResponse}
	FIX44NetworkCounterpartySystemStatusResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44NetworkCounterpartySystemStatusResponse}
)

// FIX44NetworkCounterpartySystemStatusResponse is a FIX.4.4 format of the NetworkCounterpartySystemStatusResponse message which maps the codecs into individual fields.
var FIX44NetworkCounterpartySystemStatusResponse = f0.Format{
