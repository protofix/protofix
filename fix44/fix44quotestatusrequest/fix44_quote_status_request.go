...
package fix44quotestatusrequest
...
var (
	FIX44QuoteStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44QuoteStatusRequest}
	FIX44QuoteStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44QuoteStatusRequest}
)

// FIX44QuoteStatusRequest is a FIX.4.4 format of the QuoteStatusRequest message which maps the codecs into individual fields.
var FIX44QuoteStatusRequest = f0.Format{
