...
var (
	FIX44QuoteRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44QuoteRequest}
	FIX44QuoteRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44QuoteRequest}
)

// FIX44QuoteRequest is a FIX.4.4 format of the QuoteRequest message which maps the codecs into individual fields.
var FIX44QuoteRequest = f0.Format{
