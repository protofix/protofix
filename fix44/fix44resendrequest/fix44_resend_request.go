...
var (
	FIX44ResendRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44ResendRequest}
	FIX44ResendRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44ResendRequest}
)

// FIX44ResendRequest is a FIX.4.4 format of the ResendRequest message which maps the codecs into individual fields.
var FIX44ResendRequest = f0.Format{
