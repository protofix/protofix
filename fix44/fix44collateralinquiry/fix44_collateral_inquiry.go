...
package fix44collateralinquiry
...
var (
	FIX44CollateralInquiryMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44CollateralInquiry}
	FIX44CollateralInquiryUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44CollateralInquiry}
)

// FIX44CollateralInquiry is a FIX.4.4 format of the CollateralInquiry message which maps the codecs into individual fields.
var FIX44CollateralInquiry = f0.Format{
