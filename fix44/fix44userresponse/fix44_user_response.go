...
var (
	FIX44UserResponseMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44UserResponse}
	FIX44UserResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44UserResponse}
)

// FIX44UserResponse is a FIX.4.4 format of the UserResponse message which maps the codecs into individual fields.
var FIX44UserResponse = f0.Format{
