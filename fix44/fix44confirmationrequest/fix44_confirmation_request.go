...
package fix44confirmationrequest
...
var (
	FIX44ConfirmationRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44ConfirmationRequest}
	FIX44ConfirmationRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44ConfirmationRequest}
)

// FIX44ConfirmationRequest is a FIX.4.4 format of the ConfirmationRequest message which maps the codecs into individual fields.
var FIX44ConfirmationRequest = f0.Format{
