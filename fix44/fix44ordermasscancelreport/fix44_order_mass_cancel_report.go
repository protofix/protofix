...
package fix44ordermasscancelreport
...
var (
	FIX44OrderMassCancelReportMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44OrderMassCancelReport}
	FIX44OrderMassCancelReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44OrderMassCancelReport}
)

// FIX44OrderMassCancelReport is a FIX.4.4 format of the OrderMassCancelReport message which maps the codecs into individual fields.
var FIX44OrderMassCancelReport = f0.Format{
