...
package fix44quotestatusreport
...
var (
	FIX44QuoteStatusReportMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44QuoteStatusReport}
	FIX44QuoteStatusReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44QuoteStatusReport}
)

// FIX44QuoteStatusReport is a FIX.4.4 format of the QuoteStatusReport message which maps the codecs into individual fields.
var FIX44QuoteStatusReport = f0.Format{
