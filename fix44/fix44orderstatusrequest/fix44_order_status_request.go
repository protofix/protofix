...
package fix44orderstatusrequest
...
var (
	FIX44OrderStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44OrderStatusRequest}
	FIX44OrderStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44OrderStatusRequest}
)

// FIX44OrderStatusRequest is a FIX.4.4 format of the OrderStatusRequest message which maps the codecs into individual fields.
var FIX44OrderStatusRequest = f0.Format{
