...
package fix44listcancelrequest
...
var (
	FIX44ListCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44ListCancelRequest}
	FIX44ListCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44ListCancelRequest}
)

// FIX44ListCancelRequest is a FIX.4.4 format of the ListCancelRequest message which maps the codecs into individual fields.
var FIX44ListCancelRequest = f0.Format{
