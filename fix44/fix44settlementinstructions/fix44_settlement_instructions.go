...
package fix44settlementinstructions
...
var (
	FIX44SettlementInstructionsMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44SettlementInstructions}
	FIX44SettlementInstructionsUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44SettlementInstructions}
)

// FIX44SettlementInstructions is a FIX.4.4 format of the SettlementInstructions message which maps the codecs into individual fields.
var FIX44SettlementInstructions = f0.Format{
