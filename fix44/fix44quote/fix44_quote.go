...
var (
	FIX44QuoteMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44Quote}
	FIX44QuoteUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44Quote}
)

// FIX44Quote is a FIX.4.4 format of the Quote message which maps the codecs into individual fields.
var FIX44Quote = f0.Format{
