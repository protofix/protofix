...
var (
	FIX44MassQuoteMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44MassQuote}
	FIX44MassQuoteUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44MassQuote}
)

// FIX44MassQuote is a FIX.4.4 format of the MassQuote message which maps the codecs into individual fields.
var FIX44MassQuote = f0.Format{
