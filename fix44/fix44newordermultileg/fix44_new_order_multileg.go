...
var (
	FIX44NewOrderMultilegMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44NewOrderMultileg}
	FIX44NewOrderMultilegUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44NewOrderMultileg}
)

// FIX44NewOrderMultileg is a FIX.4.4 format of the NewOrderMultileg message which maps the codecs into individual fields.
var FIX44NewOrderMultileg = f0.Format{
