...
package fix44liststatusrequest
...
var (
	FIX44ListStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44ListStatusRequest}
	FIX44ListStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44ListStatusRequest}
)

// FIX44ListStatusRequest is a FIX.4.4 format of the ListStatusRequest message which maps the codecs into individual fields.
var FIX44ListStatusRequest = f0.Format{
