...
var (
	FIX44RFQRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44RFQRequest}
	FIX44RFQRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44RFQRequest}
)

// FIX44RFQRequest is a FIX.4.4 format of the RFQRequest message which maps the codecs into individual fields.
var FIX44RFQRequest = f0.Format{
