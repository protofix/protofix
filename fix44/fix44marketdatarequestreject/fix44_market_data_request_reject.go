...
package fix44marketdatarequestreject
...
var (
	FIX44MarketDataRequestRejectMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44MarketDataRequestReject}
	FIX44MarketDataRequestRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44MarketDataRequestReject}
)

// FIX44MarketDataRequestReject is a FIX.4.4 format of the MarketDataRequestReject message which maps the codecs into individual fields.
var FIX44MarketDataRequestReject = f0.Format{
