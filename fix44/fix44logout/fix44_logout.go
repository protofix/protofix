...
var (
	FIX44LogoutMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44Logout}
	FIX44LogoutUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44Logout}
)

// FIX44Logout is a FIX.4.4 format of the Logout message which maps the codecs into individual fields.
var FIX44Logout = f0.Format{
