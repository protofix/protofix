...
package fix44ordermasscancelrequest
...
var (
	FIX44OrderMassCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44OrderMassCancelRequest}
	FIX44OrderMassCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44OrderMassCancelRequest}
)

// FIX44OrderMassCancelRequest is a FIX.4.4 format of the OrderMassCancelRequest message which maps the codecs into individual fields.
var FIX44OrderMassCancelRequest = f0.Format{
