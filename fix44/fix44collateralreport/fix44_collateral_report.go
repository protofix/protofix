...
var (
	FIX44CollateralReportMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44CollateralReport}
	FIX44CollateralReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44CollateralReport}
)

// FIX44CollateralReport is a FIX.4.4 format of the CollateralReport message which maps the codecs into individual fields.
var FIX44CollateralReport = f0.Format{
