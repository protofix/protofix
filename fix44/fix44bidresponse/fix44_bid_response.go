...
var (
	FIX44BidResponseMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44BidResponse}
	FIX44BidResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44BidResponse}
)

// FIX44BidResponse is a FIX.4.4 format of the BidResponse message which maps the codecs into individual fields.
var FIX44BidResponse = f0.Format{
