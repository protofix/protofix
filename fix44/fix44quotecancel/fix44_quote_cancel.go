...
var (
	FIX44QuoteCancelMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44QuoteCancel}
	FIX44QuoteCancelUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44QuoteCancel}
)

// FIX44QuoteCancel is a FIX.4.4 format of the QuoteCancel message which maps the codecs into individual fields.
var FIX44QuoteCancel = f0.Format{
