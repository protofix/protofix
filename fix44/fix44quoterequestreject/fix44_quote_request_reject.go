...
package fix44quoterequestreject
...
var (
	FIX44QuoteRequestRejectMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44QuoteRequestReject}
	FIX44QuoteRequestRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44QuoteRequestReject}
)

// FIX44QuoteRequestReject is a FIX.4.4 format of the QuoteRequestReject message which maps the codecs into individual fields.
var FIX44QuoteRequestReject = f0.Format{
