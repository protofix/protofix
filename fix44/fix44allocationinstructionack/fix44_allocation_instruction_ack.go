...
package fix44allocationinstructionack
...
var (
	FIX44AllocationInstructionAckMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44AllocationInstructionAck}
	FIX44AllocationInstructionAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44AllocationInstructionAck}
)

// FIX44AllocationInstructionAck is a FIX.4.4 format of the AllocationInstructionAck message which maps the codecs into individual fields.
var FIX44AllocationInstructionAck = f0.Format{
