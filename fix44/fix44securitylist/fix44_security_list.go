...
var (
	FIX44SecurityListMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44SecurityList}
	FIX44SecurityListUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44SecurityList}
)

// FIX44SecurityList is a FIX.4.4 format of the SecurityList message which maps the codecs into individual fields.
var FIX44SecurityList = f0.Format{
