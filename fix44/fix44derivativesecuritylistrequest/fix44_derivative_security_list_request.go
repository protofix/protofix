...
package fix44derivativesecuritylistrequest
...
var (
	FIX44DerivativeSecurityListRequestMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44DerivativeSecurityListRequest}
	FIX44DerivativeSecurityListRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44DerivativeSecurityListRequest}
)

// FIX44DerivativeSecurityListRequest is a FIX.4.4 format of the DerivativeSecurityListRequest message which maps the codecs into individual fields.
var FIX44DerivativeSecurityListRequest = f0.Format{
