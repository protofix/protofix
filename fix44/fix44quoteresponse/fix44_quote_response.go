...
var (
	FIX44QuoteResponseMarshaler   = marshfix.Marshal{Tag: "FIX44", Format: FIX44QuoteResponse}
	FIX44QuoteResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX44", Format: FIX44QuoteResponse}
)

// FIX44QuoteResponse is a FIX.4.4 format of the QuoteResponse message which maps the codecs into individual fields.
var FIX44QuoteResponse = f0.Format{
