...
package fix50sp2derivativesecuritylistupdatereport
...
var (
	FIX50SP2DerivativeSecurityListUpdateReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2DerivativeSecurityListUpdateReport}
	FIX50SP2DerivativeSecurityListUpdateReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2DerivativeSecurityListUpdateReport}
)

// FIX50SP2DerivativeSecurityListUpdateReport is a FIX.5.0 servicepack 2 format of the DerivativeSecurityListUpdateReport message which maps the codecs into individual fields.
var FIX50SP2DerivativeSecurityListUpdateReport = f0.Format{
