...
var (
	FIX50SP2QuoteCancelMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2QuoteCancel}
	FIX50SP2QuoteCancelUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2QuoteCancel}
)

// FIX50SP2QuoteCancel is a FIX.5.0 servicepack 2 format of the QuoteCancel message which maps the codecs into individual fields.
var FIX50SP2QuoteCancel = f0.Format{
	Fields: map[int]f0.Codec{
		QuoteReqID131:                       f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		QuoteID117:                          f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		QuoteCancelType298:                  f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* CANCEL_FOR_ONE_OR_MORE_SECURITIES */, 2 /* CANCEL_FOR_SECURITY_TYPE */, 3 /* CANCEL_FOR_UNDERLYING_SECURITY */, 4 /* CANCEL_ALL_QUOTES */, 5 /* CANCEL_QUOTE_SPECIFIED_IN_QUOTEID */, 6 /* CANCEL_BY_QUOTETYPE */, 7 /* CANCEL_FOR_SECURITY_ISSUER */, 8 /* CANCEL_FOR_ISSUER_OF_UNDERLYING_SECURITY */), f0.Var{1, 19}},
