...
package fix50sp2quoterequestreject
...
var (
	FIX50SP2QuoteRequestRejectMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2QuoteRequestReject}
	FIX50SP2QuoteRequestRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2QuoteRequestReject}
)

// FIX50SP2QuoteRequestReject is a FIX.5.0 servicepack 2 format of the QuoteRequestReject message which maps the codecs into individual fields.
var FIX50SP2QuoteRequestReject = f0.Format{
	Fields: map[int]f0.Codec{
		QuoteReqID131:                       f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		RFQReqID644:                         f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		QuoteRequestRejectReason658:         f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* UNKNOWN_SYMBOL */, 10 /* PASS */, 2 /* EXCHANGE */, 3 /* QUOTE_REQUEST_EXCEEDS_LIMIT */, 4 /* TOO_LATE_TO_ENTER */, 5 /* INVALID_PRICE */, 6 /* NOT_AUTHORIZED_TO_REQUEST_QUOTE */, 7 /* NO_MATCH_FOR_INQUIRY */, 8 /* NO_MARKET_FOR_INSTRUMENT */, 9 /* NO_INVENTORY */, 99 /* OTHER */, 11 /* INSUFFICIENT_CREDIT */), f0.Var{1, 19}},
	...
	Sort: []int{
		...
		RFQReqID644,                         // STRING
		QuoteRequestRejectReason658,         // INT
		Text58,                              // STRING
...
const (
	...
	QuoteRequestRejectReason658                         = 658  // INT
	Text58                                              = 58   // STRING
