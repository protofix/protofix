...
package fix50sp2assignmentreport
...
var (
	FIX50SP2AssignmentReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2AssignmentReport}
	FIX50SP2AssignmentReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2AssignmentReport}
)

// FIX50SP2AssignmentReport is a FIX.5.0 servicepack 2 format of the AssignmentReport message which maps the codecs into individual fields.
var FIX50SP2AssignmentReport = f0.Format{
	Fields: map[int]f0.Codec{
		AsgnRptID833:                        f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		TotNumAssignmentReports832:          f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		...
		AssignmentMethod744:                 f0.Fld{Opt, f0.ASCII, f0.String("P" /* PRO_RATA */, "R" /* RANDOM */), f0.Con{1}},
		AssignmentUnit745:                   f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		OpenInterest746:                     f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		ExerciseMethod747:                   f0.Fld{Opt, f0.ASCII, f0.String("A" /* AUTOMATIC */, "M" /* MANUAL */), f0.Con{1}},
	...
	Sort: []int{
		AsgnRptID833,                        // STRING
		TotNumAssignmentReports832,          // INT
		...
		AssignmentMethod744,                 // CHAR
		AssignmentUnit745,                   // QTY
		OpenInterest746,                     // AMT
		ExerciseMethod747,                   // CHAR
...
const (
	AsgnRptID833                                        = 833  // STRING
	TotNumAssignmentReports832                          = 832  // INT
	...
	AssignmentMethod744                                 = 744  // CHAR
	AssignmentUnit745                                   = 745  // QTY
	OpenInterest746                                     = 746  // AMT
	ExerciseMethod747                                   = 747  // CHAR
