...
package fix50sp2contraryintentionreport
...
var (
	FIX50SP2ContraryIntentionReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2ContraryIntentionReport}
	FIX50SP2ContraryIntentionReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2ContraryIntentionReport}
)

// FIX50SP2ContraryIntentionReport is a FIX.5.0 servicepack 2 format of the ContraryIntentionReport message which maps the codecs into individual fields.
var FIX50SP2ContraryIntentionReport = f0.Format{
	Fields: map[int]f0.Codec{
		ContIntRptID977:                     f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		TransactTime60:                      f0.Fld{Opt, f0.ASCII, f0.UTCTimestampMillisecondTime(), f0.Var{1, 27}},
		LateIndicator978:                    f0.Fld{Opt, f0.ASCII, f0.BoolDefault(), f0.Con{1}},
		InputSource979:                      f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		...
		ExpirationQtyType982:                f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* AUTO_EXERCISE */, 2 /* NON_AUTO_EXERCISE */, 3 /* FINAL_WILL_BE_EXERCISED */, 4 /* CONTRARY_INTENTION */, 5 /* DIFFERENCE */), f0.Var{1, 19}},
		ExpQty983:                           f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
	...
	Sort: []int{
		ContIntRptID977,                     // STRING
		TransactTime60,                      // UTCTIMESTAMP
		LateIndicator978,                    // BOOLEAN
		InputSource979,                      // STRING
...
const (
	ContIntRptID977                                     = 977  // STRING
	TransactTime60                                      = 60   // UTCTIMESTAMP
	LateIndicator978                                    = 978  // BOOLEAN
	InputSource979                                      = 979  // STRING
