...
package fix50sp2settlementobligationreport
...
var (
	FIX50SP2SettlementObligationReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SettlementObligationReport}
	FIX50SP2SettlementObligationReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SettlementObligationReport}
)

// FIX50SP2SettlementObligationReport is a FIX.5.0 servicepack 2 format of the SettlementObligationReport message which maps the codecs into individual fields.
var FIX50SP2SettlementObligationReport = f0.Format{
