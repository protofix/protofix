...
package fix50sp2tradingsessionlist
...
var (
	FIX50SP2TradingSessionListMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2TradingSessionList}
	FIX50SP2TradingSessionListUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2TradingSessionList}
)

// FIX50SP2TradingSessionList is a FIX.5.0 servicepack 2 format of the TradingSessionList message which maps the codecs into individual fields.
var FIX50SP2TradingSessionList = f0.Format{
