...
package fix50sp2tradingsessionlistupdatereport
...
var (
	FIX50SP2TradingSessionListUpdateReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2TradingSessionListUpdateReport}
	FIX50SP2TradingSessionListUpdateReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2TradingSessionListUpdateReport}
)

// FIX50SP2TradingSessionListUpdateReport is a FIX.5.0 servicepack 2 format of the TradingSessionListUpdateReport message which maps the codecs into individual fields.
var FIX50SP2TradingSessionListUpdateReport = f0.Format{
