...
var (
	FIX50SP2SecurityListMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityList}
	FIX50SP2SecurityListUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityList}
)

// FIX50SP2SecurityList is a FIX.5.0 servicepack 2 format of the SecurityList message which maps the codecs into individual fields.
var FIX50SP2SecurityList = f0.Format{
