...
package fix50sp2securitytyperequest
...
var (
	FIX50SP2SecurityTypeRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityTypeRequest}
	FIX50SP2SecurityTypeRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityTypeRequest}
)

// FIX50SP2SecurityTypeRequest is a FIX.5.0 servicepack 2 format of the SecurityTypeRequest message which maps the codecs into individual fields.
var FIX50SP2SecurityTypeRequest = f0.Format{
