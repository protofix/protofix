...
package fix50sp2securitydefinition
...
var (
	FIX50SP2SecurityDefinitionMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityDefinition}
	FIX50SP2SecurityDefinitionUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityDefinition}
)

// FIX50SP2SecurityDefinition is a FIX.5.0 servicepack 2 format of the SecurityDefinition message which maps the codecs into individual fields.
var FIX50SP2SecurityDefinition = f0.Format{
