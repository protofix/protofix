...
var (
	FIX50SP2BidRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2BidRequest}
	FIX50SP2BidRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2BidRequest}
)

// FIX50SP2BidRequest is a FIX.5.0 servicepack 2 format of the BidRequest message which maps the codecs into individual fields.
var FIX50SP2BidRequest = f0.Format{
