...
package fix50sp2streamassignmentrequest
...
var (
	FIX50SP2StreamAssignmentRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2StreamAssignmentRequest}
	FIX50SP2StreamAssignmentRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2StreamAssignmentRequest}
)

// FIX50SP2StreamAssignmentRequest is a FIX.5.0 servicepack 2 format of the StreamAssignmentRequest message which maps the codecs into individual fields.
var FIX50SP2StreamAssignmentRequest = f0.Format{
	Fields: map[int]f0.Codec{
		StreamAsgnReqID1497:                 f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		StreamAsgnReqType1498:               f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* STREAM_ASSIGNMENT_FOR_NEW_CUSTOMER */, 2 /* STREAM_ASSIGNMENT_FOR_EXISTING_CUSTOMER */), f0.Var{1, 19}},
