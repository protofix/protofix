...
package fix50sp2marketdefinitionupdatereport
...
var (
	FIX50SP2MarketDefinitionUpdateReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2MarketDefinitionUpdateReport}
	FIX50SP2MarketDefinitionUpdateReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2MarketDefinitionUpdateReport}
)

// FIX50SP2MarketDefinitionUpdateReport is a FIX.5.0 servicepack 2 format of the MarketDefinitionUpdateReport message which maps the codecs into individual fields.
var FIX50SP2MarketDefinitionUpdateReport = f0.Format{
