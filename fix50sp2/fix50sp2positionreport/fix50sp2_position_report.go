...
package fix50sp2positionreport
...
var (
	FIX50SP2PositionReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2PositionReport}
	FIX50SP2PositionReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2PositionReport}
)

// FIX50SP2PositionReport is a FIX.5.0 servicepack 2 format of the PositionReport message which maps the codecs into individual fields.
var FIX50SP2PositionReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		PosReqType724:                       f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* POSITIONS */, 1 /* TRADES */, 2 /* EXERCISES */, 3 /* ASSIGNMENTS */, 4 /* SETTLEMENT_ACTIVITY */, 5 /* BACKOUT_MESSAGE */, 6 /* DELTA_POSITIONS */), f0.Var{1, 19}},
		...
		PosReqResult728:                     f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* VALID_REQUEST */, 1 /* INVALID_OR_UNSUPPORTED_REQUEST */, 2 /* NO_POSITIONS_FOUND_THAT_MATCH_CRITERIA */, 3 /* NOT_AUTHORIZED_TO_REQUEST_POSITIONS */, 4 /* REQUEST_FOR_POSITION_NOT_SUPPORTED */, 99 /* OTHER */), f0.Var{1, 19}},
		...
		SettlPriceType731:                   f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* FINAL */, 2 /* THEORETICAL */), f0.Var{1, 19}},
		PriorSettlPrice734:                  f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		RegistStatus506:                     f0.Fld{Opt, f0.ASCII, f0.String("A" /* ACCEPTED */, "H" /* HELD */, "N" /* REMINDER */, "R" /* REJECTED */), f0.Con{1}},
		...
		ModelType1434:                       f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* UTILITY_PROVIDED_STANDARD_MODEL */, 1 /* PROPRIETARY */), f0.Var{1, 19}},
		...
		UnderlyingSettlPrice732:                             f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		UnderlyingSettlPriceType733:                         f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		UnderlyingDeliveryAmount1037:                        f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
	...
	Sort: []int{
		...
		UnderlyingSettlPrice732,                             // PRICE
		UnderlyingSettlPriceType733,                         // INT
		UnderlyingDeliveryAmount1037,                        // AMT
		...
		UnderlyingPayAmount985,                              // AMT
		UnderlyingCollectAmount986,                          // AMT
		UnderlyingSettlementDate987,                         // LOCALMKTDATE
		UnderlyingSettlementStatus988,                       // STRING
		PosType703,                                          // STRING
		LongQty704,                                          // QTY
		ShortQty705,                                         // QTY
		PosQtyStatus706,                                     // INT
...
const (
	...
	UnderlyingSettlPrice732                             = 732  // PRICE
	UnderlyingSettlPriceType733                         = 733  // INT
	UnderlyingDeliveryAmount1037                        = 1037 // AMT
	...
	UnderlyingPayAmount985                              = 985  // AMT
	UnderlyingCollectAmount986                          = 986  // AMT
	UnderlyingSettlementDate987                         = 987  // LOCALMKTDATE
	UnderlyingSettlementStatus988                       = 988  // STRING
