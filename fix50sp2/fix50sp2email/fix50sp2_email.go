...
var (
	FIX50SP2EmailMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2Email}
	FIX50SP2EmailUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2Email}
)

// FIX50SP2Email is a FIX.5.0 servicepack 2 format of the Email message which maps the codecs into individual fields.
var FIX50SP2Email = f0.Format{
	Fields: map[int]f0.Codec{
		EmailThreadID164:                    f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		...
		Subject147:                          f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		EncodedSubjectLen356:                f0.Fld{Opt, f0.ASCII, f0.Length(), f0.Var{1, 19}},
		EncodedSubject357:                   f0.Fld{Opt, f0.ASCII, f0.Bytes(), f0.Var{1, 65536}},
	...
	Sort: []int{
		EmailThreadID164,                    // STRING
		EmailType94,                         // CHAR
		OrigTime42,                          // UTCTIMESTAMP
		Subject147,                          // STRING
		EncodedSubjectLen356,                // LENGTH
		EncodedSubject357,                   // DATA
		OrderID37,                           // STRING
		ClOrdID11,                           // STRING
...
const (
	EmailThreadID164                                    = 164  // STRING
	EmailType94                                         = 94   // CHAR
	OrigTime42                                          = 42   // UTCTIMESTAMP
	Subject147                                          = 147  // STRING
	EncodedSubjectLen356                                = 356  // LENGTH
	EncodedSubject357                                   = 357  // DATA
	OrderID37                                           = 37   // STRING
	ClOrdID11                                           = 11   // STRING
