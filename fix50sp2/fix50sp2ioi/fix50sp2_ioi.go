...
var (
	FIX50SP2IOIMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2IOI}
	FIX50SP2IOIUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2IOI}
)

// FIX50SP2IOI is a FIX.5.0 servicepack 2 format of the IOI message which maps the codecs into individual fields.
var FIX50SP2IOI = f0.Format{
