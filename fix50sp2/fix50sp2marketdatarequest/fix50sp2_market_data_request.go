...
package fix50sp2marketdatarequest
...
var (
	FIX50SP2MarketDataRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2MarketDataRequest}
	FIX50SP2MarketDataRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2MarketDataRequest}
)

// FIX50SP2MarketDataRequest is a FIX.5.0 servicepack 2 format of the MarketDataRequest message which maps the codecs into individual fields.
var FIX50SP2MarketDataRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MDImplicitDelete547:                 f0.Fld{Opt, f0.ASCII, f0.BoolDefault(false /* NO */, true /* YES */), f0.Con{1}},
		ApplQueueAction815:                  f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* NO_ACTION_TAKEN */, 1 /* QUEUE_FLUSHED */, 2 /* OVERLAY_LAST */, 3 /* END_SESSION */), f0.Var{1, 19}},
		ApplQueueMax812:                     f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
...
const (
	...
	ApplQueueAction815                                  = 815  // INT
	ApplQueueMax812                                     = 812  // INT
