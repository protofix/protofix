...
package fix50sp2massquoteacknowledgement
...
var FIX50SP2MassQuoteAcknowledgement = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteSetID302:                                       f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		TotNoQuoteEntries304:                                f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		LastFragment893:                                     f0.Fld{Opt, f0.ASCII, f0.BoolDefault(false /* NO */, true /* YES */), f0.Con{1}},
		TotNoCxldQuotes1168:                                 f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		TotNoAccQuotes1169:                                  f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		TotNoRejQuotes1170:                                  f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		QuoteSetValidUntilTime367:                           f0.Fld{Opt, f0.ASCII, f0.UTCTimestampMillisecondTime(), f0.Var{1, 27}},
		...
		QuoteEntryRejectReason368:                           f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		QuoteEntryStatus1167:                                f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* ACCEPTED */, 5 /* REJECTED */, 6 /* REMOVED_FROM_MARKET */, 7 /* EXPIRED */, 12 /* LOCKED_MARKET_WARNING */, 13 /* CROSS_MARKET_WARNING */, 14 /* CANCELED_DUE_TO_LOCK_MARKET */, 15 /* CANCELED_DUE_TO_CROSS_MARKET */, 16 /* ACTIVE */), f0.Var{1, 19}},
	...
	Sort: []int{
		...
		QuoteSetID302,                                       // STRING
		TotNoQuoteEntries304,                                // INT
		LastFragment893,                                     // BOOLEAN
		TotNoCxldQuotes1168,                                 // INT
		TotNoAccQuotes1169,                                  // INT
		TotNoRejQuotes1170,                                  // INT
		QuoteSetValidUntilTime367,                           // UTCTIMESTAMP
		...
		Currency15,                                          // CURRENCY
		QuoteEntryRejectReason368,                           // INT
		QuoteEntryStatus1167,                                // INT
		BookingType775,                                      // INT
...
const (
	...
	QuoteSetID302                                       = 302  // STRING
	TotNoQuoteEntries304                                = 304  // INT
	LastFragment893                                     = 893  // BOOLEAN
	TotNoCxldQuotes1168                                 = 1168 // INT
	TotNoAccQuotes1169                                  = 1169 // INT
	TotNoRejQuotes1170                                  = 1170 // INT
	QuoteSetValidUntilTime367                           = 367  // UTCTIMESTAMP
	...
	QuoteEntryRejectReason368                           = 368  // INT
	QuoteEntryStatus1167                                = 1167 // INT
