...
var (
	FIX50SP2NewsMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2News}
	FIX50SP2NewsUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2News}
)

// FIX50SP2News is a FIX.5.0 servicepack 2 format of the News message which maps the codecs into individual fields.
var FIX50SP2News = f0.Format{
	Fields: map[int]f0.Codec{
		OrigTime42:                          f0.Fld{Opt, f0.ASCII, f0.UTCTimestampMillisecondTime(), f0.Var{1, 27}},
		...
		NewsID1472:                          f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		NewsCategory1473:                    f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* COMPANY_NEWS */, 1 /* MARKETPLACE_NEWS */, 2 /* FINANCIAL_MARKET_NEWS */, 3 /* TECHNICAL_NEWS */, 99 /* OTHER_NEWS */), f0.Var{1, 19}},
		LanguageCode1474:                    f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{2}},
		...
		Text58:                                              f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		...
		NewsRefID1476:                                       f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		NewsRefType1477:                                     f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* REPLACEMENT */, 1 /* OTHER_LANGUAGE */, 2 /* COMPLIMENTARY */), f0.Var{1, 19}},
	},
	...
	Sort: []int{
		...
		RawData96,                           // DATA
		NewsID1472,                          // STRING
		NewsCategory1473,                    // INT
		LanguageCode1474,                    // LANGUAGE
...
const (
	...
	RawData96                                           = 96   // DATA
	NewsID1472                                          = 1472 // STRING
	NewsCategory1473                                    = 1473 // INT
	LanguageCode1474                                    = 1474 // LANGUAGE
	...
	NewsRefID1476                                       = 1476 // STRING
	NewsRefType1477                                     = 1477 // INT
)
