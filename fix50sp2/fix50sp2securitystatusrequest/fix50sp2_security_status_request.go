...
package fix50sp2securitystatusrequest
...
var (
	FIX50SP2SecurityStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityStatusRequest}
	FIX50SP2SecurityStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityStatusRequest}
)

// FIX50SP2SecurityStatusRequest is a FIX.5.0 servicepack 2 format of the SecurityStatusRequest message which maps the codecs into individual fields.
var FIX50SP2SecurityStatusRequest = f0.Format{
	Fields: map[int]f0.Codec{
		SecurityStatusReqID324:                      f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
