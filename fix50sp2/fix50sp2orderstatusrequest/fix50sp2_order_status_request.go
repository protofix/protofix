...
package fix50sp2orderstatusrequest
...
var (
	FIX50SP2OrderStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2OrderStatusRequest}
	FIX50SP2OrderStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2OrderStatusRequest}
)

// FIX50SP2OrderStatusRequest is a FIX.5.0 servicepack 2 format of the OrderStatusRequest message which maps the codecs into individual fields.
var FIX50SP2OrderStatusRequest = f0.Format{
