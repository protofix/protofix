...
package fix50sp2streamassignmentreport
...
var (
	FIX50SP2StreamAssignmentReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2StreamAssignmentReport}
	FIX50SP2StreamAssignmentReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2StreamAssignmentReport}
)

// FIX50SP2StreamAssignmentReport is a FIX.5.0 servicepack 2 format of the StreamAssignmentReport message which maps the codecs into individual fields.
var FIX50SP2StreamAssignmentReport = f0.Format{
	Fields: map[int]f0.Codec{
		StreamAsgnRptID1501:                 f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		StreamAsgnReqType1498:               f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* STREAM_ASSIGNMENT_FOR_NEW_CUSTOMER */, 2 /* STREAM_ASSIGNMENT_FOR_EXISTING_CUSTOMER */), f0.Var{1, 19}},
		StreamAsgnReqID1497:                 f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		...
		StreamAsgnType1617:                  f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* ASSIGNMENT */, 2 /* REJECTED */, 3 /* TERMINATE_UNASSIGN */), f0.Var{1, 19}},
	...
	Sort: []int{
		...
		StreamAsgnReqType1498,               // INT
		StreamAsgnReqID1497,                 // STRING
		PartyID448,                          // STRING
...
const (
	...
	StreamAsgnReqType1498                     = 1498 // INT
	StreamAsgnReqID1497                       = 1497 // STRING
