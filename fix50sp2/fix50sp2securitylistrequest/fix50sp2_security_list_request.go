...
package fix50sp2securitylistrequest
...
var (
	FIX50SP2SecurityListRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityListRequest}
	FIX50SP2SecurityListRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityListRequest}
)

// FIX50SP2SecurityListRequest is a FIX.5.0 servicepack 2 format of the SecurityListRequest message which maps the codecs into individual fields.
var FIX50SP2SecurityListRequest = f0.Format{
