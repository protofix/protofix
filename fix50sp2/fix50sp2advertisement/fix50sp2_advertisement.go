...
var (
	FIX50SP2AdvertisementMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2Advertisement}
	FIX50SP2AdvertisementUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2Advertisement}
)

// FIX50SP2Advertisement is a FIX.5.0 servicepack 2 format of the Advertisement message which maps the codecs into individual fields.
var FIX50SP2Advertisement = f0.Format{
	Fields: map[int]f0.Codec{
		AdvId2:                              f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		AdvTransType5:                       f0.Fld{Req, f0.ASCII, f0.String("C" /* CANCEL */, "N" /* NEW */, "R" /* REPLACE */), f0.Var{1, 65536}},
		AdvRefID3:                           f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
