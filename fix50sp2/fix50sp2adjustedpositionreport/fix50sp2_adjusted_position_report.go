...
package fix50sp2adjustedpositionreport
...
var (
	FIX50SP2AdjustedPositionReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2AdjustedPositionReport}
	FIX50SP2AdjustedPositionReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2AdjustedPositionReport}
)

// FIX50SP2AdjustedPositionReport is a FIX.5.0 servicepack 2 format of the AdjustedPositionReport message which maps the codecs into individual fields.
var FIX50SP2AdjustedPositionReport = f0.Format{
