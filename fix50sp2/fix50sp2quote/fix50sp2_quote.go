...
var (
	FIX50SP2QuoteMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2Quote}
	FIX50SP2QuoteUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2Quote}
)

// FIX50SP2Quote is a FIX.5.0 servicepack 2 format of the Quote message which maps the codecs into individual fields.
var FIX50SP2Quote = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteResponseLevel301:               f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* NO_ACKNOWLEDGEMENT */, 1 /* ACKNOWLEDGE_ONLY_NEGATIVE_OR_ERRONEOUS_QUOTES */, 2 /* ACKNOWLEDGE_EACH_QUOTE_MESSAGE */, 3 /* SUMMARY_ACKNOWLEDGEMENT */), f0.Var{1, 19}},
		...
		BidSwapPoints1065:                   f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		OfferSwapPoints1066:                 f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		...
		QuoteMsgID1166:                      f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		...
		LegPriceType686:                                     f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		LegBidPx681:                                         f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		LegOfferPx684:                                       f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		LegOrderQty685:                                      f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		LegRefID654:                                         f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		LegBidForwardPoints1067:                             f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		LegOfferForwardPoints1068:                           f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
	...
	Sort: []int{
		...
		EncodedText355,                      // DATA
		BidSwapPoints1065,                   // PRICEOFFSET
		OfferSwapPoints1066,                 // PRICEOFFSET
		ExDestinationIDSource1133,           // CHAR
		QuoteMsgID1166,                      // STRING
		...
		LegOrderQty685,                                      // QTY
		LegRefID654,                                         // STRING
		LegBidForwardPoints1067,                             // PRICEOFFSET
		LegOfferForwardPoints1068,                           // PRICEOFFSET
		LegSymbol600,                                        // STRING
...
const (
	...
	BidSwapPoints1065                                   = 1065 // PRICEOFFSET
	OfferSwapPoints1066                                 = 1066 // PRICEOFFSET
	ExDestinationIDSource1133                           = 1133 // CHAR
	QuoteMsgID1166                                      = 1166 // STRING
	...
	LegPriceType686                                     = 686  // INT
	LegBidPx681                                         = 681  // PRICE
	LegOfferPx684                                       = 684  // PRICE
	LegOrderQty685                                      = 685  // QTY
	LegRefID654                                         = 654  // STRING
	LegBidForwardPoints1067                             = 1067 // PRICEOFFSET
	LegOfferForwardPoints1068                           = 1068 // PRICEOFFSET
