...
package fix50sp2settlementinstructionrequest
...
var (
	FIX50SP2SettlementInstructionRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SettlementInstructionRequest}
	FIX50SP2SettlementInstructionRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SettlementInstructionRequest}
)

// FIX50SP2SettlementInstructionRequest is a FIX.5.0 servicepack 2 format of the SettlementInstructionRequest message which maps the codecs into individual fields.
var FIX50SP2SettlementInstructionRequest = f0.Format{
