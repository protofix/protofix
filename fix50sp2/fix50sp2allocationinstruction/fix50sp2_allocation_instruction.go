...
package fix50sp2allocationinstruction
...
var (
	FIX50SP2AllocationInstructionMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2AllocationInstruction}
	FIX50SP2AllocationInstructionUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2AllocationInstruction}
)

// FIX50SP2AllocationInstruction is a FIX.5.0 servicepack 2 format of the AllocationInstruction message which maps the codecs into individual fields.
var FIX50SP2AllocationInstruction = f0.Format{
