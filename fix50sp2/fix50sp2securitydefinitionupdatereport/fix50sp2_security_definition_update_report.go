...
package fix50sp2securitydefinitionupdatereport
...
var (
	FIX50SP2SecurityDefinitionUpdateReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityDefinitionUpdateReport}
	FIX50SP2SecurityDefinitionUpdateReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityDefinitionUpdateReport}
)

// FIX50SP2SecurityDefinitionUpdateReport is a FIX.5.0 servicepack 2 format of the SecurityDefinitionUpdateReport message which maps the codecs into individual fields.
var FIX50SP2SecurityDefinitionUpdateReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SecurityResponseType323:                     f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* ACCEPT_SECURITY_PROPOSAL_AS_IS */, 2 /* ACCEPT_SECURITY_PROPOSAL_WITH_REVISIONS_AS_INDICATED_IN_THE_MESSAGE */, 3 /* LIST_OF_SECURITY_TYPES_RETURNED_PER_REQUEST */, 4 /* LIST_OF_SECURITIES_RETURNED_PER_REQUEST */, 5 /* REJECT_SECURITY_PROPOSAL */, 6 /* CANNOT_MATCH_SELECTION_CRITERIA */), f0.Var{1, 19}},
