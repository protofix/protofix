...
package fix50sp2tradecapturereportrequestack
...
var (
	FIX50SP2TradeCaptureReportRequestAckMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2TradeCaptureReportRequestAck}
	FIX50SP2TradeCaptureReportRequestAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2TradeCaptureReportRequestAck}
)

// FIX50SP2TradeCaptureReportRequestAck is a FIX.5.0 servicepack 2 format of the TradeCaptureReportRequestAck message which maps the codecs into individual fields.
var FIX50SP2TradeCaptureReportRequestAck = f0.Format{
	Fields: map[int]f0.Codec{
		...
		TradeRequestResult749:                       f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* SUCCESSFUL */, 1 /* INVALID_OR_UNKNOWN_INSTRUMENT */, 2 /* INVALID_TYPE_OF_TRADE_REQUESTED */, 3 /* INVALID_PARTIES */, 4 /* INVALID_TRANSPORT_TYPE_REQUESTED */, 5 /* INVALID_DESTINATION_REQUESTED */, 8 /* TRADEREQUESTTYPE_NOT_SUPPORTED */, 9 /* NOT_AUTHORIZED */, 99 /* OTHER */), f0.Var{1, 19}},
