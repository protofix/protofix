...
package fix50sp2crossordercancelreplacerequest
...
var (
	FIX50SP2CrossOrderCancelReplaceRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2CrossOrderCancelReplaceRequest}
	FIX50SP2CrossOrderCancelReplaceRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2CrossOrderCancelReplaceRequest}
)

// FIX50SP2CrossOrderCancelReplaceRequest is a FIX.5.0 servicepack 2 format of the CrossOrderCancelReplaceRequest message which maps the codecs into individual fields.
var FIX50SP2CrossOrderCancelReplaceRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		CrossType549:                        f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* CROSS_AON */, 2 /* CROSS_IOC */, 3 /* CROSS_ONE_SIDE */, 4 /* CROSS_SAME_PRICE */), f0.Var{1, 19}},
		CrossPrioritization550:              f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* NONE */, 1 /* BUY_SIDE_IS_PRIORITIZED */, 2 /* SELL_SIDE_IS_PRIORITIZED */), f0.Var{1, 19}},
		...
		SideComplianceID659:                 f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		SideTimeInForce962:                  f0.Fld{Opt, f0.ASCII, f0.UTCTimestampMillisecondTime(), f0.Var{1, 27}},
	...
	Sort: []int{
		...
		SideComplianceID659,                 // STRING
		SideTimeInForce962,                  // UTCTIMESTAMP
...
const (
	...
	SideComplianceID659                                 = 659  // STRING
	SideTimeInForce962                                  = 962  // UTCTIMESTAMP
