...
package fix50sp2collateralrequest
...
var (
	FIX50SP2CollateralRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2CollateralRequest}
	FIX50SP2CollateralRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2CollateralRequest}
)

// FIX50SP2CollateralRequest is a FIX.5.0 servicepack 2 format of the CollateralRequest message which maps the codecs into individual fields.
var FIX50SP2CollateralRequest = f0.Format{
	Fields: map[int]f0.Codec{
		CollReqID894:                        f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
