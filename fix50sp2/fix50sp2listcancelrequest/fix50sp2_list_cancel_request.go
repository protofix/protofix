...
package fix50sp2listcancelrequest
...
var (
	FIX50SP2ListCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2ListCancelRequest}
	FIX50SP2ListCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2ListCancelRequest}
)

// FIX50SP2ListCancelRequest is a FIX.5.0 servicepack 2 format of the ListCancelRequest message which maps the codecs into individual fields.
var FIX50SP2ListCancelRequest = f0.Format{
