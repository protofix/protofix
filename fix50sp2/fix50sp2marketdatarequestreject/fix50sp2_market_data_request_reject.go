...
package fix50sp2marketdatarequestreject
...
var (
	FIX50SP2MarketDataRequestRejectMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2MarketDataRequestReject}
	FIX50SP2MarketDataRequestRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2MarketDataRequestReject}
)

// FIX50SP2MarketDataRequestReject is a FIX.5.0 servicepack 2 format of the MarketDataRequestReject message which maps the codecs into individual fields.
var FIX50SP2MarketDataRequestReject = f0.Format{
