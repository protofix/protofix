...
package fix50sp2marketdataincrementalrefresh
...
var (
	FIX50SP2MarketDataIncrementalRefreshMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2MarketDataIncrementalRefresh}
	FIX50SP2MarketDataIncrementalRefreshUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2MarketDataIncrementalRefresh}
)

// FIX50SP2MarketDataIncrementalRefresh is a FIX.5.0 servicepack 2 format of the MarketDataIncrementalRefresh message which maps the codecs into individual fields.
var FIX50SP2MarketDataIncrementalRefresh = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MDUpdateAction279:                   f0.Fld{Req, f0.ASCII, f0.String("0" /* NEW */, "1" /* CHANGE */, "2" /* DELETE */, "3" /* DELETE_THRU */, "4" /* DELETE_FROM */, "5" /* OVERLAY */), f0.Con{1}},
		DeleteReason285:                     f0.Fld{Opt, f0.ASCII, f0.String("0" /* CANCELLATION */, "1" /* ERROR */), f0.Con{1}},
		MDEntryType269:                      f0.Fld{Opt, f0.ASCII, f0.String("0" /* BID */, "1" /* OFFER */, "2" /* TRADE */, "3" /* INDEX_VALUE */, "4" /* OPENING_PRICE */, "5" /* CLOSING_PRICE */, "6" /* SETTLEMENT_PRICE */, "7" /* TRADING_SESSION_HIGH_PRICE */, "8" /* TRADING_SESSION_LOW_PRICE */, "9" /* TRADING_SESSION_VWAP_PRICE */, "A" /* IMBALANCE */, "B" /* TRADE_VOLUME */, "C" /* OPEN_INTEREST */, "D" /* COMPOSITE_UNDERLYING_PRICE */, "E" /* SIMULATED_SELL_PRICE */, "F" /* SIMULATED_BUY_PRICE */, "G" /* MARGIN_RATE */, "H" /* MID_PRICE */, "J" /* EMPTY_BOOK */, "K" /* SETTLE_HIGH_PRICE */, "L" /* SETTLE_LOW_PRICE */, "M" /* PRIOR_SETTLE_PRICE */, "N" /* SESSION_HIGH_BID */, "O" /* SESSION_LOW_OFFER */, "P" /* EARLY_PRICES */, "Q" /* AUCTION_CLEARING_PRICE */, "S" /* SWAP_VALUE_FACTOR */, "R" /* DAILY_VALUE_ADJUSTMENT_FOR_LONG_POSITIONS */, "T" /* CUMULATIVE_VALUE_ADJUSTMENT_FOR_LONG_POSITIONS */, "U" /* DAILY_VALUE_ADJUSTMENT_FOR_SHORT_POSITIONS */, "V" /* CUMULATIVE_VALUE_ADJUSTMENT_FOR_SHORT_POSITIONS */, "Y" /* RECOVERY_RATE */, "Z" /* RECOVERY_RATE_FOR_LONG */, "a" /* RECOVERY_RATE_FOR_SHORT */, "W" /* FIXING_PRICE */, "X" /* CASH_RATE */), f0.Con{1}},
		...
		DealingCapacity1048:                 f0.Fld{Opt, f0.ASCII, f0.String("A" /* AGENT */, "P" /* PRINCIPAL */, "R" /* RISKLESS_PRINCIPAL */), f0.Con{1}},
		...
		MDSubBookType1173:                   f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		...
		SecurityTradingStatus326:            f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* OPENING_DELAY */, 10 /* MARKET_ON_CLOSE_IMBALANCE_SELL */, 11 /* 11 */, 12 /* NO_MARKET_IMBALANCE */, 13 /* NO_MARKET_ON_CLOSE_IMBALANCE */, 14 /* ITS_PRE_OPENING */, 15 /* NEW_PRICE_INDICATION */, 16 /* TRADE_DISSEMINATION_TIME */, 17 /* READY_TO_TRADE */, 18 /* NOT_AVAILABLE_FOR_TRADING */, 19 /* NOT_TRADED_ON_THIS_MARKET */, 2 /* TRADING_HALT */, 20 /* UNKNOWN_OR_INVALID */, 21 /* PRE_OPEN */, 22 /* OPENING_ROTATION */, 23 /* FAST_MARKET */, 3 /* RESUME */, 4 /* NO_OPEN */, 5 /* PRICE_INDICATION */, 6 /* TRADING_RANGE_INDICATION */, 7 /* MARKET_IMBALANCE_BUY */, 8 /* MARKET_IMBALANCE_SELL */, 9 /* MARKET_ON_CLOSE_IMBALANCE_BUY */, 24 /* PRE_CROSS */, 25 /* CROSS */, 26 /* POST_CLOSE */), f0.Var{1, 19}},
		HaltReasonInt327:                    f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* NEWS_DISSEMINATION */, 1 /* ORDER_INFLUX */, 2 /* ORDER_IMBALANCE */, 3 /* ADDITIONAL_INFORMATION */, 4 /* NEWS_PENDING */, 5 /* EQUIPMENT_CHANGEOVER */), f0.Var{1, 19}},
		...
		FirstPx1025:                         f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		LastPx31:                            f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		MDStreamID1500:                      f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		...
		MDSecSizeType1178:                                   f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* CUSTOMER */), f0.Var{1, 19}},
		MDSecSize1179:                                       f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		StatsType1176:                                       f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* EXCHANGE_LAST */, 2 /* HIGH */, 3 /* AVERAGE_PRICE */, 4 /* TURNOVER */), f0.Var{1, 19}},
...
const (
	...
	FirstPx1025                                         = 1025 // PRICE
	LastPx31                                            = 31   // PRICE
	MDStreamID1500                                      = 1500 // STRING
	Symbol55                                            = 55   // STRING
	...
	MDSecSizeType1178                                   = 1178 // INT
	MDSecSize1179                                       = 1179 // QTY
	StatsType1176                                       = 1176 // INT
