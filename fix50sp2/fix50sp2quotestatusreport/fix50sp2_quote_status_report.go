...
package fix50sp2quotestatusreport
...
var (
	FIX50SP2QuoteStatusReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2QuoteStatusReport}
	FIX50SP2QuoteStatusReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2QuoteStatusReport}
)

// FIX50SP2QuoteStatusReport is a FIX.5.0 servicepack 2 format of the QuoteStatusReport message which maps the codecs into individual fields.
var FIX50SP2QuoteStatusReport = f0.Format{
	Fields: map[int]f0.Codec{
		QuoteStatusReqID649:                 f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		...
		QuoteStatus297:                      f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* ACCEPTED */, 1 /* CANCEL_FOR_SYMBOL */, 10 /* PENDING */, 11 /* PASS */, 12 /* LOCKED_MARKET_WARNING */, 13 /* CROSS_MARKET_WARNING */, 14 /* CANCELED_DUE_TO_LOCK_MARKET */, 15 /* CANCELED_DUE_TO_CROSS_MARKET */, 2 /* CANCELED_FOR_SECURITY_TYPE */, 3 /* CANCELED_FOR_UNDERLYING */, 4 /* CANCELED_ALL */, 5 /* REJECTED */, 6 /* REMOVED_FROM_MARKET */, 7 /* EXPIRED */, 8 /* QUERY */, 9 /* QUOTE_NOT_FOUND */, 16 /* ACTIVE */, 17 /* CANCELED */, 18 /* UNSOLICITED_QUOTE_REPLENISHMENT */, 19 /* PENDING_END_TRADE */, 20 /* TOO_LATE_TO_END */), f0.Var{1, 19}},
		...
		QuoteCancelType298:                  f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* CANCEL_FOR_ONE_OR_MORE_SECURITIES */, 2 /* CANCEL_FOR_SECURITY_TYPE */, 3 /* CANCEL_FOR_UNDERLYING_SECURITY */, 4 /* CANCEL_ALL_QUOTES */, 5 /* CANCEL_QUOTE_SPECIFIED_IN_QUOTEID */, 6 /* CANCEL_BY_QUOTETYPE */, 7 /* CANCEL_FOR_SECURITY_ISSUER */, 8 /* CANCEL_FOR_ISSUER_OF_UNDERLYING_SECURITY */), f0.Var{1, 19}},
		QuoteMsgID1166:                      f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		QuoteRejectReason300:                f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* UNKNOWN_SYMBOL */, 2 /* EXCHANGE */, 3 /* QUOTE_REQUEST_EXCEEDS_LIMIT */, 4 /* TOO_LATE_TO_ENTER */, 5 /* UNKNOWN_QUOTE */, 6 /* DUPLICATE_QUOTE */, 7 /* INVALID_BID_ASK_SPREAD */, 8 /* INVALID_PRICE */, 9 /* NOT_AUTHORIZED_TO_QUOTE_SECURITY */, 99 /* OTHER */, 10 /* PRICE_EXCEEDS_CURRENT_PRICE_BAND */, 11 /* QUOTE_LOCKED */, 12 /* INVALID_OR_UNKNOWN_SECURITY_ISSUER */, 13 /* INVALID_OR_UNKNOWN_ISSUER_OF_UNDERLYING_SECURITY */), f0.Var{1, 19}},
		...
		TargetPartyID1462:                                   f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		TargetPartyIDSource1463:                             f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{1}},
		TargetPartyRole1464:                                 f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
	},
	Unknown0: f0.UnknownFld{f0.ASCII, f0.Unknown(), f0.Var{1, 65536}},
	Sort: []int{
		QuoteStatusReqID649,                 // STRING
		...
		TargetPartyID1462,                                   // STRING
		TargetPartyIDSource1463,                             // CHAR
		TargetPartyRole1464,                                 // INT
	},
}
...
const (
	QuoteStatusReqID649                                 = 649  // STRING
	...
	TargetPartyID1462                                   = 1462 // STRING
	TargetPartyIDSource1463                             = 1463 // CHAR
	TargetPartyRole1464                                 = 1464 // INT
)
