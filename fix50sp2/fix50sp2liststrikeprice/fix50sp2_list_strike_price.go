...
package fix50sp2liststrikeprice
...
var (
	FIX50SP2ListStrikePriceMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2ListStrikePrice}
	FIX50SP2ListStrikePriceUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2ListStrikePrice}
)

// FIX50SP2ListStrikePrice is a FIX.5.0 servicepack 2 format of the ListStrikePrice message which maps the codecs into individual fields.
var FIX50SP2ListStrikePrice = f0.Format{
	Fields: map[int]f0.Codec{
		ListID66:                            f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		TotNoStrikes422:                     f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
