...
package fix50sp2liststatusrequest
...
var (
	FIX50SP2ListStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2ListStatusRequest}
	FIX50SP2ListStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2ListStatusRequest}
)

// FIX50SP2ListStatusRequest is a FIX.5.0 servicepack 2 format of the ListStatusRequest message which maps the codecs into individual fields.
var FIX50SP2ListStatusRequest = f0.Format{
