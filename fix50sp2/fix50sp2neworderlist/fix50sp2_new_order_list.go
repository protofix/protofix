...
var (
	FIX50SP2NewOrderListMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2NewOrderList}
	FIX50SP2NewOrderListUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2NewOrderList}
)

// FIX50SP2NewOrderList is a FIX.5.0 servicepack 2 format of the NewOrderList message which maps the codecs into individual fields.
var FIX50SP2NewOrderList = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ListExecInstType433:                 f0.Fld{Opt, f0.ASCII, f0.String("1" /* IMMEDIATE */, "2" /* WAIT_FOR_EXECUT_INSTRUCTION */, "3" /* EXCHANGE_SWITCH_CIV_ORDER_3 */, "4" /* EXCHANGE_SWITCH_CIV_ORDER_4 */, "5" /* EXCHANGE_SWITCH_CIV_ORDER_5 */), f0.Con{1}},
		...
		AllowableOneSidednessPct765:         f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		AllowableOneSidednessValue766:       f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		AllowableOneSidednessCurr767:        f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{3}},
		...
		ListSeqNo67:                         f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		ClOrdLinkID583:                      f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		SettlInstMode160:                    f0.Fld{Opt, f0.ASCII, f0.String("0" /* DEFAULT */, "1" /* STANDING_INSTRUCTIONS_PROVIDED */, "2" /* SPECIFIC_ALLOCATION_ACCOUNT_OVERRIDING */, "3" /* SPECIFIC_ALLOCATION_ACCOUNT_STANDING */, "4" /* SPECIFIC_ORDER_FOR_A_SINGLE_ACCOUNT */, "5" /* REQUEST_REJECT */), f0.Con{1}},
	...
	Sort: []int{
		...
		AllowableOneSidednessPct765,         // PERCENTAGE
		AllowableOneSidednessValue766,       // AMT
		AllowableOneSidednessCurr767,        // CURRENCY
		TotNoOrders68,                       // INT
...
const (
	...
	AllowableOneSidednessPct765                         = 765  // PERCENTAGE
	AllowableOneSidednessValue766                       = 766  // AMT
	AllowableOneSidednessCurr767                        = 767  // CURRENCY
