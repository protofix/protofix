...
package fix50sp2collateralresponse
...
var (
	FIX50SP2CollateralResponseMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2CollateralResponse}
	FIX50SP2CollateralResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2CollateralResponse}
)

// FIX50SP2CollateralResponse is a FIX.5.0 servicepack 2 format of the CollateralResponse message which maps the codecs into individual fields.
var FIX50SP2CollateralResponse = f0.Format{
	Fields: map[int]f0.Codec{
		CollRespID904:                       f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		CollAsgnID902:                       f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		CollReqID894:                        f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		CollAsgnReason895:                   f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* INITIAL */, 1 /* SCHEDULED */, 2 /* TIME_WARNING */, 3 /* MARGIN_DEFICIENCY */, 4 /* MARGIN_EXCESS */, 5 /* FORWARD_COLLATERAL_DEMAND */, 6 /* EVENT_OF_DEFAULT */, 7 /* ADVERSE_TAX_EVENT */), f0.Var{1, 19}},
		CollAsgnTransType903:                f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* NEW */, 1 /* REPLACE */, 2 /* CANCEL */, 3 /* RELEASE */, 4 /* REVERSE */), f0.Var{1, 19}},
		CollAsgnRespType905:                 f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* RECEIVED */, 1 /* ACCEPTED */, 2 /* DECLINED */, 3 /* REJECTED */), f0.Var{1, 19}},
		CollAsgnRejectReason906:             f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* UNKNOWN_DEAL */, 1 /* UNKNOWN_OR_INVALID_INSTRUMENT */, 2 /* UNAUTHORIZED_TRANSACTION */, 3 /* INSUFFICIENT_COLLATERAL */, 4 /* INVALID_TYPE_OF_COLLATERAL */, 5 /* EXCESSIVE_SUBSTITUTION */, 99 /* OTHER */), f0.Var{1, 19}},
	...
	Sort: []int{
		CollRespID904,                       // STRING
		CollAsgnID902,                       // STRING
		CollReqID894,                        // STRING
		CollAsgnReason895,                   // INT
		CollAsgnTransType903,                // INT
		CollAsgnRespType905,                 // INT
		CollAsgnRejectReason906,             // INT
