...
package fix50sp2applicationmessagerequestack
...
var (
	FIX50SP2ApplicationMessageRequestAckMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2ApplicationMessageRequestAck}
	FIX50SP2ApplicationMessageRequestAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2ApplicationMessageRequestAck}
)

// FIX50SP2ApplicationMessageRequestAck is a FIX.5.0 servicepack 2 format of the ApplicationMessageRequestAck message which maps the codecs into individual fields.
var FIX50SP2ApplicationMessageRequestAck = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ApplReqType1347:           f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* RETRANSMISSION_OF_APPLICATION_MESSAGES_FOR_THE_SPECIFIED_APPLICATIONS */, 1 /* SUBSCRIPTION_TO_THE_SPECIFIED_APPLICATIONS */, 2 /* REQUEST_FOR_THE_LAST_APPLLASTSEQNUM_PUBLISHED_FOR_THE_SPECIFIED_APPLICATIONS */, 3 /* REQUEST_VALID_SET_OF_APPLICATIONS */, 4 /* UNSUBSCRIBE_TO_THE_SPECIFIED_APPLICATIONS */, 5 /* CANCEL_RETRANSMISSION */, 6 /* CANCEL_RETRANSMISSION_AND_UNSUBSCRIBE_TO_THE_SPECIFIED_APPLICATIONS */), f0.Var{1, 19}},
