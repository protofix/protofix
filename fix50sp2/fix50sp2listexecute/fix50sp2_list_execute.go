...
var (
	FIX50SP2ListExecuteMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2ListExecute}
	FIX50SP2ListExecuteUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2ListExecute}
)

// FIX50SP2ListExecute is a FIX.5.0 servicepack 2 format of the ListExecute message which maps the codecs into individual fields.
var FIX50SP2ListExecute = f0.Format{
