...
package fix50sp2requestforpositionsack
...
var (
	FIX50SP2RequestForPositionsAckMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2RequestForPositionsAck}
	FIX50SP2RequestForPositionsAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2RequestForPositionsAck}
)

// FIX50SP2RequestForPositionsAck is a FIX.5.0 servicepack 2 format of the RequestForPositionsAck message which maps the codecs into individual fields.
var FIX50SP2RequestForPositionsAck = f0.Format{
	Fields: map[int]f0.Codec{
		...
		PosReqResult728:                     f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* VALID_REQUEST */, 1 /* INVALID_OR_UNSUPPORTED_REQUEST */, 2 /* NO_POSITIONS_FOUND_THAT_MATCH_CRITERIA */, 3 /* NOT_AUTHORIZED_TO_REQUEST_POSITIONS */, 4 /* REQUEST_FOR_POSITION_NOT_SUPPORTED */, 99 /* OTHER */), f0.Var{1, 19}},
		PosReqStatus729:                     f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* COMPLETED */, 1 /* COMPLETED_WITH_WARNINGS */, 2 /* REJECTED */), f0.Var{1, 19}},
