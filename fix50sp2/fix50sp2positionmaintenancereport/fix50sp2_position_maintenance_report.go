...
package fix50sp2positionmaintenancereport
...
var (
	FIX50SP2PositionMaintenanceReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2PositionMaintenanceReport}
	FIX50SP2PositionMaintenanceReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2PositionMaintenanceReport}
)

// FIX50SP2PositionMaintenanceReport is a FIX.5.0 servicepack 2 format of the PositionMaintenanceReport message which maps the codecs into individual fields.
var FIX50SP2PositionMaintenanceReport = f0.Format{
	Fields: map[int]f0.Codec{
		PosMaintRptID721:                    f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		PosTransType709:                     f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* EXERCISE */, 2 /* DO_NOT_EXERCISE */, 3 /* POSITION_ADJUSTMENT */, 4 /* POSITION_CHANGE_SUBMISSION_MARGIN_DISPOSITION */, 5 /* PLEDGE */, 6 /* LARGE_TRADER_SUBMISSION */), f0.Var{1, 19}},
		PosReqID710:                         f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		PosMaintAction712:                   f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* NEW */, 2 /* REPLACE */, 3 /* CANCEL */, 4 /* REVERSE */), f0.Var{1, 19}},
		OrigPosReqRefID713:                  f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		PosMaintStatus722:                   f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* ACCEPTED */, 1 /* ACCEPTED_WITH_WARNINGS */, 2 /* REJECTED */, 3 /* COMPLETED */, 4 /* COMPLETED_WITH_WARNINGS */), f0.Var{1, 19}},
		PosMaintResult723:                   f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* SUCCESSFUL_COMPLETION */, 1 /* REJECTED */, 99 /* OTHER */), f0.Var{1, 19}},
		...
		AdjustmentType718:                   f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* PROCESS_REQUEST_AS_MARGIN_DISPOSITION */, 1 /* DELTA_PLUS */, 2 /* DELTA_MINUS */, 3 /* FINAL */), f0.Var{1, 19}},
		ThresholdAmount834:                  f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		...
		ContraryInstructionIndicator719:     f0.Fld{Opt, f0.ASCII, f0.BoolDefault(), f0.Con{1}},
		PriorSpreadIndicator720:             f0.Fld{Opt, f0.ASCII, f0.BoolDefault(), f0.Con{1}},
	...
	Sort: []int{
		...
		PosTransType709,                     // INT
		PosReqID710,                         // STRING
		PosMaintAction712,                   // INT
		OrigPosReqRefID713,                  // STRING
		PosMaintStatus722,                   // INT
		PosMaintResult723,                   // INT
		...
		AdjustmentType718,                   // INT
		ThresholdAmount834,                  // PRICEOFFSET
		Text58,                              // STRING
		EncodedTextLen354,                   // LENGTH
		EncodedText355,                      // DATA
		SettlCurrency120,                    // CURRENCY
		ContraryInstructionIndicator719,     // BOOLEAN
		PriorSpreadIndicator720,             // BOOLEAN
...
const (
	...
	PosTransType709                                     = 709  // INT
	PosReqID710                                         = 710  // STRING
	PosMaintAction712                                   = 712  // INT
	OrigPosReqRefID713                                  = 713  // STRING
	PosMaintStatus722                                   = 722  // INT
	PosMaintResult723                                   = 723  // INT
	...
	AdjustmentType718                                   = 718  // INT
	ThresholdAmount834                                  = 834  // PRICEOFFSET
	Text58                                              = 58   // STRING
	EncodedTextLen354                                   = 354  // LENGTH
	EncodedText355                                      = 355  // DATA
	SettlCurrency120                                    = 120  // CURRENCY
	ContraryInstructionIndicator719                     = 719  // BOOLEAN
	PriorSpreadIndicator720                             = 720  // BOOLEAN
