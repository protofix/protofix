...
package fix50sp2requestforpositions
...
var (
	FIX50SP2RequestForPositionsMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2RequestForPositions}
	FIX50SP2RequestForPositionsUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2RequestForPositions}
)

// FIX50SP2RequestForPositions is a FIX.5.0 servicepack 2 format of the RequestForPositions message which maps the codecs into individual fields.
var FIX50SP2RequestForPositions = f0.Format{
	Fields: map[int]f0.Codec{
		PosReqID710:                         f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		PosReqType724:                       f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* POSITIONS */, 1 /* TRADES */, 2 /* EXERCISES */, 3 /* ASSIGNMENTS */, 4 /* SETTLEMENT_ACTIVITY */, 5 /* BACKOUT_MESSAGE */, 6 /* DELTA_POSITIONS */), f0.Var{1, 19}},
