...
package fix50sp2collateralreport
...
var (
	FIX50SP2CollateralReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2CollateralReport}
	FIX50SP2CollateralReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2CollateralReport}
)

// FIX50SP2CollateralReport is a FIX.5.0 servicepack 2 format of the CollateralReport message which maps the codecs into individual fields.
var FIX50SP2CollateralReport = f0.Format{
	Fields: map[int]f0.Codec{
		CollRptID908:                        f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		CollInquiryID909:                    f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		CollStatus910:                       f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* UNASSIGNED */, 1 /* PARTIALLY_ASSIGNED */, 2 /* ASSIGNMENT_PROPOSED */, 3 /* ASSIGNED */, 4 /* CHALLENGED */), f0.Var{1, 19}},
		...
		CollApplType1043:                    f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* SPECIFIC_DEPOSIT */, 1 /* GENERAL */), f0.Var{1, 19}},
...
const (
	CollRptID908                                        = 908  // STRING
	CollInquiryID909                                    = 909  // STRING
	CollStatus910                                       = 910  // INT
