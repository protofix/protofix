...
package fix50sp2networkcounterpartysystemstatusrequest
...
var (
	FIX50SP2NetworkCounterpartySystemStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2NetworkCounterpartySystemStatusRequest}
	FIX50SP2NetworkCounterpartySystemStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2NetworkCounterpartySystemStatusRequest}
)

// FIX50SP2NetworkCounterpartySystemStatusRequest is a FIX.5.0 servicepack 2 format of the NetworkCounterpartySystemStatusRequest message which maps the codecs into individual fields.
var FIX50SP2NetworkCounterpartySystemStatusRequest = f0.Format{
