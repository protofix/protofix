...
package fix50sp2marketdatasnapshotfullrefresh
...
var (
	FIX50SP2MarketDataSnapshotFullRefreshMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2MarketDataSnapshotFullRefresh}
	FIX50SP2MarketDataSnapshotFullRefreshUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2MarketDataSnapshotFullRefresh}
)

// FIX50SP2MarketDataSnapshotFullRefresh is a FIX.5.0 servicepack 2 format of the MarketDataSnapshotFullRefresh message which maps the codecs into individual fields.
var FIX50SP2MarketDataSnapshotFullRefresh = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MDReportID963:                               f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		...
		RefreshIndicator1187:                        f0.Fld{Opt, f0.ASCII, f0.BoolDefault(), f0.Con{1}},
...
const (
	...
	RefreshIndicator1187                                = 1187 // BOOLEAN
