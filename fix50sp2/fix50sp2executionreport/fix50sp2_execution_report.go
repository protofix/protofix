...
package fix50sp2executionreport
...
var (
	FIX50SP2ExecutionReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2ExecutionReport}
	FIX50SP2ExecutionReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2ExecutionReport}
)

// FIX50SP2ExecutionReport is a FIX.5.0 servicepack 2 format of the ExecutionReport message which maps the codecs into individual fields.
var FIX50SP2ExecutionReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		FillLiquidityInd1443:                                f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
