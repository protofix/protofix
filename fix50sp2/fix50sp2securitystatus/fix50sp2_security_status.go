...
package fix50sp2securitystatus
...
var (
	FIX50SP2SecurityStatusMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityStatus}
	FIX50SP2SecurityStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityStatus}
)

// FIX50SP2SecurityStatus is a FIX.5.0 servicepack 2 format of the SecurityStatus message which maps the codecs into individual fields.
var FIX50SP2SecurityStatus = f0.Format{
	Fields: map[int]f0.Codec{
		...
		InViewOfCommon328:                   f0.Fld{Opt, f0.ASCII, f0.BoolDefault(false /* NO */, true /* YES */), f0.Con{1}},
		DueToRelated329:                     f0.Fld{Opt, f0.ASCII, f0.BoolDefault(false /* NO */, true /* YES */), f0.Con{1}},
		...
		SecurityTradingEvent1174:            f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* ORDER_IMBALANCE_AUCTION_IS_EXTENDED */, 2 /* TRADING_RESUMES */, 3 /* PRICE_VOLATILITY_INTERRUPTION */, 4 /* CHANGE_OF_TRADING_SESSION */, 5 /* CHANGE_OF_TRADING_SUBSESSION */, 6 /* CHANGE_OF_SECURITY_TRADING_STATUS */, 7 /* CHANGE_OF_BOOK_TYPE */, 8 /* CHANGE_OF_MARKET_DEPTH */), f0.Var{1, 19}},
...
const (
	...
	SecurityTradingEvent1174                            = 1174 // INT
