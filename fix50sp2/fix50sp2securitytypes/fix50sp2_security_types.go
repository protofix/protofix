...
var (
	FIX50SP2SecurityTypesMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityTypes}
	FIX50SP2SecurityTypesUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityTypes}
)

// FIX50SP2SecurityTypes is a FIX.5.0 servicepack 2 format of the SecurityTypes message which maps the codecs into individual fields.
var FIX50SP2SecurityTypes = f0.Format{
