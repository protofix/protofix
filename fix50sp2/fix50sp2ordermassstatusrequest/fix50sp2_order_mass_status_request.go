...
package fix50sp2ordermassstatusrequest
...
var (
	FIX50SP2OrderMassStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2OrderMassStatusRequest}
	FIX50SP2OrderMassStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2OrderMassStatusRequest}
)

// FIX50SP2OrderMassStatusRequest is a FIX.5.0 servicepack 2 format of the OrderMassStatusRequest message which maps the codecs into individual fields.
var FIX50SP2OrderMassStatusRequest = f0.Format{
	Fields: map[int]f0.Codec{
		MassStatusReqID584:                  f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		MassStatusReqType585:                f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* STATUS_FOR_ORDERS_FOR_A_SECURITY */, 2 /* STATUS_FOR_ORDERS_FOR_AN_UNDERLYING_SECURITY */, 3 /* STATUS_FOR_ORDERS_FOR_A_PRODUCT */, 4 /* STATUS_FOR_ORDERS_FOR_A_CFICODE */, 5 /* STATUS_FOR_ORDERS_FOR_A_SECURITYTYPE */, 6 /* STATUS_FOR_ORDERS_FOR_A_TRADING_SESSION */, 7 /* STATUS_FOR_ALL_ORDERS */, 8 /* STATUS_FOR_ORDERS_FOR_A_PARTYID */, 9 /* STATUS_FOR_SECURITY_ISSUER */, 10 /* STATUS_FOR_ISSUER_OF_UNDERLYING_SECURITY */), f0.Var{1, 19}},
