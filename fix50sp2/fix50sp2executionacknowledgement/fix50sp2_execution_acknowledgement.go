...
package fix50sp2executionacknowledgement
...
var (
	FIX50SP2ExecutionAcknowledgementMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2ExecutionAcknowledgement}
	FIX50SP2ExecutionAcknowledgementUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2ExecutionAcknowledgement}
)

// FIX50SP2ExecutionAcknowledgement is a FIX.5.0 servicepack 2 format of the ExecutionAcknowledgement message which maps the codecs into individual fields.
var FIX50SP2ExecutionAcknowledgement = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ExecAckStatus1036:                   f0.Fld{Req, f0.ASCII, f0.String("0" /* RECEIVED_NOT_YET_PROCESSED */, "1" /* ACCEPTED */, "2" /* DONT_KNOW */), f0.Con{1}},
		ExecID17:                            f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		DKReason127:                         f0.Fld{Opt, f0.ASCII, f0.String("A" /* UNKNOWN_SYMBOL */, "B" /* WRONG_SIDE */, "C" /* QUANTITY_EXCEEDS_ORDER */, "D" /* NO_MATCHING_ORDER */, "E" /* PRICE_EXCEEDS_LIMIT */, "F" /* CALCULATION_DIFFERENCE */, "Z" /* OTHER */), f0.Con{1}},
