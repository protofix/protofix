...
package fix50sp2securitydefinitionrequest
...
var (
	FIX50SP2SecurityDefinitionRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityDefinitionRequest}
	FIX50SP2SecurityDefinitionRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2SecurityDefinitionRequest}
)

// FIX50SP2SecurityDefinitionRequest is a FIX.5.0 servicepack 2 format of the SecurityDefinitionRequest message which maps the codecs into individual fields.
var FIX50SP2SecurityDefinitionRequest = f0.Format{
	Fields: map[int]f0.Codec{
		SecurityReqID320:                            f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		SecurityRequestType321:                      f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* REQUEST_SECURITY_IDENTITY_AND_SPECIFICATIONS */, 1 /* REQUEST_SECURITY_IDENTITY_FOR_THE_SPECIFICATIONS_PROVIDED */, 2 /* REQUEST_LIST_SECURITY_TYPES */, 3 /* REQUEST_LIST_SECURITIES */, 4 /* SYMBOL */, 5 /* SECURITYTYPE_AND_OR_CFICODE */, 6 /* PRODUCT */, 7 /* TRADINGSESSIONID */, 8 /* ALL_SECURITIES */, 9 /* MARKETID_OR_MARKETID_PLUS_MARKETSEGMENTID */), f0.Var{1, 19}},
...
const (
	...
	SecurityRequestType321                              = 321  // INT
