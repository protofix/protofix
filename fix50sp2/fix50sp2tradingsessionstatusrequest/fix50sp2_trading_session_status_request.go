...
package fix50sp2tradingsessionstatusrequest
...
var (
	FIX50SP2TradingSessionStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP2", Format: FIX50SP2TradingSessionStatusRequest}
	FIX50SP2TradingSessionStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP2", Format: FIX50SP2TradingSessionStatusRequest}
)

// FIX50SP2TradingSessionStatusRequest is a FIX.5.0 servicepack 2 format of the TradingSessionStatusRequest message which maps the codecs into individual fields.
var FIX50SP2TradingSessionStatusRequest = f0.Format{
