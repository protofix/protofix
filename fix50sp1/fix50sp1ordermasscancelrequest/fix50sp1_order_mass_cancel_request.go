...
package fix50sp1ordermasscancelrequest
...
var (
	FIX50SP1OrderMassCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1OrderMassCancelRequest}
	FIX50SP1OrderMassCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1OrderMassCancelRequest}
)

// FIX50SP1OrderMassCancelRequest is a FIX.5.0 servicepack 1 format of the OrderMassCancelRequest message which maps the codecs into individual fields.
var FIX50SP1OrderMassCancelRequest = f0.Format{
