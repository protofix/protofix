...
var (
	FIX50SP1QuoteResponseMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1QuoteResponse}
	FIX50SP1QuoteResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1QuoteResponse}
)

// FIX50SP1QuoteResponse is a FIX.5.0 servicepack 1 format of the QuoteResponse message which maps the codecs into individual fields.
var FIX50SP1QuoteResponse = f0.Format{
