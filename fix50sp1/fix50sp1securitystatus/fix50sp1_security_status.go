...
package fix50sp1securitystatus
...
var (
	FIX50SP1SecurityStatusMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityStatus}
	FIX50SP1SecurityStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityStatus}
)

// FIX50SP1SecurityStatus is a FIX.5.0 servicepack 1 format of the SecurityStatus message which maps the codecs into individual fields.
var FIX50SP1SecurityStatus = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SecurityTradingEvent1174:                f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* ORDER_IMBALANCE_AUCTION_IS_EXTENDED */, 2 /* TRADING_RESUMES */, 3 /* PRICE_VOLATILITY_INTERRUPTION */, 4 /* CHANGE_OF_TRADING_SESSION */, 5 /* CHANGE_OF_TRADING_SUBSESSION */, 6 /* CHANGE_OF_SECURITY_STATUS */, 7 /* CHANGE_OF_BOOK_TYPE */, 8 /* CHANGE_OF_MARKET_DEPTH */), f0.Var{1, 19}},
