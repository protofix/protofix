...
var (
	FIX50SP1UserRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1UserRequest}
	FIX50SP1UserRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1UserRequest}
)

// FIX50SP1UserRequest is a FIX.5.0 servicepack 1 format of the UserRequest message which maps the codecs into individual fields.
var FIX50SP1UserRequest = f0.Format{
