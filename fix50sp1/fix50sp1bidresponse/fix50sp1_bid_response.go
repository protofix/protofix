...
var (
	FIX50SP1BidResponseMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1BidResponse}
	FIX50SP1BidResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1BidResponse}
)

// FIX50SP1BidResponse is a FIX.5.0 servicepack 1 format of the BidResponse message which maps the codecs into individual fields.
var FIX50SP1BidResponse = f0.Format{
