...
var (
	FIX50SP1NewsMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1News}
	FIX50SP1NewsUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1News}
)

// FIX50SP1News is a FIX.5.0 servicepack 1 format of the News message which maps the codecs into individual fields.
var FIX50SP1News = f0.Format{
