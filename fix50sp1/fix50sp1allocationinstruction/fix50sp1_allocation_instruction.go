...
package fix50sp1allocationinstruction
...
var (
	FIX50SP1AllocationInstructionMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1AllocationInstruction}
	FIX50SP1AllocationInstructionUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1AllocationInstruction}
)

// FIX50SP1AllocationInstruction is a FIX.5.0 servicepack 1 format of the AllocationInstruction message which maps the codecs into individual fields.
var FIX50SP1AllocationInstruction = f0.Format{
