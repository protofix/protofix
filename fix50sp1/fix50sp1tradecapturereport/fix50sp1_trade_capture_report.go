...
package fix50sp1tradecapturereport
...
var (
	FIX50SP1TradeCaptureReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1TradeCaptureReport}
	FIX50SP1TradeCaptureReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1TradeCaptureReport}
)

// FIX50SP1TradeCaptureReport is a FIX.5.0 servicepack 1 format of the TradeCaptureReport message which maps the codecs into individual fields.
var FIX50SP1TradeCaptureReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SideQty1009:                             f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		...
		SideTrdSubTyp1008:                       f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* CMTA */, 1 /* INTERNAL_TRANSFER */, 2 /* EXTERNAL_TRANSFER */, 3 /* REJECT_FOR_SUBMITTING_TRADE */, 4 /* ADVISORY_FOR_CONTRA_SIDE */, 5 /* OFFSET_DUE_TO_AN_ALLOCATION */, 6 /* ONSET_DUE_TO_AN_ALLOCATION */, 7 /* DIFFERENTIAL_SPREAD */, 8 /* IMPLIED_SPREAD_LEG_EXECUTED_AGAINST_AN_OUTRIGHT */, 9 /* TRANSACTION_FROM_EXERCISE */, 10 /* TRANSACTION_FROM_ASSIGNMENT */), f0.Var{1, 19}},
