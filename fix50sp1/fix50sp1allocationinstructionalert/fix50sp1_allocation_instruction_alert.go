...
package fix50sp1allocationinstructionalert
...
var (
	FIX50SP1AllocationInstructionAlertMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1AllocationInstructionAlert}
	FIX50SP1AllocationInstructionAlertUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1AllocationInstructionAlert}
)

// FIX50SP1AllocationInstructionAlert is a FIX.5.0 servicepack 1 format of the AllocationInstructionAlert message which maps the codecs into individual fields.
var FIX50SP1AllocationInstructionAlert = f0.Format{
