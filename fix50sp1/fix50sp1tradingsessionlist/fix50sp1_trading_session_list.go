...
package fix50sp1tradingsessionlist
...
var (
	FIX50SP1TradingSessionListMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1TradingSessionList}
	FIX50SP1TradingSessionListUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1TradingSessionList}
)

// FIX50SP1TradingSessionList is a FIX.5.0 servicepack 1 format of the TradingSessionList message which maps the codecs into individual fields.
var FIX50SP1TradingSessionList = f0.Format{
