...
package fix50sp1securitydefinition
...
var (
	FIX50SP1SecurityDefinitionMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityDefinition}
	FIX50SP1SecurityDefinitionUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityDefinition}
)

// FIX50SP1SecurityDefinition is a FIX.5.0 servicepack 1 format of the SecurityDefinition message which maps the codecs into individual fields.
var FIX50SP1SecurityDefinition = f0.Format{
