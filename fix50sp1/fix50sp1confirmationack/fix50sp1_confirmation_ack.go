...
package fix50sp1confirmationack
...
var (
	FIX50SP1ConfirmationAckMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1ConfirmationAck}
	FIX50SP1ConfirmationAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1ConfirmationAck}
)

// FIX50SP1ConfirmationAck is a FIX.5.0 servicepack 1 format of the ConfirmationAck message which maps the codecs into individual fields.
var FIX50SP1ConfirmationAck = f0.Format{
