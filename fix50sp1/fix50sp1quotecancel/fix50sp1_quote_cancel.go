...
var (
	FIX50SP1QuoteCancelMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1QuoteCancel}
	FIX50SP1QuoteCancelUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1QuoteCancel}
)

// FIX50SP1QuoteCancel is a FIX.5.0 servicepack 1 format of the QuoteCancel message which maps the codecs into individual fields.
var FIX50SP1QuoteCancel = f0.Format{
	Fields: map[int]f0.Codec{
		QuoteReqID131:                           f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		QuoteID117:                              f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		QuoteCancelType298:                      f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* CANCEL_FOR_SYMBOL */, 2 /* CANCEL_FOR_SECURITY_TYPE */, 3 /* CANCEL_FOR_UNDERLYING_SYMBOL */, 4 /* CANCEL_ALL_QUOTES */, 5 /* CANCEL_QUOTE_SPECIFIED_IN_QUOTEID */), f0.Var{1, 19}},
