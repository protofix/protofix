...
var (
	FIX50SP1QuoteMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1Quote}
	FIX50SP1QuoteUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1Quote}
)

// FIX50SP1Quote is a FIX.5.0 servicepack 1 format of the Quote message which maps the codecs into individual fields.
var FIX50SP1Quote = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteResponseLevel301:                   f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* NO_ACKNOWLEDGEMENT */, 1 /* ACKNOWLEDGE_ONLY_NEGATIVE_OR_ERRONEOUS_QUOTES */, 2 /* ACKNOWLEDGE_EACH_QUOTE_MESSAGES */, 3 /* SUMMARY_ACKNOWLEDGEMENT */), f0.Var{1, 19}},
