...
package fix50sp1allocationreport
...
var (
	FIX50SP1AllocationReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1AllocationReport}
	FIX50SP1AllocationReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1AllocationReport}
)

// FIX50SP1AllocationReport is a FIX.5.0 servicepack 1 format of the AllocationReport message which maps the codecs into individual fields.
var FIX50SP1AllocationReport = f0.Format{
