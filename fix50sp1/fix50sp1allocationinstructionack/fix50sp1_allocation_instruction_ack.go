...
package fix50sp1allocationinstructionack
...
var (
	FIX50SP1AllocationInstructionAckMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1AllocationInstructionAck}
	FIX50SP1AllocationInstructionAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1AllocationInstructionAck}
)

// FIX50SP1AllocationInstructionAck is a FIX.5.0 servicepack 1 format of the AllocationInstructionAck message which maps the codecs into individual fields.
var FIX50SP1AllocationInstructionAck = f0.Format{
