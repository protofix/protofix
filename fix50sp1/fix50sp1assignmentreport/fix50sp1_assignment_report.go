...
package fix50sp1assignmentreport
...
var (
	FIX50SP1AssignmentReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1AssignmentReport}
	FIX50SP1AssignmentReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1AssignmentReport}
)

// FIX50SP1AssignmentReport is a FIX.5.0 servicepack 1 format of the AssignmentReport message which maps the codecs into individual fields.
var FIX50SP1AssignmentReport = f0.Format{
