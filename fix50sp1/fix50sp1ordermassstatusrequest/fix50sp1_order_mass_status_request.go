...
package fix50sp1ordermassstatusrequest
...
var (
	FIX50SP1OrderMassStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1OrderMassStatusRequest}
	FIX50SP1OrderMassStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1OrderMassStatusRequest}
)

// FIX50SP1OrderMassStatusRequest is a FIX.5.0 servicepack 1 format of the OrderMassStatusRequest message which maps the codecs into individual fields.
var FIX50SP1OrderMassStatusRequest = f0.Format{
