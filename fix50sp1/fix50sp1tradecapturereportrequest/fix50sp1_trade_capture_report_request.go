...
package fix50sp1tradecapturereportrequest
...
var (
	FIX50SP1TradeCaptureReportRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1TradeCaptureReportRequest}
	FIX50SP1TradeCaptureReportRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1TradeCaptureReportRequest}
)

// FIX50SP1TradeCaptureReportRequest is a FIX.5.0 servicepack 1 format of the TradeCaptureReportRequest message which maps the codecs into individual fields.
var FIX50SP1TradeCaptureReportRequest = f0.Format{
