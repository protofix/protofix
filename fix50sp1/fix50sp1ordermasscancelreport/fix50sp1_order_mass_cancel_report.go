...
package fix50sp1ordermasscancelreport
...
var (
	FIX50SP1OrderMassCancelReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1OrderMassCancelReport}
	FIX50SP1OrderMassCancelReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1OrderMassCancelReport}
)

// FIX50SP1OrderMassCancelReport is a FIX.5.0 servicepack 1 format of the OrderMassCancelReport message which maps the codecs into individual fields.
var FIX50SP1OrderMassCancelReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MassCancelRequestType530:                f0.Fld{Req, f0.ASCII, f0.String("1" /* CANCEL_ORDERS_FOR_A_SECURITY */, "2" /* CANCEL_ORDERS_FOR_AN_UNDERLYING_SECURITY */, "3" /* CANCEL_ORDERS_FOR_A_PRODUCT */, "4" /* CANCEL_ORDERS_FOR_A_CFICODE */, "5" /* CANCEL_ORDERS_FOR_A_SECURITYTYPE */, "6" /* CANCEL_ORDERS_FOR_A_TRADING_SESSION */, "7" /* CANCEL_ALL_ORDERS */, "8" /* CANCEL_ORDERS_FOR_A_MARKET */, "9" /* CANCEL_ORDERS_FOR_A_MARKET_SEGMENT */, "A" /* CANCEL_ORDERS_FOR_A_SECURITY_GROUP */), f0.Con{1}},
		...
		MassCancelRejectReason532:               f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* MASS_CANCEL_NOT_SUPPORTED */, 1 /* INVALID_OR_UNKNOWN_SECURITY */, 2 /* INVALID_OR_UNKOWN_UNDERLYING_SECURITY */, 3 /* INVALID_OR_UNKNOWN_PRODUCT */, 4 /* INVALID_OR_UNKNOWN_CFICODE */, 5 /* INVALID_OR_UNKNOWN_SECURITYTYPE */, 6 /* INVALID_OR_UNKNOWN_TRADING_SESSION */, 99 /* OTHER */, 7 /* INVALID_OR_UNKNOWN_MARKET */, 8 /* INVALID_OR_UNKOWN_MARKET_SEGMENT */, 9 /* INVALID_OR_UNKNOWN_SECURITY_GROUP */), f0.Var{1, 19}},
