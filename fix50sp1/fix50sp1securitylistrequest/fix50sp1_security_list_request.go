...
package fix50sp1securitylistrequest
...
var (
	FIX50SP1SecurityListRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityListRequest}
	FIX50SP1SecurityListRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityListRequest}
)

// FIX50SP1SecurityListRequest is a FIX.5.0 servicepack 1 format of the SecurityListRequest message which maps the codecs into individual fields.
var FIX50SP1SecurityListRequest = f0.Format{
