...
var (
	FIX50SP1ConfirmationMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1Confirmation}
	FIX50SP1ConfirmationUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1Confirmation}
)

// FIX50SP1Confirmation is a FIX.5.0 servicepack 1 format of the Confirmation message which maps the codecs into individual fields.
var FIX50SP1Confirmation = f0.Format{
