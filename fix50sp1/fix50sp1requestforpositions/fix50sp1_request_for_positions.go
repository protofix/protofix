...
package fix50sp1requestforpositions
...
var (
	FIX50SP1RequestForPositionsMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1RequestForPositions}
	FIX50SP1RequestForPositionsUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1RequestForPositions}
)

// FIX50SP1RequestForPositions is a FIX.5.0 servicepack 1 format of the RequestForPositions message which maps the codecs into individual fields.
var FIX50SP1RequestForPositions = f0.Format{
	Fields: map[int]f0.Codec{
		PosReqID710:                             f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		PosReqType724:                           f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* POSITIONS */, 1 /* TRADES */, 2 /* EXERCISES */, 3 /* ASSIGNMENTS */, 4 /* SETTLEMENT_ACTIVITY */, 5 /* BACKOUT_MESSAGE */), f0.Var{1, 19}},
