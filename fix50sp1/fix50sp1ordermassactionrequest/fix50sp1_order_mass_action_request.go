...
package fix50sp1ordermassactionrequest
...
var (
	FIX50SP1OrderMassActionRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1OrderMassActionRequest}
	FIX50SP1OrderMassActionRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1OrderMassActionRequest}
)

// FIX50SP1OrderMassActionRequest is a FIX.5.0 servicepack 1 format of the OrderMassActionRequest message which maps the codecs into individual fields.
var FIX50SP1OrderMassActionRequest = f0.Format{
