...
package fix50sp1executionacknowledgement
...
var (
	FIX50SP1ExecutionAcknowledgementMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1ExecutionAcknowledgement}
	FIX50SP1ExecutionAcknowledgementUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1ExecutionAcknowledgement}
)

// FIX50SP1ExecutionAcknowledgement is a FIX.5.0 servicepack 1 format of the ExecutionAcknowledgement message which maps the codecs into individual fields.
var FIX50SP1ExecutionAcknowledgement = f0.Format{
