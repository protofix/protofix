...
package fix50sp1tradingsessionstatus
...
var (
	FIX50SP1TradingSessionStatusMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1TradingSessionStatus}
	FIX50SP1TradingSessionStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1TradingSessionStatus}
)

// FIX50SP1TradingSessionStatus is a FIX.5.0 servicepack 1 format of the TradingSessionStatus message which maps the codecs into individual fields.
var FIX50SP1TradingSessionStatus = f0.Format{
