...
package fix50sp1crossordercancelrequest
...
var (
	FIX50SP1CrossOrderCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1CrossOrderCancelRequest}
	FIX50SP1CrossOrderCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1CrossOrderCancelRequest}
)

// FIX50SP1CrossOrderCancelRequest is a FIX.5.0 servicepack 1 format of the CrossOrderCancelRequest message which maps the codecs into individual fields.
var FIX50SP1CrossOrderCancelRequest = f0.Format{
