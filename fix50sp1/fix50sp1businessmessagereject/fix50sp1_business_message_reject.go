...
package fix50sp1businessmessagereject
...
var (
	FIX50SP1BusinessMessageRejectMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1BusinessMessageReject}
	FIX50SP1BusinessMessageRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1BusinessMessageReject}
)

// FIX50SP1BusinessMessageReject is a FIX.5.0 servicepack 1 format of the BusinessMessageReject message which maps the codecs into individual fields.
var FIX50SP1BusinessMessageReject = f0.Format{
