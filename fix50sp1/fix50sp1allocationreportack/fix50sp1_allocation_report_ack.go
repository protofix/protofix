...
package fix50sp1allocationreportack
...
var (
	FIX50SP1AllocationReportAckMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1AllocationReportAck}
	FIX50SP1AllocationReportAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1AllocationReportAck}
)

// FIX50SP1AllocationReportAck is a FIX.5.0 servicepack 1 format of the AllocationReportAck message which maps the codecs into individual fields.
var FIX50SP1AllocationReportAck = f0.Format{
