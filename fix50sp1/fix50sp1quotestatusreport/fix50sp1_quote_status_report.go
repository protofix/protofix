...
package fix50sp1quotestatusreport
...
var (
	FIX50SP1QuoteStatusReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1QuoteStatusReport}
	FIX50SP1QuoteStatusReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1QuoteStatusReport}
)

// FIX50SP1QuoteStatusReport is a FIX.5.0 servicepack 1 format of the QuoteStatusReport message which maps the codecs into individual fields.
var FIX50SP1QuoteStatusReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteCancelType298:                      f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* CANCEL_FOR_SYMBOL */, 2 /* CANCEL_FOR_SECURITY_TYPE */, 3 /* CANCEL_FOR_UNDERLYING_SYMBOL */, 4 /* CANCEL_ALL_QUOTES */, 5 /* CANCEL_QUOTE_SPECIFIED_IN_QUOTEID */), f0.Var{1, 19}},
		QuoteMsgID1166:                          f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		QuoteRejectReason300:                    f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* UNKNOWN_SYMBOL */, 2 /* EXCHANGE */, 3 /* QUOTE_REQUEST_EXCEEDS_LIMIT */, 4 /* TOO_LATE_TO_ENTER */, 5 /* UNKNOWN_QUOTE */, 6 /* DUPLICATE_QUOTE */, 7 /* INVALID_BID_ASK_SPREAD */, 8 /* INVALID_PRICE */, 9 /* NOT_AUTHORIZED_TO_QUOTE_SECURITY */, 99 /* OTHER */, 10 /* PRICE_EXCEEDS_CURRENT_PRICE_BAND */, 11 /* QUOTE_LOCKED */), f0.Var{1, 19}},
