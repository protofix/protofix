...
var (
	FIX50SP1NewOrderListMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1NewOrderList}
	FIX50SP1NewOrderListUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1NewOrderList}
)

// FIX50SP1NewOrderList is a FIX.5.0 servicepack 1 format of the NewOrderList message which maps the codecs into individual fields.
var FIX50SP1NewOrderList = f0.Format{
