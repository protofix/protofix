...
package fix50sp1newordermultileg
...
var (
	FIX50SP1NewOrderMultilegMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1NewOrderMultileg}
	FIX50SP1NewOrderMultilegUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1NewOrderMultileg}
)

// FIX50SP1NewOrderMultileg is a FIX.5.0 servicepack 1 format of the NewOrderMultileg message which maps the codecs into individual fields.
var FIX50SP1NewOrderMultileg = f0.Format{
	Fields: map[int]f0.Codec{
		...
		RefOrderIDSource1081:                    f0.Fld{Opt, f0.ASCII, f0.String("0" /* SECONDARYORDERID */, "1" /* ORDERID */, "2" /* MDENTRYID */, "3" /* QUOTEENTRYID */), f0.Con{1}},
