...
package fix50sp1derivativesecuritylist
...
var (
	FIX50SP1DerivativeSecurityListMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1DerivativeSecurityList}
	FIX50SP1DerivativeSecurityListUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1DerivativeSecurityList}
)

// FIX50SP1DerivativeSecurityList is a FIX.5.0 servicepack 1 format of the DerivativeSecurityList message which maps the codecs into individual fields.
var FIX50SP1DerivativeSecurityList = f0.Format{
