...
var (
	FIX50SP1AdvertisementMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1Advertisement}
	FIX50SP1AdvertisementUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1Advertisement}
)

// FIX50SP1Advertisement is a FIX.5.0 servicepack 1 format of the Advertisement message which maps the codecs into individual fields.
var FIX50SP1Advertisement = f0.Format{
