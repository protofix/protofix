...
package fix50sp1tradingsessionstatusrequest
...
var (
	FIX50SP1TradingSessionStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1TradingSessionStatusRequest}
	FIX50SP1TradingSessionStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1TradingSessionStatusRequest}
)

// FIX50SP1TradingSessionStatusRequest is a FIX.5.0 servicepack 1 format of the TradingSessionStatusRequest message which maps the codecs into individual fields.
var FIX50SP1TradingSessionStatusRequest = f0.Format{
