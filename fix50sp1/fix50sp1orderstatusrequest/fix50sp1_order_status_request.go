...
package fix50sp1orderstatusrequest
...
var (
	FIX50SP1OrderStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1OrderStatusRequest}
	FIX50SP1OrderStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1OrderStatusRequest}
)

// FIX50SP1OrderStatusRequest is a FIX.5.0 servicepack 1 format of the OrderStatusRequest message which maps the codecs into individual fields.
var FIX50SP1OrderStatusRequest = f0.Format{
