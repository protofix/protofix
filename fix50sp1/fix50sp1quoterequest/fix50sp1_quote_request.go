...
var (
	FIX50SP1QuoteRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1QuoteRequest}
	FIX50SP1QuoteRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1QuoteRequest}
)

// FIX50SP1QuoteRequest is a FIX.5.0 servicepack 1 format of the QuoteRequest message which maps the codecs into individual fields.
var FIX50SP1QuoteRequest = f0.Format{
