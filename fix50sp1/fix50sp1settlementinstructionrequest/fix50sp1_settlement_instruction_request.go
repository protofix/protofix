...
package fix50sp1settlementinstructionrequest
...
var (
	FIX50SP1SettlementInstructionRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1SettlementInstructionRequest}
	FIX50SP1SettlementInstructionRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1SettlementInstructionRequest}
)

// FIX50SP1SettlementInstructionRequest is a FIX.5.0 servicepack 1 format of the SettlementInstructionRequest message which maps the codecs into individual fields.
var FIX50SP1SettlementInstructionRequest = f0.Format{
