...
package fix50sp1ordercancelrequest
...
var (
	FIX50SP1OrderCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1OrderCancelRequest}
	FIX50SP1OrderCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1OrderCancelRequest}
)

// FIX50SP1OrderCancelRequest is a FIX.5.0 servicepack 1 format of the OrderCancelRequest message which maps the codecs into individual fields.
var FIX50SP1OrderCancelRequest = f0.Format{
