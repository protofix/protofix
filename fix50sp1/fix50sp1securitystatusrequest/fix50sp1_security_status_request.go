...
package fix50sp1securitystatusrequest
...
var (
	FIX50SP1SecurityStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityStatusRequest}
	FIX50SP1SecurityStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityStatusRequest}
)

// FIX50SP1SecurityStatusRequest is a FIX.5.0 servicepack 1 format of the SecurityStatusRequest message which maps the codecs into individual fields.
var FIX50SP1SecurityStatusRequest = f0.Format{
