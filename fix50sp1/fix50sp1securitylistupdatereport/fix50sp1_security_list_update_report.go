...
package fix50sp1securitylistupdatereport
...
var (
	FIX50SP1SecurityListUpdateReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityListUpdateReport}
	FIX50SP1SecurityListUpdateReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityListUpdateReport}
)

// FIX50SP1SecurityListUpdateReport is a FIX.5.0 servicepack 1 format of the SecurityListUpdateReport message which maps the codecs into individual fields.
var FIX50SP1SecurityListUpdateReport = f0.Format{
