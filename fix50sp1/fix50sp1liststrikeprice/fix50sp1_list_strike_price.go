...
package fix50sp1liststrikeprice
...
var (
	FIX50SP1ListStrikePriceMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1ListStrikePrice}
	FIX50SP1ListStrikePriceUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1ListStrikePrice}
)

// FIX50SP1ListStrikePrice is a FIX.5.0 servicepack 1 format of the ListStrikePrice message which maps the codecs into individual fields.
var FIX50SP1ListStrikePrice = f0.Format{
