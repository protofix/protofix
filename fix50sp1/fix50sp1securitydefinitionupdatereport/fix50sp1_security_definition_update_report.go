...
package fix50sp1securitydefinitionupdatereport
...
var (
	FIX50SP1SecurityDefinitionUpdateReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityDefinitionUpdateReport}
	FIX50SP1SecurityDefinitionUpdateReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityDefinitionUpdateReport}
)

// FIX50SP1SecurityDefinitionUpdateReport is a FIX.5.0 servicepack 1 format of the SecurityDefinitionUpdateReport message which maps the codecs into individual fields.
var FIX50SP1SecurityDefinitionUpdateReport = f0.Format{
