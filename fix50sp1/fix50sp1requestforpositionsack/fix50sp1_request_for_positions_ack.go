...
package fix50sp1requestforpositionsack
...
var (
	FIX50SP1RequestForPositionsAckMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1RequestForPositionsAck}
	FIX50SP1RequestForPositionsAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1RequestForPositionsAck}
)

// FIX50SP1RequestForPositionsAck is a FIX.5.0 servicepack 1 format of the RequestForPositionsAck message which maps the codecs into individual fields.
var FIX50SP1RequestForPositionsAck = f0.Format{
