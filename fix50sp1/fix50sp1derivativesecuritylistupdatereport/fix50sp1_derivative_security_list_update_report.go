...
package fix50sp1derivativesecuritylistupdatereport
...
var (
	FIX50SP1DerivativeSecurityListUpdateReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1DerivativeSecurityListUpdateReport}
	FIX50SP1DerivativeSecurityListUpdateReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1DerivativeSecurityListUpdateReport}
)

// FIX50SP1DerivativeSecurityListUpdateReport is a FIX.5.0 servicepack 1 format of the DerivativeSecurityListUpdateReport message which maps the codecs into individual fields.
var FIX50SP1DerivativeSecurityListUpdateReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		DerivativeFuturesValuationMethod1319:     f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
	...
	Sort: []int{
		...
		DerivativeFuturesValuationMethod1319,     // STRING
...
const (
	...
	DerivativeFuturesValuationMethod1319     = 1319 // STRING
