...
var (
	FIX50SP1SecurityListMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityList}
	FIX50SP1SecurityListUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityList}
)

// FIX50SP1SecurityList is a FIX.5.0 servicepack 1 format of the SecurityList message which maps the codecs into individual fields.
var FIX50SP1SecurityList = f0.Format{
