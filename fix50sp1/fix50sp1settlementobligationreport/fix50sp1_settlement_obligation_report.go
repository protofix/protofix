...
package fix50sp1settlementobligationreport
...
var (
	FIX50SP1SettlementObligationReportMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1SettlementObligationReport}
	FIX50SP1SettlementObligationReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1SettlementObligationReport}
)

// FIX50SP1SettlementObligationReport is a FIX.5.0 servicepack 1 format of the SettlementObligationReport message which maps the codecs into individual fields.
var FIX50SP1SettlementObligationReport = f0.Format{
	Fields: map[int]f0.Codec{
		ClearingBusinessDate715:             f0.Fld{Opt, f0.ASCII, f0.LocalMktDateTime(), f0.Con{8}},
		SettlementCycleNo1153:               f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		SettlObligMsgID1160:                 f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		SettlObligMode1159:                  f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* PRELIMINARY */, 2 /* FINAL */), f0.Var{1, 19}},
		...
		SettlObligID1161:                    f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		SettlObligTransType1162:             f0.Fld{Opt, f0.ASCII, f0.String("C" /* CANCEL */, "N" /* NEW */, "R" /* REPLACE */, "T" /* RESTATE */), f0.Con{1}},
		SettlObligRefID1163:                 f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		CcyAmt1157:                          f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
	...
	Sort: []int{
		...
		SettlementCycleNo1153,               // INT
		SettlObligMsgID1160,                 // STRING
		SettlObligMode1159,                  // INT
		Text58,                              // STRING
		EncodedTextLen354,                   // LENGTH
		EncodedText355,                      // DATA
		TransactTime60,                      // UTCTIMESTAMP
		NetGrossInd430,                      // INT
		SettlObligID1161,                    // STRING
		SettlObligTransType1162,             // CHAR
		SettlObligRefID1163,                 // STRING
		CcyAmt1157,                          // AMT
		SettlCurrAmt119,                     // AMT
		Currency15,                          // CURRENCY
...
const (
	...
	SettlementCycleNo1153               = 1153 // INT
	SettlObligMsgID1160                 = 1160 // STRING
	SettlObligMode1159                  = 1159 // INT
	Text58                              = 58   // STRING
	EncodedTextLen354                   = 354  // LENGTH
	EncodedText355                      = 355  // DATA
	TransactTime60                      = 60   // UTCTIMESTAMP
	NetGrossInd430                      = 430  // INT
	SettlObligID1161                    = 1161 // STRING
	SettlObligTransType1162             = 1162 // CHAR
	SettlObligRefID1163                 = 1163 // STRING
	CcyAmt1157                          = 1157 // AMT
