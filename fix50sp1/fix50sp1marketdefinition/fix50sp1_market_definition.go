...
package fix50sp1marketdefinition
...
var (
	FIX50SP1MarketDefinitionMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1MarketDefinition}
	FIX50SP1MarketDefinitionUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1MarketDefinition}
)

// FIX50SP1MarketDefinition is a FIX.5.0 servicepack 1 format of the MarketDefinition message which maps the codecs into individual fields.
var FIX50SP1MarketDefinition = f0.Format{
