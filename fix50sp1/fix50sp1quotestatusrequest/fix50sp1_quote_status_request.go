...
package fix50sp1quotestatusrequest
...
var (
	FIX50SP1QuoteStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1QuoteStatusRequest}
	FIX50SP1QuoteStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1QuoteStatusRequest}
)

// FIX50SP1QuoteStatusRequest is a FIX.5.0 servicepack 1 format of the QuoteStatusRequest message which maps the codecs into individual fields.
var FIX50SP1QuoteStatusRequest = f0.Format{
