...
var (
	FIX50SP1RFQRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1RFQRequest}
	FIX50SP1RFQRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1RFQRequest}
)

// FIX50SP1RFQRequest is a FIX.5.0 servicepack 1 format of the RFQRequest message which maps the codecs into individual fields.
var FIX50SP1RFQRequest = f0.Format{
