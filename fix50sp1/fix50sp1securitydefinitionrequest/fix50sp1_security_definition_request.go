...
package fix50sp1securitydefinitionrequest
...
var (
	FIX50SP1SecurityDefinitionRequestMarshaler   = marshfix.Marshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityDefinitionRequest}
	FIX50SP1SecurityDefinitionRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50SP1", Format: FIX50SP1SecurityDefinitionRequest}
)

// FIX50SP1SecurityDefinitionRequest is a FIX.5.0 servicepack 1 format of the SecurityDefinitionRequest message which maps the codecs into individual fields.
var FIX50SP1SecurityDefinitionRequest = f0.Format{
