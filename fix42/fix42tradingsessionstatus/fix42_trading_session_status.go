...
package fix42tradingsessionstatus
...
var (
	FIX42TradingSessionStatusMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42TradingSessionStatus}
	FIX42TradingSessionStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42TradingSessionStatus}
)

// FIX42TradingSessionStatus is a FIX.4.2 format of the TradingSessionStatus message which maps the codecs into individual fields.
var FIX42TradingSessionStatus = f0.Format{
	Fields: map[int]f0.Codec{
		...
		TradSesStatus340:          f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* HALTED */, 2 /* OPEN */, 3 /* CLOSED */, 4 /* PRE_OPEN */, 5 /* PRE_CLOSE */), f0.Var{1, 19}},
