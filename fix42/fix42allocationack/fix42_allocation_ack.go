...
var (
	FIX42AllocationACKMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42AllocationACK}
	FIX42AllocationACKUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42AllocationACK}
)

// FIX42AllocationACK is a FIX.4.2 format of the AllocationACK message which maps the codecs into individual fields.
var FIX42AllocationACK = f0.Format{
