...
package fix42marketdataincrementalrefresh
...
var (
	FIX42MarketDataIncrementalRefreshMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42MarketDataIncrementalRefresh}
	FIX42MarketDataIncrementalRefreshUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42MarketDataIncrementalRefresh}
)

// FIX42MarketDataIncrementalRefresh is a FIX.4.2 format of the MarketDataIncrementalRefresh message which maps the codecs into individual fields.
var FIX42MarketDataIncrementalRefresh = f0.Format{
