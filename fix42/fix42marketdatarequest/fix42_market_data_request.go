...
package fix42marketdatarequest
...
var (
	FIX42MarketDataRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42MarketDataRequest}
	FIX42MarketDataRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42MarketDataRequest}
)

// FIX42MarketDataRequest is a FIX.4.2 format of the MarketDataRequest message which maps the codecs into individual fields.
var FIX42MarketDataRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		AggregatedBook266:          f0.Fld{Opt, f0.ASCII, f0.BoolDefault(false /* NO */, true /* YES */), f0.Con{1}},
