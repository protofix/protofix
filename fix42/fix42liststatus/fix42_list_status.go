...
var (
	FIX42ListStatusMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42ListStatus}
	FIX42ListStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42ListStatus}
)

// FIX42ListStatus is a FIX.4.2 format of the ListStatus message which maps the codecs into individual fields.
var FIX42ListStatus = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ListStatusType429:           f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		NoRpts82:                    f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		ListOrderStatus431:          f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
