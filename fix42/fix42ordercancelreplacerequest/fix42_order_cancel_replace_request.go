...
package fix42ordercancelreplacerequest
...
var (
	FIX42OrderCancelReplaceRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42OrderCancelReplaceRequest}
	FIX42OrderCancelReplaceRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42OrderCancelReplaceRequest}
)

// FIX42OrderCancelReplaceRequest is a FIX.4.2 format of the OrderCancelReplaceRequest message which maps the codecs into individual fields.
var FIX42OrderCancelReplaceRequest = f0.Format{
