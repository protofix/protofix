...
var (
	FIX42EmailMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42Email}
	FIX42EmailUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42Email}
)

// FIX42Email is a FIX.4.2 format of the Email message which maps the codecs into individual fields.
var FIX42Email = f0.Format{
