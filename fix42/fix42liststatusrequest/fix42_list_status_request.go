...
package fix42liststatusrequest
...
var (
	FIX42ListStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42ListStatusRequest}
	FIX42ListStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42ListStatusRequest}
)

// FIX42ListStatusRequest is a FIX.4.2 format of the ListStatusRequest message which maps the codecs into individual fields.
var FIX42ListStatusRequest = f0.Format{
