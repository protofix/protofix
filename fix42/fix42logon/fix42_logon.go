...
var (
	FIX42LogonMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42Logon}
	FIX42LogonUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42Logon}
)

// FIX42Logon is a FIX.4.2 format of the Logon message which maps the codecs into individual fields.
var FIX42Logon = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MaxMessageSize383:         f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
