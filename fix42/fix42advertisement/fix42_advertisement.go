...
var (
	FIX42AdvertisementMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42Advertisement}
	FIX42AdvertisementUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42Advertisement}
)

// FIX42Advertisement is a FIX.4.2 format of the Advertisement message which maps the codecs into individual fields.
var FIX42Advertisement = f0.Format{
