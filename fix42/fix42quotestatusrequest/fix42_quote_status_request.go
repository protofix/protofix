...
package fix42quotestatusrequest
...
var (
	FIX42QuoteStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42QuoteStatusRequest}
	FIX42QuoteStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42QuoteStatusRequest}
)

// FIX42QuoteStatusRequest is a FIX.4.2 format of the QuoteStatusRequest message which maps the codecs into individual fields.
var FIX42QuoteStatusRequest = f0.Format{
