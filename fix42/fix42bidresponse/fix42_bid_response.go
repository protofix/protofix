...
var (
	FIX42BidResponseMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42BidResponse}
	FIX42BidResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42BidResponse}
)

// FIX42BidResponse is a FIX.4.2 format of the BidResponse message which maps the codecs into individual fields.
var FIX42BidResponse = f0.Format{
