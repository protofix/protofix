...
var (
	FIX42SequenceResetMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42SequenceReset}
	FIX42SequenceResetUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42SequenceReset}
)

// FIX42SequenceReset is a FIX.4.2 format of the SequenceReset message which maps the codecs into individual fields.
var FIX42SequenceReset = f0.Format{
	Fields: map[int]f0.Codec{
		...
		NewSeqNo36:                f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
