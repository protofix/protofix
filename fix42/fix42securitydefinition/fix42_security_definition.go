...
package fix42securitydefinition
...
var (
	FIX42SecurityDefinitionMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42SecurityDefinition}
	FIX42SecurityDefinitionUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42SecurityDefinition}
)

// FIX42SecurityDefinition is a FIX.4.2 format of the SecurityDefinition message which maps the codecs into individual fields.
var FIX42SecurityDefinition = f0.Format{
