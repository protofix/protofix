...
var (
	FIX42LogoutMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42Logout}
	FIX42LogoutUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42Logout}
)

// FIX42Logout is a FIX.4.2 format of the Logout message which maps the codecs into individual fields.
var FIX42Logout = f0.Format{
