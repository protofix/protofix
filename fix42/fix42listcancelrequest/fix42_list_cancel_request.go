...
package fix42listcancelrequest
...
var (
	FIX42ListCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42ListCancelRequest}
	FIX42ListCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42ListCancelRequest}
)

// FIX42ListCancelRequest is a FIX.4.2 format of the ListCancelRequest message which maps the codecs into individual fields.
var FIX42ListCancelRequest = f0.Format{
