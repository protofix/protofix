...
var (
	FIX42QuoteMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42Quote}
	FIX42QuoteUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42Quote}
)

// FIX42Quote is a FIX.4.2 format of the Quote message which maps the codecs into individual fields.
var FIX42Quote = f0.Format{
