...
var (
	FIX42RejectMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42Reject}
	FIX42RejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42Reject}
)

// FIX42Reject is a FIX.4.2 format of the Reject message which maps the codecs into individual fields.
var FIX42Reject = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SessionRejectReason373:    f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* INVALID_TAG_NUMBER */, 1 /* REQUIRED_TAG_MISSING */, 10 /* SENDINGTIME_ACCURACY_PROBLEM */, 11 /* INVALID_MSGTYPE */, 2 /* TAG_NOT_DEFINED_FOR_THIS_MESSAGE_TYPE */, 3 /* UNDEFINED_TAG */, 4 /* TAG_SPECIFIED_WITHOUT_A_VALUE */, 5 /* VALUE_IS_INCORRECT */, 6 /* INCORRECT_DATA_FORMAT_FOR_VALUE */, 7 /* DECRYPTION_PROBLEM */, 8 /* SIGNATURE_PROBLEM */, 9 /* COMPID_PROBLEM */), f0.Var{1, 19}},
