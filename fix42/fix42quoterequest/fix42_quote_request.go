...
var (
	FIX42QuoteRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42QuoteRequest}
	FIX42QuoteRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42QuoteRequest}
)

// FIX42QuoteRequest is a FIX.4.2 format of the QuoteRequest message which maps the codecs into individual fields.
var FIX42QuoteRequest = f0.Format{
