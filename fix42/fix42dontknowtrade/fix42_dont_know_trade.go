...
var (
	FIX42DontKnowTradeMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42DontKnowTrade}
	FIX42DontKnowTradeUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42DontKnowTrade}
)

// FIX42DontKnowTrade is a FIX.4.2 format of the DontKnowTrade message which maps the codecs into individual fields.
var FIX42DontKnowTrade = f0.Format{
