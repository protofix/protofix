...
package fix42indicationofinterest
...
var (
	FIX42IndicationofInterestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42IndicationofInterest}
	FIX42IndicationofInterestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42IndicationofInterest}
)

// FIX42IndicationofInterest is a FIX.4.2 format of the IndicationofInterest message which maps the codecs into individual fields.
var FIX42IndicationofInterest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		IOIShares27:               f0.Fld{Req, f0.ASCII, f0.String("L" /* LARGE */, "M" /* MEDIUM */, "S" /* SMALL */), f0.Var{1, 65536}},
		...
		SpreadToBenchmark218:      f0.Fld{Opt, f0.ASCII, f0.Float(), f0.Var{1, 19}},
		Benchmark219:              f0.Fld{Opt, f0.ASCII, f0.String("1" /* CURVE */, "2" /* 5_YR */, "3" /* OLD_5 */, "4" /* 10_YR */, "5" /* OLD_10 */, "6" /* 30_YR */, "7" /* OLD_30 */, "8" /* 3_MO_LIBOR */, "9" /* 6_MO_LIBOR */), f0.Con{1}},
	...
	Sort: []int{
		...
		URLLink149,                // STRING
		SpreadToBenchmark218,      // PRICEOFFSET
		Benchmark219,              // CHAR
...
const (
	...
	SpreadToBenchmark218      = 218 // PRICEOFFSET
