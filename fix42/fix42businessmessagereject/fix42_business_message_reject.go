...
package fix42businessmessagereject
...
var (
	FIX42BusinessMessageRejectMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42BusinessMessageReject}
	FIX42BusinessMessageRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42BusinessMessageReject}
)

// FIX42BusinessMessageReject is a FIX.4.2 format of the BusinessMessageReject message which maps the codecs into individual fields.
var FIX42BusinessMessageReject = f0.Format{
	Fields: map[int]f0.Codec{
		...
		RefSeqNum45:               f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		...
		BusinessRejectReason380:   f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* OTHER */, 1 /* UNKOWN_ID */, 2 /* UNKNOWN_SECURITY */, 3 /* UNSUPPORTED_MESSAGE_TYPE */, 4 /* APPLICATION_NOT_AVAILABLE */, 5 /* CONDITIONALLY_REQUIRED_FIELD_MISSING */), f0.Var{1, 19}},
