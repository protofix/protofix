...
var (
	FIX42ListStrikePriceMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42ListStrikePrice}
	FIX42ListStrikePriceUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42ListStrikePrice}
)

// FIX42ListStrikePrice is a FIX.4.2 format of the ListStrikePrice message which maps the codecs into individual fields.
var FIX42ListStrikePrice = f0.Format{
