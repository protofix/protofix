...
var (
	FIX42NewsMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42News}
	FIX42NewsUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42News}
)

// FIX42News is a FIX.4.2 format of the News message which maps the codecs into individual fields.
var FIX42News = f0.Format{
