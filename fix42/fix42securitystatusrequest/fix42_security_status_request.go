...
package fix42securitystatusrequest
...
var (
	FIX42SecurityStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42SecurityStatusRequest}
	FIX42SecurityStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42SecurityStatusRequest}
)

// FIX42SecurityStatusRequest is a FIX.4.2 format of the SecurityStatusRequest message which maps the codecs into individual fields.
var FIX42SecurityStatusRequest = f0.Format{
