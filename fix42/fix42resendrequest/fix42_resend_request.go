...
var (
	FIX42ResendRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42ResendRequest}
	FIX42ResendRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42ResendRequest}
)

// FIX42ResendRequest is a FIX.4.2 format of the ResendRequest message which maps the codecs into individual fields.
var FIX42ResendRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		BeginSeqNo7:               f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		EndSeqNo16:                f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
