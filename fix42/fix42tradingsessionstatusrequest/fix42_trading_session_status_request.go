...
package fix42tradingsessionstatusrequest
...
var (
	FIX42TradingSessionStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42TradingSessionStatusRequest}
	FIX42TradingSessionStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42TradingSessionStatusRequest}
)

// FIX42TradingSessionStatusRequest is a FIX.4.2 format of the TradingSessionStatusRequest message which maps the codecs into individual fields.
var FIX42TradingSessionStatusRequest = f0.Format{
