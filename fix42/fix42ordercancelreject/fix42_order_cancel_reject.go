...
package fix42ordercancelreject
...
var (
	FIX42OrderCancelRejectMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42OrderCancelReject}
	FIX42OrderCancelRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42OrderCancelReject}
)

// FIX42OrderCancelReject is a FIX.4.2 format of the OrderCancelReject message which maps the codecs into individual fields.
var FIX42OrderCancelReject = f0.Format{
	Fields: map[int]f0.Codec{
		...
		CxlRejReason102:           f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* TOO_LATE_TO_CANCEL */, 1 /* UNKNOWN_ORDER */, 2 /* BROKER_OPTION */, 3 /* ORDER_ALREADY_IN_PENDING_CANCEL_OR_PENDING_REPLACE_STATUS */), f0.Var{1, 19}},
