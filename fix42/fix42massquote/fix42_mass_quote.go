...
var (
	FIX42MassQuoteMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42MassQuote}
	FIX42MassQuoteUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42MassQuote}
)

// FIX42MassQuote is a FIX.4.2 format of the MassQuote message which maps the codecs into individual fields.
var FIX42MassQuote = f0.Format{
