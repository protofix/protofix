...
var (
	FIX42ListExecuteMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42ListExecute}
	FIX42ListExecuteUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42ListExecute}
)

// FIX42ListExecute is a FIX.4.2 format of the ListExecute message which maps the codecs into individual fields.
var FIX42ListExecute = f0.Format{
