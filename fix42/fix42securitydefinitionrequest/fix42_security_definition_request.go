...
package fix42securitydefinitionrequest
...
var (
	FIX42SecurityDefinitionRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42SecurityDefinitionRequest}
	FIX42SecurityDefinitionRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42SecurityDefinitionRequest}
)

// FIX42SecurityDefinitionRequest is a FIX.4.2 format of the SecurityDefinitionRequest message which maps the codecs into individual fields.
var FIX42SecurityDefinitionRequest = f0.Format{
