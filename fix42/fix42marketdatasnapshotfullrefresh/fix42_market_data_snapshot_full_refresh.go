...
package fix42marketdatasnapshotfullrefresh
...
var (
	FIX42MarketDataSnapshotFullRefreshMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42MarketDataSnapshotFullRefresh}
	FIX42MarketDataSnapshotFullRefreshUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42MarketDataSnapshotFullRefresh}
)

// FIX42MarketDataSnapshotFullRefresh is a FIX.4.2 format of the MarketDataSnapshotFullRefresh message which maps the codecs into individual fields.
var FIX42MarketDataSnapshotFullRefresh = f0.Format{
