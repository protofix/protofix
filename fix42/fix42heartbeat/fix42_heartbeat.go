...
var (
	FIX42HeartbeatMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42Heartbeat}
	FIX42HeartbeatUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42Heartbeat}
)

// FIX42Heartbeat is a FIX.4.2 format of the Heartbeat message which maps the codecs into individual fields.
var FIX42Heartbeat = f0.Format{
