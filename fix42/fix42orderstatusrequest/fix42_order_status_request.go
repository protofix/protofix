...
package fix42orderstatusrequest
...
var (
	FIX42OrderStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42OrderStatusRequest}
	FIX42OrderStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42OrderStatusRequest}
)

// FIX42OrderStatusRequest is a FIX.4.2 format of the OrderStatusRequest message which maps the codecs into individual fields.
var FIX42OrderStatusRequest = f0.Format{
