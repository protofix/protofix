...
var (
	FIX42AllocationMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42Allocation}
	FIX42AllocationUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42Allocation}
)

// FIX42Allocation is a FIX.4.2 format of the Allocation message which maps the codecs into individual fields.
var FIX42Allocation = f0.Format{
	Fields: map[int]f0.Codec{
		...
		AllocTransType71:          f0.Fld{Req, f0.ASCII, f0.String("0" /* NEW */, "1" /* REPLACE */, "2" /* CANCEL */, "3" /* PRELIMINARY */, "4" /* CALCULATED */, "5" /* CALCULATED_WITHOUT_PRELIMINARY */), f0.Con{1}},
		...
		Shares53:                  f0.Fld{Req, f0.ASCII, f0.Float(), f0.Var{1, 19}},
