...
package fix42quoteacknowledgement
...
var (
	FIX42QuoteAcknowledgementMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42QuoteAcknowledgement}
	FIX42QuoteAcknowledgementUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42QuoteAcknowledgement}
)

// FIX42QuoteAcknowledgement is a FIX.4.2 format of the QuoteAcknowledgement message which maps the codecs into individual fields.
var FIX42QuoteAcknowledgement = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteAckStatus297:         f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* ACCEPTED */, 1 /* CANCELED_FOR_SYMBOL */, 2 /* CANCELED_FOR_SECURITY_TYPE */, 3 /* CANCELED_FOR_UNDERLYING */, 4 /* CANCELED_ALL */, 5 /* REJECTED */), f0.Var{1, 19}},
		QuoteRejectReason300:      f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* UNKNOWN_SYMBOL */, 2 /* EXCHANGE */, 3 /* QUOTE_REQUEST_EXCEEDS_LIMIT */, 4 /* TOO_LATE_TO_ENTER */, 5 /* UNKNOWN_QUOTE */, 6 /* DUPLICATE_QUOTE */, 7 /* INVALID_BID_ASK_SPREAD */, 8 /* INVALID_PRICE */, 9 /* NOT_AUTHORIZED_TO_QUOTE_SECURITY */), f0.Var{1, 19}},
