...
var (
	FIX42SecurityStatusMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42SecurityStatus}
	FIX42SecurityStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42SecurityStatus}
)

// FIX42SecurityStatus is a FIX.4.2 format of the SecurityStatus message which maps the codecs into individual fields.
var FIX42SecurityStatus = f0.Format{
	Fields: map[int]f0.Codec{
		...
		FinancialStatus291:        f0.Fld{Opt, f0.ASCII, f0.String("1" /* BANKRUPT */), f0.Con{1}},
		CorporateAction292:        f0.Fld{Opt, f0.ASCII, f0.String("A" /* EX_DIVIDEND */, "B" /* EX_DISTRIBUTION */, "C" /* EX_RIGHTS */, "D" /* NEW */, "E" /* EX_INTEREST */), f0.Con{1}},
		HaltReasonChar327:         f0.Fld{Opt, f0.ASCII, f0.String("D" /* NEWS_DISSEMINATION */, "E" /* ORDER_INFLUX */, "I" /* ORDER_IMBALANCE */, "M" /* ADDITIONAL_INFORMATION */, "P" /* NEWS_PENDING */, "X" /* EQUIPMENT_CHANGEOVER */), f0.Con{1}},
	...
	Sort: []int{
		...
		FinancialStatus291,        // CHAR
		CorporateAction292,        // CHAR
...
const (
	...
	FinancialStatus291        = 291 // CHAR
	CorporateAction292        = 292 // CHAR
