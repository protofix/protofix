...
var (
	FIX42QuoteCancelMarshaler   = marshfix.Marshal{Tag: "FIX42", Format: FIX42QuoteCancel}
	FIX42QuoteCancelUnmarshaler = marshfix.Unmarshal{Tag: "FIX42", Format: FIX42QuoteCancel}
)

// FIX42QuoteCancel is a FIX.4.2 format of the QuoteCancel message which maps the codecs into individual fields.
var FIX42QuoteCancel = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteCancelType298:        f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* CANCEL_FOR_SYMBOL */, 2 /* CANCEL_FOR_SECURITY_TYPE */, 3 /* CANCEL_FOR_UNDERLYING_SYMBOL */, 4 /* CANCEL_FOR_ALL_QUOTES */), f0.Var{1, 19}},
