...
var (
	MOEX44UserRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44UserRequest}
	MOEX44UserRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44UserRequest}
)

// MOEX44UserRequest is a MOEX.4.4 (FIX.4.4) format of the UserRequest message which maps the codecs into individual fields.
var MOEX44UserRequest = f0.Format{
