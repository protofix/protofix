...
package moex44securitydefinition
...
var (
	MOEX44SecurityDefinitionMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44SecurityDefinition}
	MOEX44SecurityDefinitionUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44SecurityDefinition}
)

// MOEX44SecurityDefinition is a MOEX.4.4 (FIX.4.4) format of the SecurityDefinition message which maps the codecs into individual fields.
var MOEX44SecurityDefinition = f0.Format{
