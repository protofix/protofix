...
package moex44crossordercancelrequest
...
var (
	MOEX44CrossOrderCancelRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44CrossOrderCancelRequest}
	MOEX44CrossOrderCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44CrossOrderCancelRequest}
)

// MOEX44CrossOrderCancelRequest is a MOEX.4.4 (FIX.4.4) format of the CrossOrderCancelRequest message which maps the codecs into individual fields.
var MOEX44CrossOrderCancelRequest = f0.Format{
