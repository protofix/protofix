...
package moex44securitylistrequest
...
var (
	MOEX44SecurityListRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44SecurityListRequest}
	MOEX44SecurityListRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44SecurityListRequest}
)

// MOEX44SecurityListRequest is a MOEX.4.4 (FIX.4.4) format of the SecurityListRequest message which maps the codecs into individual fields.
var MOEX44SecurityListRequest = f0.Format{
