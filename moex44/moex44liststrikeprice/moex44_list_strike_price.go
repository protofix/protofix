...
var (
	MOEX44ListStrikePriceMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44ListStrikePrice}
	MOEX44ListStrikePriceUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44ListStrikePrice}
)

// MOEX44ListStrikePrice is a MOEX.4.4 (FIX.4.4) format of the ListStrikePrice message which maps the codecs into individual fields.
var MOEX44ListStrikePrice = f0.Format{
