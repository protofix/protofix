...
package moex44tradingsessionstatusrequest
...
var (
	MOEX44TradingSessionStatusRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44TradingSessionStatusRequest}
	MOEX44TradingSessionStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44TradingSessionStatusRequest}
)

// MOEX44TradingSessionStatusRequest is a MOEX.4.4 (FIX.4.4) format of the TradingSessionStatusRequest message which maps the codecs into individual fields.
var MOEX44TradingSessionStatusRequest = f0.Format{
