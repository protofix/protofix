...
package moex44liststatusrequest
...
var (
	MOEX44ListStatusRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44ListStatusRequest}
	MOEX44ListStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44ListStatusRequest}
)

// MOEX44ListStatusRequest is a MOEX.4.4 (FIX.4.4) format of the ListStatusRequest message which maps the codecs into individual fields.
var MOEX44ListStatusRequest = f0.Format{
