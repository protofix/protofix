...
package moex44quoterequestreject
...
var (
	MOEX44QuoteRequestRejectMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44QuoteRequestReject}
	MOEX44QuoteRequestRejectUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44QuoteRequestReject}
)

// MOEX44QuoteRequestReject is a MOEX.4.4 (FIX.4.4) format of the QuoteRequestReject message which maps the codecs into individual fields.
var MOEX44QuoteRequestReject = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteRequestRejectReason658: f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* UNKNOWNSYM */, 10 /* PASS */, 2 /* EXCHANGECLOSED */, 3 /* QUOTEREQUESTEXLIMIT */, 4 /* TOOLATE */, 5 /* INVPRICE */, 6 /* NOTAUTHTOREQQUOTE */, 7 /* NOMATCHFORINQUIRY */, 8 /* NOMARKETFORINSTRUMENT */, 9 /* NOINVENTORY */, 99 /* OTHER */), f0.Var{1, 19}},
