...
var (
	MOEX44BidResponseMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44BidResponse}
	MOEX44BidResponseUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44BidResponse}
)

// MOEX44BidResponse is a MOEX.4.4 (FIX.4.4) format of the BidResponse message which maps the codecs into individual fields.
var MOEX44BidResponse = f0.Format{
