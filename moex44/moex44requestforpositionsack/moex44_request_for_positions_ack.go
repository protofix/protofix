...
package moex44requestforpositionsack
...
var (
	MOEX44RequestForPositionsAckMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44RequestForPositionsAck}
	MOEX44RequestForPositionsAckUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44RequestForPositionsAck}
)

// MOEX44RequestForPositionsAck is a MOEX.4.4 (FIX.4.4) format of the RequestForPositionsAck message which maps the codecs into individual fields.
var MOEX44RequestForPositionsAck = f0.Format{
	Fields: map[int]f0.Codec{
		...
		PosReqStatus729:               f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* COMPLETED */, 1 /* COMPLETEDWITHWARNINGS */, 2 /* REJECTED */), f0.Var{1, 19}},
