...
var (
	MOEX44LogoutMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44Logout}
	MOEX44LogoutUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44Logout}
)

// MOEX44Logout is a MOEX.4.4 (FIX.4.4) format of the Logout message which maps the codecs into individual fields.
var MOEX44Logout = f0.Format{
