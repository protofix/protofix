...
var (
	MOEX44QuoteRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44QuoteRequest}
	MOEX44QuoteRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44QuoteRequest}
)

// MOEX44QuoteRequest is a MOEX.4.4 (FIX.4.4) format of the QuoteRequest message which maps the codecs into individual fields.
var MOEX44QuoteRequest = f0.Format{
