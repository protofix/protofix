...
var (
	MOEX44SecurityStatusMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44SecurityStatus}
	MOEX44SecurityStatusUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44SecurityStatus}
)

// MOEX44SecurityStatus is a MOEX.4.4 (FIX.4.4) format of the SecurityStatus message which maps the codecs into individual fields.
var MOEX44SecurityStatus = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SecurityTradingStatus326:      f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* OPENDELAY */, 10 /* MKTONCLSIMBSELL */, 11 /* NA */, 12 /* NOMKTIMB */, 13 /* NOMKTONCLSIMB */, 14 /* ITSPREOPN */, 15 /* NEWPXIND */, 16 /* TRDDISTIME */, 17 /* READY */, 18 /* NOTAVAIL */, 19 /* NOTTRADED */, 2 /* TRDHALT */, 20 /* UNKNOWN */, 21 /* PRE_OPEN */, 22 /* OPENINGROTATION */, 23 /* FASTMARKET */, 3 /* RESUME */, 4 /* NOOPEN */, 5 /* PXIND */, 6 /* TRDRNGIND */, 7 /* MKTIMBBUY */, 8 /* MKTBALSELL */, 9 /* MKTONCLSIMBBUY */), f0.Var{1, 19}},
		...
		HaltReasonChar327:             f0.Fld{Opt, f0.ASCII, f0.String("D" /* NEWSDISS */, "E" /* ORDINFL */, "I" /* ORDIMB */, "M" /* ADDINFO */, "P" /* NEWSPEND */, "X" /* EQUIPCHANGE */), f0.Con{1}},
