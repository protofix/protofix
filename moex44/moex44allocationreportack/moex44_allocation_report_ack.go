...
package moex44allocationreportack
...
var (
	MOEX44AllocationReportAckMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44AllocationReportAck}
	MOEX44AllocationReportAckUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44AllocationReportAck}
)

// MOEX44AllocationReportAck is a MOEX.4.4 (FIX.4.4) format of the AllocationReportAck message which maps the codecs into individual fields.
var MOEX44AllocationReportAck = f0.Format{
