...
package moex44collateralreport
...
var (
	MOEX44CollateralReportMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44CollateralReport}
	MOEX44CollateralReportUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44CollateralReport}
)

// MOEX44CollateralReport is a MOEX.4.4 (FIX.4.4) format of the CollateralReport message which maps the codecs into individual fields.
var MOEX44CollateralReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		CollStatus910:                 f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* UNASSIGNED */, 1 /* PARTIALLYASSIGNED */, 2 /* ASSIGNMENTPROPOSED */, 3 /* ASSIGNEDACCEPTED */, 4 /* CHALLENGED */), f0.Var{1, 19}},
