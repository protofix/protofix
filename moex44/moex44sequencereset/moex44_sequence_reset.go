...
var (
	MOEX44SequenceResetMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44SequenceReset}
	MOEX44SequenceResetUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44SequenceReset}
)

// MOEX44SequenceReset is a MOEX.4.4 (FIX.4.4) format of the SequenceReset message which maps the codecs into individual fields.
var MOEX44SequenceReset = f0.Format{
	Fields: map[int]f0.Codec{
		...
		GapFillFlag123:     f0.Fld{Opt, f0.ASCII, f0.BoolDefault(false /* NO */, true /* YES */), f0.Con{1}},
