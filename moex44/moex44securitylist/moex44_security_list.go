...
var (
	MOEX44SecurityListMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44SecurityList}
	MOEX44SecurityListUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44SecurityList}
)

// MOEX44SecurityList is a MOEX.4.4 (FIX.4.4) format of the SecurityList message which maps the codecs into individual fields.
var MOEX44SecurityList = f0.Format{
