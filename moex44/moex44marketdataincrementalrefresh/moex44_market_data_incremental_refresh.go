...
package moex44marketdataincrementalrefresh
...
var (
	MOEX44MarketDataIncrementalRefreshMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44MarketDataIncrementalRefresh}
	MOEX44MarketDataIncrementalRefreshUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44MarketDataIncrementalRefresh}
)

// MOEX44MarketDataIncrementalRefresh is a MOEX.4.4 (FIX.4.4) format of the MarketDataIncrementalRefresh message which maps the codecs into individual fields.
var MOEX44MarketDataIncrementalRefresh = f0.Format{
