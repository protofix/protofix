...
package moex44businessmessagereject
...
var (
	MOEX44BusinessMessageRejectMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44BusinessMessageReject}
	MOEX44BusinessMessageRejectUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44BusinessMessageReject}
)

// MOEX44BusinessMessageReject is a MOEX.4.4 (FIX.4.4) format of the BusinessMessageReject message which maps the codecs into individual fields.
var MOEX44BusinessMessageReject = f0.Format{
	Fields: map[int]f0.Codec{
		...
		BusinessRejectReason380: f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* OTHER */, 1 /* UNKNID */, 2 /* UNKNSEC */, 3 /* UNKNMSGTYPE */, 4 /* APPNA */, 5 /* CONDFLDMISS */, 6 /* NOTAUTH */, 7 /* NODELIVTOFIRM */), f0.Var{1, 19}},
