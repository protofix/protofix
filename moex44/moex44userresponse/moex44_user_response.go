...
var (
	MOEX44UserResponseMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44UserResponse}
	MOEX44UserResponseUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44UserResponse}
)

// MOEX44UserResponse is a MOEX.4.4 (FIX.4.4) format of the UserResponse message which maps the codecs into individual fields.
var MOEX44UserResponse = f0.Format{
	Fields: map[int]f0.Codec{
		...
		UserStatus926:      f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* LOGGEDIN */, 2 /* NOTLOGGEDIN */, 3 /* USERNOTRECOGNISED */, 4 /* PASSWORDINCORRECT */, 5 /* PASSWORDCHANGED */, 6 /* OTHER */), f0.Var{1, 19}},
