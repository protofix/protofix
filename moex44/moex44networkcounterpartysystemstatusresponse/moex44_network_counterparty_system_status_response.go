...
package moex44networkcounterpartysystemstatusresponse
...
var (
	MOEX44NetworkCounterpartySystemStatusResponseMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44NetworkCounterpartySystemStatusResponse}
	MOEX44NetworkCounterpartySystemStatusResponseUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44NetworkCounterpartySystemStatusResponse}
)

// MOEX44NetworkCounterpartySystemStatusResponse is a MOEX.4.4 (FIX.4.4) format of the NetworkCounterpartySystemStatusResponse message which maps the codecs into individual fields.
var MOEX44NetworkCounterpartySystemStatusResponse = f0.Format{
	Fields: map[int]f0.Codec{
		...
		NetworkStatusResponseType937: f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* FULL */, 2 /* INCREMENTALUPDATE */), f0.Var{1, 19}},
