...
package moex44ordercancelrequest
...
var (
	MOEX44OrderCancelRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44OrderCancelRequest}
	MOEX44OrderCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44OrderCancelRequest}
)

// MOEX44OrderCancelRequest is a MOEX.4.4 (FIX.4.4) format of the OrderCancelRequest message which maps the codecs into individual fields.
var MOEX44OrderCancelRequest = f0.Format{
