...
package moex44ordermasscancelreport
...
var (
	MOEX44OrderMassCancelReportMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44OrderMassCancelReport}
	MOEX44OrderMassCancelReportUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44OrderMassCancelReport}
)

// MOEX44OrderMassCancelReport is a MOEX.4.4 (FIX.4.4) format of the OrderMassCancelReport message which maps the codecs into individual fields.
var MOEX44OrderMassCancelReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MassCancelRequestType530:                f0.Fld{Req, f0.ASCII, f0.String("1" /* CXLORDERSSECURITY */, "2" /* CXLORDERSUNDERLYINGSECURITY */, "3" /* CXLORDERSPRODUCT */, "4" /* CXLORDERSCFICODE */, "5" /* CXLORDERSSECURITYTYPE */, "6" /* CXLORDERSTRDSESSION */, "7" /* CXLALLORDERS */), f0.Con{1}},
		MassCancelResponse531:                   f0.Fld{Req, f0.ASCII, f0.String("0" /* CXLREQREJ */, "1" /* CXLORDERSSECURITY */, "2" /* CXLORDERSUNDERLYINGSECURITY */, "3" /* CXLORDERSPRODUCT */, "4" /* CXLORDERSCFICODE */, "5" /* CXLORDERSSECURITYTYPE */, "6" /* CXLORDERSTRDSESSION */, "7" /* CXLALLORDERS */), f0.Con{1}},
		MassCancelRejectReason532:               f0.Fld{Opt, f0.ASCII, f0.String("0" /* MASSCXLNOTSUPPORTED */, "1" /* INVALIDSECURITY */, "2" /* INVALIDUNDERLYING */, "3" /* INVALIDPRODUCT */, "4" /* INVALIDCFICODE */, "5" /* INVALIDSECURITYTYPE */, "6" /* INVALIDTRDSESSION */, "99" /* OTHER */), f0.Con{1}},
	...
	Sort: []int{
		...
		MassCancelRejectReason532,               // CHAR
...
const (
	...
	MassCancelRejectReason532               = 532 // CHAR
