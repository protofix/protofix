...
var (
	MOEX44NewOrderSingleMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44NewOrderSingle}
	MOEX44NewOrderSingleUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44NewOrderSingle}
)

// MOEX44NewOrderSingle is a MOEX.4.4 (FIX.4.4) format of the NewOrderSingle message which maps the codecs into individual fields.
var MOEX44NewOrderSingle = f0.Format{
