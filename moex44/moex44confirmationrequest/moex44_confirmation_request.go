...
package moex44confirmationrequest
...
var (
	MOEX44ConfirmationRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44ConfirmationRequest}
	MOEX44ConfirmationRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44ConfirmationRequest}
)

// MOEX44ConfirmationRequest is a MOEX.4.4 (FIX.4.4) format of the ConfirmationRequest message which maps the codecs into individual fields.
var MOEX44ConfirmationRequest = f0.Format{
