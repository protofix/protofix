...
var (
	MOEX44AdvertisementMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44Advertisement}
	MOEX44AdvertisementUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44Advertisement}
)

// MOEX44Advertisement is a MOEX.4.4 (FIX.4.4) format of the Advertisement message which maps the codecs into individual fields.
var MOEX44Advertisement = f0.Format{
	Fields: map[int]f0.Codec{
		...
		AdvTransType5:                 f0.Fld{Req, f0.ASCII, f0.String("C" /* ADVCANCEL */, "N" /* ADVNEW */, "R" /* ADVREPLACE */), f0.Var{1, 65536}},
