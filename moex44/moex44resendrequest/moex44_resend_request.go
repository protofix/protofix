...
var (
	MOEX44ResendRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44ResendRequest}
	MOEX44ResendRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44ResendRequest}
)

// MOEX44ResendRequest is a MOEX.4.4 (FIX.4.4) format of the ResendRequest message which maps the codecs into individual fields.
var MOEX44ResendRequest = f0.Format{
