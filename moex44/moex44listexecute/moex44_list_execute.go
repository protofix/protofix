...
var (
	MOEX44ListExecuteMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44ListExecute}
	MOEX44ListExecuteUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44ListExecute}
)

// MOEX44ListExecute is a MOEX.4.4 (FIX.4.4) format of the ListExecute message which maps the codecs into individual fields.
var MOEX44ListExecute = f0.Format{
