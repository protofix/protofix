...
var (
	MOEX44TestRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44TestRequest}
	MOEX44TestRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44TestRequest}
)

// MOEX44TestRequest is a MOEX.4.4 (FIX.4.4) format of the TestRequest message which maps the codecs into individual fields.
var MOEX44TestRequest = f0.Format{
