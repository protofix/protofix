...
package moex44quotestatusreport
...
var (
	MOEX44QuoteStatusReportMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44QuoteStatusReport}
	MOEX44QuoteStatusReportUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44QuoteStatusReport}
)

// MOEX44QuoteStatusReport is a MOEX.4.4 (FIX.4.4) format of the QuoteStatusReport message which maps the codecs into individual fields.
var MOEX44QuoteStatusReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteStatus297:                f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* ACCPT */, 1 /* CXLSYM */, 10 /* PENDING */, 11 /* PASS */, 12 /* LOCKEDMARKETWARNING */, 13 /* CROSSMARKETWARNING */, 14 /* CANCELEDDUETOLOCKMARKET */, 15 /* CANCELEDDUETOCROSSMARKET */, 2 /* CXLSECTYPE */, 3 /* CXLUNDER */, 4 /* CXLALL */, 5 /* REJ */, 6 /* REMOVED */, 7 /* EXPIRED */, 8 /* QUERY */, 9 /* QUOTENOTFOUND */), f0.Var{1, 19}},
