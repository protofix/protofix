...
var (
	MOEX44NewOrderCrossMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44NewOrderCross}
	MOEX44NewOrderCrossUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44NewOrderCross}
)

// MOEX44NewOrderCross is a MOEX.4.4 (FIX.4.4) format of the NewOrderCross message which maps the codecs into individual fields.
var MOEX44NewOrderCross = f0.Format{
