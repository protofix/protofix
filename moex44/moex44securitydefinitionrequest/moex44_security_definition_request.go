...
package moex44securitydefinitionrequest
...
var (
	MOEX44SecurityDefinitionRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44SecurityDefinitionRequest}
	MOEX44SecurityDefinitionRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44SecurityDefinitionRequest}
)

// MOEX44SecurityDefinitionRequest is a MOEX.4.4 (FIX.4.4) format of the SecurityDefinitionRequest message which maps the codecs into individual fields.
var MOEX44SecurityDefinitionRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SecurityRequestType321:        f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* REQSECID */, 1 /* REQSECIDPROV */, 2 /* REQSECLISTTYPES */, 3 /* REQSECLIST */), f0.Var{1, 19}},
		...
		ExpirationCycle827:            f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* EXPIREONTRADINGSESSIONCLOSE */, 1 /* EXPIREONTRADINGSESSIONOPEN */), f0.Var{1, 19}},
