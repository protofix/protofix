...
package moex44settlementinstructions
...
var (
	MOEX44SettlementInstructionsMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44SettlementInstructions}
	MOEX44SettlementInstructionsUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44SettlementInstructions}
)

// MOEX44SettlementInstructions is a MOEX.4.4 (FIX.4.4) format of the SettlementInstructions message which maps the codecs into individual fields.
var MOEX44SettlementInstructions = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SettlInstMode160:       f0.Fld{Req, f0.ASCII, f0.String("0" /* DEFAULT */, "1" /* SIPROVIDED */, "2" /* ACCOUNTOVERRIDING */, "3" /* ACCOUNTSTANDING */, "4" /* CIVORDERSINGLEACCT */, "5" /* REJECT */), f0.Con{1}},
		SettlInstReqRejCode792: f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* UNABLETOPROCESSREQUEST */, 1 /* UNKNOWNACCOUNT */, 2 /* NOMATCHINGSETTLEMENTINSTRUCTIONSFOUND */, 99 /* OTHER */), f0.Var{1, 19}},
