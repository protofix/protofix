...
package moex44quotestatusrequest
...
var (
	MOEX44QuoteStatusRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44QuoteStatusRequest}
	MOEX44QuoteStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44QuoteStatusRequest}
)

// MOEX44QuoteStatusRequest is a MOEX.4.4 (FIX.4.4) format of the QuoteStatusRequest message which maps the codecs into individual fields.
var MOEX44QuoteStatusRequest = f0.Format{
