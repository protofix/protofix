...
var (
	MOEX44DontKnowTradeMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44DontKnowTrade}
	MOEX44DontKnowTradeUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44DontKnowTrade}
)

// MOEX44DontKnowTrade is a MOEX.4.4 (FIX.4.4) format of the DontKnowTrade message which maps the codecs into individual fields.
var MOEX44DontKnowTrade = f0.Format{
	Fields: map[int]f0.Codec{
		...
		DKReason127:                   f0.Fld{Req, f0.ASCII, f0.String("A" /* UNKNOWNSYMBOL */, "B" /* WRONGSIDE */, "C" /* QUANTITYEXCEEDSORDER */, "D" /* NOMATCH */, "E" /* PRICEEXCEEDSLIMIT */, "F" /* CALCULATIONDIFFERENCE */, "Z" /* OTHER */), f0.Con{1}},
