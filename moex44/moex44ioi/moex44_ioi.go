...
var (
	MOEX44IOIMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44IOI}
	MOEX44IOIUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44IOI}
)

// MOEX44IOI is a MOEX.4.4 (FIX.4.4) format of the IOI message which maps the codecs into individual fields.
var MOEX44IOI = f0.Format{
