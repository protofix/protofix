...
package moex44networkcounterpartysystemstatusrequest
...
var (
	MOEX44NetworkCounterpartySystemStatusRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44NetworkCounterpartySystemStatusRequest}
	MOEX44NetworkCounterpartySystemStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44NetworkCounterpartySystemStatusRequest}
)

// MOEX44NetworkCounterpartySystemStatusRequest is a MOEX.4.4 (FIX.4.4) format of the NetworkCounterpartySystemStatusRequest message which maps the codecs into individual fields.
var MOEX44NetworkCounterpartySystemStatusRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		NetworkRequestType935: f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* SNAPSHOT */, 2 /* SUBSCRIBE */, 4 /* STOPSUBSCRIBING */, 8 /* LEVELOFDETAIL */), f0.Var{1, 19}},
