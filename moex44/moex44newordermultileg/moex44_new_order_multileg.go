...
package moex44newordermultileg
...
var (
	MOEX44NewOrderMultilegMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44NewOrderMultileg}
	MOEX44NewOrderMultilegUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44NewOrderMultileg}
)

// MOEX44NewOrderMultileg is a MOEX.4.4 (FIX.4.4) format of the NewOrderMultileg message which maps the codecs into individual fields.
var MOEX44NewOrderMultileg = f0.Format{
