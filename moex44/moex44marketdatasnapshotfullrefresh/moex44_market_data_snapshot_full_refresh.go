...
package moex44marketdatasnapshotfullrefresh
...
var (
	MOEX44MarketDataSnapshotFullRefreshMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44MarketDataSnapshotFullRefresh}
	MOEX44MarketDataSnapshotFullRefreshUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44MarketDataSnapshotFullRefresh}
)

// MOEX44MarketDataSnapshotFullRefresh is a MOEX.4.4 (FIX.4.4) format of the MarketDataSnapshotFullRefresh message which maps the codecs into individual fields.
var MOEX44MarketDataSnapshotFullRefresh = f0.Format{
