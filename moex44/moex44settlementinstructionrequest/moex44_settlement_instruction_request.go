...
package moex44settlementinstructionrequest
...
var (
	MOEX44SettlementInstructionRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44SettlementInstructionRequest}
	MOEX44SettlementInstructionRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44SettlementInstructionRequest}
)

// MOEX44SettlementInstructionRequest is a MOEX.4.4 (FIX.4.4) format of the SettlementInstructionRequest message which maps the codecs into individual fields.
var MOEX44SettlementInstructionRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		LastUpdateTime779:    f0.Fld{Opt, f0.ASCII, f0.UTCTimestampNanosecondTime(), f0.Var{1, 27}},
