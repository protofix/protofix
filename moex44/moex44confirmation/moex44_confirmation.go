...
var (
	MOEX44ConfirmationMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44Confirmation}
	MOEX44ConfirmationUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44Confirmation}
)

// MOEX44Confirmation is a MOEX.4.4 (FIX.4.4) format of the Confirmation message which maps the codecs into individual fields.
var MOEX44Confirmation = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ConfirmType773:                f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* STATUS */, 2 /* CONFIRMATION */, 3 /* CONFIRMATIONREQUESTREJECTED */), f0.Var{1, 19}},
		...
		ConfirmStatus665:              f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* RECEIVED */, 2 /* MISMATCHEDACCOUNT */, 3 /* MISSINGSETTLEMENTINSTRUCTIONS */, 4 /* CONFIRMED */, 5 /* REQUESTREJECTED */), f0.Var{1, 19}},
		...
		AllocAccountType798:           f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* ACCOUNTISCARRIEDONCUSTOMERSIDEOFBOOKS */, 2 /* ACCOUNTISCARRIEDONNONCUSTOMERSIDEOFBOOKS */, 3 /* HOUSETRADER */, 4 /* FLOORTRADER */, 6 /* ACCOUNTISCARRIEDONNONCUSTOMERSIDEOFBOOKSANDISCROSSMARGINED */, 7 /* ACCOUNTISHOUSETRADERANDISCROSSMARGINED */, 8 /* JBO */), f0.Var{1, 19}},
