...
package moex44allocationinstructionack
...
var (
	MOEX44AllocationInstructionAckMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44AllocationInstructionAck}
	MOEX44AllocationInstructionAckUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44AllocationInstructionAck}
)

// MOEX44AllocationInstructionAck is a MOEX.4.4 (FIX.4.4) format of the AllocationInstructionAck message which maps the codecs into individual fields.
var MOEX44AllocationInstructionAck = f0.Format{
	Fields: map[int]f0.Codec{
		...
		AllocType626:            f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* BUYSIDECALC */, 2 /* BUYSIDEPRELIM */, 3 /* SELLSIDECALC */, 4 /* SELLSIDECALCWITHOUTPRELIM */, 5 /* BUYSIDEREADYTOBOOKSINGLE */, 6 /* BUYSIDEREADYTOBOOKCOMBINED */, 7 /* WAREHOUSEINSTRUCTION */, 8 /* REQUESTTOINTERMEDIARY */), f0.Var{1, 19}},
