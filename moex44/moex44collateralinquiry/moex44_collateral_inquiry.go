...
package moex44collateralinquiry
...
var (
	MOEX44CollateralInquiryMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44CollateralInquiry}
	MOEX44CollateralInquiryUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44CollateralInquiry}
)

// MOEX44CollateralInquiry is a MOEX.4.4 (FIX.4.4) format of the CollateralInquiry message which maps the codecs into individual fields.
var MOEX44CollateralInquiry = f0.Format{
