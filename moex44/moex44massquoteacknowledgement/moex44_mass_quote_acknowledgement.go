...
package moex44massquoteacknowledgement
...
var (
	MOEX44MassQuoteAcknowledgementMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44MassQuoteAcknowledgement}
	MOEX44MassQuoteAcknowledgementUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44MassQuoteAcknowledgement}
)

// MOEX44MassQuoteAcknowledgement is a MOEX.4.4 (FIX.4.4) format of the MassQuoteAcknowledgement message which maps the codecs into individual fields.
var MOEX44MassQuoteAcknowledgement = f0.Format{
