...
package moex44collateralresponse
...
var (
	MOEX44CollateralResponseMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44CollateralResponse}
	MOEX44CollateralResponseUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44CollateralResponse}
)

// MOEX44CollateralResponse is a MOEX.4.4 (FIX.4.4) format of the CollateralResponse message which maps the codecs into individual fields.
var MOEX44CollateralResponse = f0.Format{
	Fields: map[int]f0.Codec{
		...
		CollAsgnRejectReason906:       f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* UNKNOWNDEAL */, 1 /* UNKNOWNORINVALIDINSTRUMENT */, 2 /* UNAUTHORIZEDTRANSACTION */, 3 /* INSUFFICIENTCOLLATERAL */, 4 /* INVALIDTYPEOFCOLLATERAL */, 5 /* EXCESSIVESUBSTITUTION */, 99 /* OTHER */), f0.Var{1, 19}},
