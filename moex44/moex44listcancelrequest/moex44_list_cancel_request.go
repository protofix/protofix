...
package moex44listcancelrequest
...
var (
	MOEX44ListCancelRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44ListCancelRequest}
	MOEX44ListCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44ListCancelRequest}
)

// MOEX44ListCancelRequest is a MOEX.4.4 (FIX.4.4) format of the ListCancelRequest message which maps the codecs into individual fields.
var MOEX44ListCancelRequest = f0.Format{
