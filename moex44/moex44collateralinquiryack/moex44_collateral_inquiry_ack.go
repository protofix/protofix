...
package moex44collateralinquiryack
...
var (
	MOEX44CollateralInquiryAckMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44CollateralInquiryAck}
	MOEX44CollateralInquiryAckUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44CollateralInquiryAck}
)

// MOEX44CollateralInquiryAck is a MOEX.4.4 (FIX.4.4) format of the CollateralInquiryAck message which maps the codecs into individual fields.
var MOEX44CollateralInquiryAck = f0.Format{
	Fields: map[int]f0.Codec{
		...
		CollInquiryStatus945:          f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* ACCEPTED */, 1 /* ACCEPTEDWITHWARNINGS */, 2 /* COMPLETED */, 3 /* COMPLETEDWITHWARNINGS */, 4 /* REJECTED */), f0.Var{1, 19}},
		CollInquiryResult946:          f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* SUCCESSFUL */, 1 /* INVALIDORUNKNOWNINSTRUMENT */, 2 /* INVALIDORUNKNOWNCOLLATERALTYPE */, 3 /* INVALIDPARTIES */, 4 /* INVALIDTRANSPORTTYPEREQUESTED */, 5 /* INVALIDDESTINATIONREQUESTED */, 6 /* NOCOLLATERALFOUNDFORTHETRADESPECIFIED */, 7 /* NOCOLLATERALFOUNDFORTHEORDERSPECIFIED */, 8 /* COLLATERALINQUIRYTYPENOTSUPPORTED */, 9 /* UNAUTHORIZEDFORCOLLATERALINQUIRY */, 99 /* OTHER */), f0.Var{1, 19}},
