...
package moex44requestforpositions
...
var (
	MOEX44RequestForPositionsMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44RequestForPositions}
	MOEX44RequestForPositionsUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44RequestForPositions}
)

// MOEX44RequestForPositions is a MOEX.4.4 (FIX.4.4) format of the RequestForPositions message which maps the codecs into individual fields.
var MOEX44RequestForPositions = f0.Format{
	Fields: map[int]f0.Codec{
		...
		PosReqType724:                 f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* POSITIONS */, 1 /* TRADES */, 2 /* EXERCISES */, 3 /* ASSIGNMENTS */), f0.Var{1, 19}},
