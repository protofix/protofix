...
package moex44derivativesecuritylist
...
var (
	MOEX44DerivativeSecurityListMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44DerivativeSecurityList}
	MOEX44DerivativeSecurityListUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44DerivativeSecurityList}
)

// MOEX44DerivativeSecurityList is a MOEX.4.4 (FIX.4.4) format of the DerivativeSecurityList message which maps the codecs into individual fields.
var MOEX44DerivativeSecurityList = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SecurityRequestResult560:                f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* VALIDREQ */, 1 /* INVALIDREQ */, 2 /* NOINSTRUMENTSFOUND */, 3 /* NOTAUTHORIZED */, 4 /* INSTRUMENTUNAVAILABLE */, 5 /* NOTSUPPORTED */), f0.Var{1, 19}},
