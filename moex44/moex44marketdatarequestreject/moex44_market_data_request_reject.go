...
package moex44marketdatarequestreject
...
var (
	MOEX44MarketDataRequestRejectMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44MarketDataRequestReject}
	MOEX44MarketDataRequestRejectUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44MarketDataRequestReject}
)

// MOEX44MarketDataRequestReject is a MOEX.4.4 (FIX.4.4) format of the MarketDataRequestReject message which maps the codecs into individual fields.
var MOEX44MarketDataRequestReject = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MDReqRejReason281:  f0.Fld{Opt, f0.ASCII, f0.String("0" /* UNKNOWNSYM */, "1" /* DUPID */, "2" /* INSBAND */, "3" /* INSPERM */, "4" /* UNSUPPSUB */, "5" /* UNSUPPMKTDEPTH */, "6" /* UNSUPPMDUPDATE */, "7" /* UNSUPPAGGBK */, "8" /* UNSUPPENTRY */, "9" /* UNSUPPTRDSESSIONID */, "A" /* UNSUPPSCOPE */, "B" /* UNSUPPPOSITIONEFFECTSETTLEFLAG */, "C" /* UNSUPPMDIMPLICITDELETE */), f0.Con{1}},
