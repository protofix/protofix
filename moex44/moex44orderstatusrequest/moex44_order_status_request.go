...
package moex44orderstatusrequest
...
var (
	MOEX44OrderStatusRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44OrderStatusRequest}
	MOEX44OrderStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44OrderStatusRequest}
)

// MOEX44OrderStatusRequest is a MOEX.4.4 (FIX.4.4) format of the OrderStatusRequest message which maps the codecs into individual fields.
var MOEX44OrderStatusRequest = f0.Format{
