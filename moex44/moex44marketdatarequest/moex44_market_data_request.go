...
package moex44marketdatarequest
...
var (
	MOEX44MarketDataRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44MarketDataRequest}
	MOEX44MarketDataRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44MarketDataRequest}
)

// MOEX44MarketDataRequest is a MOEX.4.4 (FIX.4.4) format of the MarketDataRequest message which maps the codecs into individual fields.
var MOEX44MarketDataRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MDUpdateType265:            f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* FULL */, 1 /* INCREMENTAL */), f0.Var{1, 19}},
		AggregatedBook266:          f0.Fld{Opt, f0.ASCII, f0.BoolDefault(), f0.Con{1}},
		OpenCloseSettlFlag286:      f0.Fld{Opt, f0.ASCII, f0.String("0" /* DAILYOPEN */, "1" /* SESSIONOPEN */, "2" /* DELIVERYSETTLEMENT */, "3" /* EXPECTEDENTRY */, "4" /* ENTRYFROMPREVBUSINESSDAY */, "5" /* THEORETICALPRICE */), f0.Var{1, 65536}},
		Scope546:                   f0.Fld{Opt, f0.ASCII, f0.String("1" /* LOCALMARKET */, "2" /* NATIONAL */, "3" /* GLOBAL */), f0.Var{1, 65536}},
	...
	Sort: []int{
		...
		OpenCloseSettlFlag286,      // MULTIPLEVALUESTRING
...
const (
	...
	OpenCloseSettlFlag286      = 286 // MULTIPLEVALUESTRING
