...
var (
	MOEX44NewOrderListMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44NewOrderList}
	MOEX44NewOrderListUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44NewOrderList}
)

// MOEX44NewOrderList is a MOEX.4.4 (FIX.4.4) format of the NewOrderList message which maps the codecs into individual fields.
var MOEX44NewOrderList = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ListExecInstType433:           f0.Fld{Opt, f0.ASCII, f0.String("1" /* IMMED */, "2" /* WAIT */, "3" /* EXCHCIVSELL */, "4" /* EXCHCIVBUYTOP */, "5" /* EXCHCIVBUYWD */), f0.Con{1}},
