...
var (
	MOEX44QuoteMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44Quote}
	MOEX44QuoteUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44Quote}
)

// MOEX44Quote is a MOEX.4.4 (FIX.4.4) format of the Quote message which maps the codecs into individual fields.
var MOEX44Quote = f0.Format{
