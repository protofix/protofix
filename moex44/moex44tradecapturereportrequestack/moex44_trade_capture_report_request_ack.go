...
package moex44tradecapturereportrequestack
...
var (
	MOEX44TradeCaptureReportRequestAckMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44TradeCaptureReportRequestAck}
	MOEX44TradeCaptureReportRequestAckUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44TradeCaptureReportRequestAck}
)

// MOEX44TradeCaptureReportRequestAck is a MOEX.4.4 (FIX.4.4) format of the TradeCaptureReportRequestAck message which maps the codecs into individual fields.
var MOEX44TradeCaptureReportRequestAck = f0.Format{
