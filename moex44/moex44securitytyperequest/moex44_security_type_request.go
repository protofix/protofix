...
package moex44securitytyperequest
...
var (
	MOEX44SecurityTypeRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44SecurityTypeRequest}
	MOEX44SecurityTypeRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44SecurityTypeRequest}
)

// MOEX44SecurityTypeRequest is a MOEX.4.4 (FIX.4.4) format of the SecurityTypeRequest message which maps the codecs into individual fields.
var MOEX44SecurityTypeRequest = f0.Format{
