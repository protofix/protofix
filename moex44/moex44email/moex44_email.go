...
var (
	MOEX44EmailMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44Email}
	MOEX44EmailUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44Email}
)

// MOEX44Email is a MOEX.4.4 (FIX.4.4) format of the Email message which maps the codecs into individual fields.
var MOEX44Email = f0.Format{
	Fields: map[int]f0.Codec{
		...
		EmailType94:          f0.Fld{Req, f0.ASCII, f0.String("0" /* NEW */, "1" /* REPLY */, "2" /* ADMINREPLY */), f0.Con{1}},
