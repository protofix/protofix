...
package moex44ordermasscancelrequest
...
var (
	MOEX44OrderMassCancelRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44OrderMassCancelRequest}
	MOEX44OrderMassCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44OrderMassCancelRequest}
)

// MOEX44OrderMassCancelRequest is a MOEX.4.4 (FIX.4.4) format of the OrderMassCancelRequest message which maps the codecs into individual fields.
var MOEX44OrderMassCancelRequest = f0.Format{
