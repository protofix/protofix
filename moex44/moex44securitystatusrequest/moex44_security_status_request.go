...
package moex44securitystatusrequest
...
var (
	MOEX44SecurityStatusRequestMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44SecurityStatusRequest}
	MOEX44SecurityStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44SecurityStatusRequest}
)

// MOEX44SecurityStatusRequest is a MOEX.4.4 (FIX.4.4) format of the SecurityStatusRequest message which maps the codecs into individual fields.
var MOEX44SecurityStatusRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SubscriptionRequestType263:    f0.Fld{Req, f0.ASCII, f0.String("0" /* SNAPSHOT */, "1" /* SNAPSHOTUPDATE */, "2" /* UNSUBSCRIBE */), f0.Con{1}},
