...
var (
	MOEX44MassQuoteMarshaler   = marshfix.Marshal{Tag: "MOEX44", Format: MOEX44MassQuote}
	MOEX44MassQuoteUnmarshaler = marshfix.Unmarshal{Tag: "MOEX44", Format: MOEX44MassQuote}
)

// MOEX44MassQuote is a MOEX.4.4 (FIX.4.4) format of the MassQuote message which maps the codecs into individual fields.
var MOEX44MassQuote = f0.Format{
