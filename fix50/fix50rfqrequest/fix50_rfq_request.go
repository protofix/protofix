...
var (
	FIX50RFQRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50RFQRequest}
	FIX50RFQRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50RFQRequest}
)

// FIX50RFQRequest is a FIX.5.0 format of the RFQRequest message which maps the codecs into individual fields.
var FIX50RFQRequest = f0.Format{
