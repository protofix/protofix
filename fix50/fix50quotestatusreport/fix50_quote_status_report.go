...
package fix50quotestatusreport
...
var (
	FIX50QuoteStatusReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50QuoteStatusReport}
	FIX50QuoteStatusReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50QuoteStatusReport}
)

// FIX50QuoteStatusReport is a FIX.5.0 format of the QuoteStatusReport message which maps the codecs into individual fields.
var FIX50QuoteStatusReport = f0.Format{
