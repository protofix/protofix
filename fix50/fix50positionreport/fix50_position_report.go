...
var (
	FIX50PositionReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50PositionReport}
	FIX50PositionReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50PositionReport}
)

// FIX50PositionReport is a FIX.5.0 format of the PositionReport message which maps the codecs into individual fields.
var FIX50PositionReport = f0.Format{
