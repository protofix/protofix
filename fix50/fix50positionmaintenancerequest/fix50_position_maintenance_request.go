...
package fix50positionmaintenancerequest
...
var (
	FIX50PositionMaintenanceRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50PositionMaintenanceRequest}
	FIX50PositionMaintenanceRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50PositionMaintenanceRequest}
)

// FIX50PositionMaintenanceRequest is a FIX.5.0 format of the PositionMaintenanceRequest message which maps the codecs into individual fields.
var FIX50PositionMaintenanceRequest = f0.Format{
