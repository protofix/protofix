...
package fix50securitydefinition
...
var (
	FIX50SecurityDefinitionMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50SecurityDefinition}
	FIX50SecurityDefinitionUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50SecurityDefinition}
)

// FIX50SecurityDefinition is a FIX.5.0 format of the SecurityDefinition message which maps the codecs into individual fields.
var FIX50SecurityDefinition = f0.Format{
