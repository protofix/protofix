...
var (
	FIX50SecurityTypesMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50SecurityTypes}
	FIX50SecurityTypesUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50SecurityTypes}
)

// FIX50SecurityTypes is a FIX.5.0 format of the SecurityTypes message which maps the codecs into individual fields.
var FIX50SecurityTypes = f0.Format{
