...
var (
	FIX50DontKnowTradeMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50DontKnowTrade}
	FIX50DontKnowTradeUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50DontKnowTrade}
)

// FIX50DontKnowTrade is a FIX.5.0 format of the DontKnowTrade message which maps the codecs into individual fields.
var FIX50DontKnowTrade = f0.Format{
