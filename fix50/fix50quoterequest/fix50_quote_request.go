...
var (
	FIX50QuoteRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50QuoteRequest}
	FIX50QuoteRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50QuoteRequest}
)

// FIX50QuoteRequest is a FIX.5.0 format of the QuoteRequest message which maps the codecs into individual fields.
var FIX50QuoteRequest = f0.Format{
