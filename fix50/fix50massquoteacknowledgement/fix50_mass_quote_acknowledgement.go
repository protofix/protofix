...
package fix50massquoteacknowledgement
...
var (
	FIX50MassQuoteAcknowledgementMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50MassQuoteAcknowledgement}
	FIX50MassQuoteAcknowledgementUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50MassQuoteAcknowledgement}
)

// FIX50MassQuoteAcknowledgement is a FIX.5.0 format of the MassQuoteAcknowledgement message which maps the codecs into individual fields.
var FIX50MassQuoteAcknowledgement = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteRejectReason300:                    f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* UNKNOWN_SYMBOL */, 2 /* EXCHANGE */, 3 /* QUOTE_REQUEST_EXCEEDS_LIMIT */, 4 /* TOO_LATE_TO_ENTER */, 5 /* UNKNOWN_QUOTE */, 6 /* DUPLICATE_QUOTE */, 7 /* INVALID_BID_ASK_SPREAD */, 8 /* INVALID_PRICE */, 9 /* NOT_AUTHORIZED_TO_QUOTE_SECURITY */, 99 /* OTHER */), f0.Var{1, 19}},
		...
		QuoteEntryRejectReason368:               f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* UNKNOWN_SYMBOL */, 2 /* EXHCNAGE */, 3 /* QUOTE_EXCEEDS_LIMIT */, 4 /* TOO_LATE_TO_ENTER */, 5 /* UNKNOWN_QUOTE */, 6 /* DUPLICATE_QUOTE */, 7 /* INVALID_BID_ASK_SPREAD */, 8 /* INVALID_PRICE */, 9 /* NOT_AUTHORIZED_TO_QUOTE_SECURITY */, 99 /* OTHER */), f0.Var{1, 19}},
