...
package fix50quotestatusrequest
...
var (
	FIX50QuoteStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50QuoteStatusRequest}
	FIX50QuoteStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50QuoteStatusRequest}
)

// FIX50QuoteStatusRequest is a FIX.5.0 format of the QuoteStatusRequest message which maps the codecs into individual fields.
var FIX50QuoteStatusRequest = f0.Format{
