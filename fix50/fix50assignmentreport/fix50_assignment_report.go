...
var (
	FIX50AssignmentReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50AssignmentReport}
	FIX50AssignmentReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50AssignmentReport}
)

// FIX50AssignmentReport is a FIX.5.0 format of the AssignmentReport message which maps the codecs into individual fields.
var FIX50AssignmentReport = f0.Format{
