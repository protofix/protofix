...
package fix50securitylistupdatereport
...
var (
	FIX50SecurityListUpdateReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50SecurityListUpdateReport}
	FIX50SecurityListUpdateReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50SecurityListUpdateReport}
)

// FIX50SecurityListUpdateReport is a FIX.5.0 format of the SecurityListUpdateReport message which maps the codecs into individual fields.
var FIX50SecurityListUpdateReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ExpirationCycle827:                      f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* EXPIRE_ON_TRADING_SESSION_CLOSE */, 1 /* EXPIRE_ON_TRADING_SESSION_OPEN */), f0.Var{1, 19}},
