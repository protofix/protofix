...
package fix50quoterequestreject
...
var (
	FIX50QuoteRequestRejectMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50QuoteRequestReject}
	FIX50QuoteRequestRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50QuoteRequestReject}
)

// FIX50QuoteRequestReject is a FIX.5.0 format of the QuoteRequestReject message which maps the codecs into individual fields.
var FIX50QuoteRequestReject = f0.Format{
