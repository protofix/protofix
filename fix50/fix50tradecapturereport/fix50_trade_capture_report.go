...
package fix50tradecapturereport
...
var (
	FIX50TradeCaptureReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50TradeCaptureReport}
	FIX50TradeCaptureReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50TradeCaptureReport}
)

// FIX50TradeCaptureReport is a FIX.5.0 format of the TradeCaptureReport message which maps the codecs into individual fields.
var FIX50TradeCaptureReport = f0.Format{
