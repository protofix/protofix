...
package fix50marketdatarequest
...
var (
	FIX50MarketDataRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50MarketDataRequest}
	FIX50MarketDataRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50MarketDataRequest}
)

// FIX50MarketDataRequest is a FIX.5.0 format of the MarketDataRequest message which maps the codecs into individual fields.
var FIX50MarketDataRequest = f0.Format{
