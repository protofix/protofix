...
package fix50orderstatusrequest
...
var (
	FIX50OrderStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50OrderStatusRequest}
	FIX50OrderStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50OrderStatusRequest}
)

// FIX50OrderStatusRequest is a FIX.5.0 format of the OrderStatusRequest message which maps the codecs into individual fields.
var FIX50OrderStatusRequest = f0.Format{
