...
package fix50requestforpositionsack
...
var (
	FIX50RequestForPositionsAckMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50RequestForPositionsAck}
	FIX50RequestForPositionsAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50RequestForPositionsAck}
)

// FIX50RequestForPositionsAck is a FIX.5.0 format of the RequestForPositionsAck message which maps the codecs into individual fields.
var FIX50RequestForPositionsAck = f0.Format{
