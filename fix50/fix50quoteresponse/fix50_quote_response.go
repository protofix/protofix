...
var (
	FIX50QuoteResponseMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50QuoteResponse}
	FIX50QuoteResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50QuoteResponse}
)

// FIX50QuoteResponse is a FIX.5.0 format of the QuoteResponse message which maps the codecs into individual fields.
var FIX50QuoteResponse = f0.Format{
	Fields: map[int]f0.Codec{
		QuoteRespID693:                          f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		QuoteID117:                              f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		QuoteRespType694:                        f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* HIT_LIFT */, 2 /* COUNTER */, 3 /* EXPIRED */, 4 /* COVER */, 5 /* DONE_AWAY */, 6 /* PASS */), f0.Var{1, 19}},
