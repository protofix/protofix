...
package fix50executionacknowledgement
...
var (
	FIX50ExecutionAcknowledgementMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50ExecutionAcknowledgement}
	FIX50ExecutionAcknowledgementUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50ExecutionAcknowledgement}
)

// FIX50ExecutionAcknowledgement is a FIX.5.0 format of the ExecutionAcknowledgement message which maps the codecs into individual fields.
var FIX50ExecutionAcknowledgement = f0.Format{
