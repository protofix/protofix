...
package fix50allocationinstructionack
...
var (
	FIX50AllocationInstructionAckMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50AllocationInstructionAck}
	FIX50AllocationInstructionAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50AllocationInstructionAck}
)

// FIX50AllocationInstructionAck is a FIX.5.0 format of the AllocationInstructionAck message which maps the codecs into individual fields.
var FIX50AllocationInstructionAck = f0.Format{
