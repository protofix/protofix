...
var (
	FIX50NewsMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50News}
	FIX50NewsUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50News}
)

// FIX50News is a FIX.5.0 format of the News message which maps the codecs into individual fields.
var FIX50News = f0.Format{
