...
package fix50securitydefinitionrequest
...
var (
	FIX50SecurityDefinitionRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50SecurityDefinitionRequest}
	FIX50SecurityDefinitionRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50SecurityDefinitionRequest}
)

// FIX50SecurityDefinitionRequest is a FIX.5.0 format of the SecurityDefinitionRequest message which maps the codecs into individual fields.
var FIX50SecurityDefinitionRequest = f0.Format{
	Fields: map[int]f0.Codec{
		SecurityReqID320:                        f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		SecurityRequestType321:                  f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* REQUEST_SECURITY_IDENTITY_AND_SPECIFICATIONS */, 1 /* REQUEST_SECURITY_IDENTITY_FOR_THE_SPECIFICATIONS_PROVIDED */, 2 /* REQUEST_LIST_SECURITY_TYPES */, 3 /* REQUEST_LIST_SECURITIES */), f0.Var{1, 19}},
