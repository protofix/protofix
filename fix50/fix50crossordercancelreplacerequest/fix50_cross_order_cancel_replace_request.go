...
package fix50crossordercancelreplacerequest
...
var (
	FIX50CrossOrderCancelReplaceRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50CrossOrderCancelReplaceRequest}
	FIX50CrossOrderCancelReplaceRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50CrossOrderCancelReplaceRequest}
)

// FIX50CrossOrderCancelReplaceRequest is a FIX.5.0 format of the CrossOrderCancelReplaceRequest message which maps the codecs into individual fields.
var FIX50CrossOrderCancelReplaceRequest = f0.Format{
