...
package fix50listcancelrequest
...
var (
	FIX50ListCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50ListCancelRequest}
	FIX50ListCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50ListCancelRequest}
)

// FIX50ListCancelRequest is a FIX.5.0 format of the ListCancelRequest message which maps the codecs into individual fields.
var FIX50ListCancelRequest = f0.Format{
