...
var (
	FIX50ListStrikePriceMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50ListStrikePrice}
	FIX50ListStrikePriceUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50ListStrikePrice}
)

// FIX50ListStrikePrice is a FIX.5.0 format of the ListStrikePrice message which maps the codecs into individual fields.
var FIX50ListStrikePrice = f0.Format{
	Fields: map[int]f0.Codec{
		...
		Price44:                                 f0.Fld{Req, f0.ASCII, f0.Float(), f0.Var{1, 19}},
