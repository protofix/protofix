...
package fix50tradecapturereportack
...
var (
	FIX50TradeCaptureReportAckMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50TradeCaptureReportAck}
	FIX50TradeCaptureReportAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50TradeCaptureReportAck}
)

// FIX50TradeCaptureReportAck is a FIX.5.0 format of the TradeCaptureReportAck message which maps the codecs into individual fields.
var FIX50TradeCaptureReportAck = f0.Format{
