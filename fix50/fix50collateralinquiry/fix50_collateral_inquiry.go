...
package fix50collateralinquiry
...
var (
	FIX50CollateralInquiryMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50CollateralInquiry}
	FIX50CollateralInquiryUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50CollateralInquiry}
)

// FIX50CollateralInquiry is a FIX.5.0 format of the CollateralInquiry message which maps the codecs into individual fields.
var FIX50CollateralInquiry = f0.Format{
