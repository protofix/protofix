...
package fix50ordermassstatusrequest
...
var (
	FIX50OrderMassStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50OrderMassStatusRequest}
	FIX50OrderMassStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50OrderMassStatusRequest}
)

// FIX50OrderMassStatusRequest is a FIX.5.0 format of the OrderMassStatusRequest message which maps the codecs into individual fields.
var FIX50OrderMassStatusRequest = f0.Format{
