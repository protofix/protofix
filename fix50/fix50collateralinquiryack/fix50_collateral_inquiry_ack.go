...
package fix50collateralinquiryack
...
var (
	FIX50CollateralInquiryAckMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50CollateralInquiryAck}
	FIX50CollateralInquiryAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50CollateralInquiryAck}
)

// FIX50CollateralInquiryAck is a FIX.5.0 format of the CollateralInquiryAck message which maps the codecs into individual fields.
var FIX50CollateralInquiryAck = f0.Format{
