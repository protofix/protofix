...
var (
	FIX50IOIMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50IOI}
	FIX50IOIUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50IOI}
)

// FIX50IOI is a FIX.5.0 format of the IOI message which maps the codecs into individual fields.
var FIX50IOI = f0.Format{
