...
package fix50derivativesecuritylist
...
var (
	FIX50DerivativeSecurityListMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50DerivativeSecurityList}
	FIX50DerivativeSecurityListUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50DerivativeSecurityList}
)

// FIX50DerivativeSecurityList is a FIX.5.0 format of the DerivativeSecurityList message which maps the codecs into individual fields.
var FIX50DerivativeSecurityList = f0.Format{
