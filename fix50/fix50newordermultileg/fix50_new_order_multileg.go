...
var (
	FIX50NewOrderMultilegMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50NewOrderMultileg}
	FIX50NewOrderMultilegUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50NewOrderMultileg}
)

// FIX50NewOrderMultileg is a FIX.5.0 format of the NewOrderMultileg message which maps the codecs into individual fields.
var FIX50NewOrderMultileg = f0.Format{
	Fields: map[int]f0.Codec{
		...
		RefOrderIDSource1081:                    f0.Fld{Opt, f0.ASCII, f0.String("0" /* SECONDARYORDEID */, "1" /* ORDEID */, "2" /* MENTRYID */, "3" /* QUOTENTRYID */), f0.Con{1}},
