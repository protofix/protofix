...
var (
	FIX50MassQuoteMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50MassQuote}
	FIX50MassQuoteUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50MassQuote}
)

// FIX50MassQuote is a FIX.5.0 format of the MassQuote message which maps the codecs into individual fields.
var FIX50MassQuote = f0.Format{
