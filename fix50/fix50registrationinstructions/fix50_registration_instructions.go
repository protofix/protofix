...
package fix50registrationinstructions
...
var (
	FIX50RegistrationInstructionsMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50RegistrationInstructions}
	FIX50RegistrationInstructionsUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50RegistrationInstructions}
)

// FIX50RegistrationInstructions is a FIX.5.0 format of the RegistrationInstructions message which maps the codecs into individual fields.
var FIX50RegistrationInstructions = f0.Format{
