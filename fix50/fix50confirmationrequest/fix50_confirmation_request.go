...
package fix50confirmationrequest
...
var (
	FIX50ConfirmationRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50ConfirmationRequest}
	FIX50ConfirmationRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50ConfirmationRequest}
)

// FIX50ConfirmationRequest is a FIX.5.0 format of the ConfirmationRequest message which maps the codecs into individual fields.
var FIX50ConfirmationRequest = f0.Format{
