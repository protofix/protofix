...
package fix50securitylistrequest
...
var (
	FIX50SecurityListRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50SecurityListRequest}
	FIX50SecurityListRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50SecurityListRequest}
)

// FIX50SecurityListRequest is a FIX.5.0 format of the SecurityListRequest message which maps the codecs into individual fields.
var FIX50SecurityListRequest = f0.Format{
