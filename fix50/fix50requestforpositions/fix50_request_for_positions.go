...
package fix50requestforpositions
...
var (
	FIX50RequestForPositionsMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50RequestForPositions}
	FIX50RequestForPositionsUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50RequestForPositions}
)

// FIX50RequestForPositions is a FIX.5.0 format of the RequestForPositions message which maps the codecs into individual fields.
var FIX50RequestForPositions = f0.Format{
