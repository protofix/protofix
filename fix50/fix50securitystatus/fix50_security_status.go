...
var (
	FIX50SecurityStatusMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50SecurityStatus}
	FIX50SecurityStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50SecurityStatus}
)

// FIX50SecurityStatus is a FIX.5.0 format of the SecurityStatus message which maps the codecs into individual fields.
var FIX50SecurityStatus = f0.Format{
