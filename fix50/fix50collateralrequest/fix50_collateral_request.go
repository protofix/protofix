...
package fix50collateralrequest
...
var (
	FIX50CollateralRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50CollateralRequest}
	FIX50CollateralRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50CollateralRequest}
)

// FIX50CollateralRequest is a FIX.5.0 format of the CollateralRequest message which maps the codecs into individual fields.
var FIX50CollateralRequest = f0.Format{
