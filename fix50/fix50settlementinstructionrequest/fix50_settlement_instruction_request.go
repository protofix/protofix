...
package fix50settlementinstructionrequest
...
var (
	FIX50SettlementInstructionRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50SettlementInstructionRequest}
	FIX50SettlementInstructionRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50SettlementInstructionRequest}
)

// FIX50SettlementInstructionRequest is a FIX.5.0 format of the SettlementInstructionRequest message which maps the codecs into individual fields.
var FIX50SettlementInstructionRequest = f0.Format{
