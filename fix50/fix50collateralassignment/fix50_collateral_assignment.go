...
package fix50collateralassignment
...
var (
	FIX50CollateralAssignmentMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50CollateralAssignment}
	FIX50CollateralAssignmentUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50CollateralAssignment}
)

// FIX50CollateralAssignment is a FIX.5.0 format of the CollateralAssignment message which maps the codecs into individual fields.
var FIX50CollateralAssignment = f0.Format{
