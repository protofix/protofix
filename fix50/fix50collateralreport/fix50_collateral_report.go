...
var (
	FIX50CollateralReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50CollateralReport}
	FIX50CollateralReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50CollateralReport}
)

// FIX50CollateralReport is a FIX.5.0 format of the CollateralReport message which maps the codecs into individual fields.
var FIX50CollateralReport = f0.Format{
