...
var (
	FIX50SecurityListMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50SecurityList}
	FIX50SecurityListUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50SecurityList}
)

// FIX50SecurityList is a FIX.5.0 format of the SecurityList message which maps the codecs into individual fields.
var FIX50SecurityList = f0.Format{
