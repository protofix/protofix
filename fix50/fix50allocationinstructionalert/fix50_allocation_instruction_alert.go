...
package fix50allocationinstructionalert
...
var (
	FIX50AllocationInstructionAlertMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50AllocationInstructionAlert}
	FIX50AllocationInstructionAlertUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50AllocationInstructionAlert}
)

// FIX50AllocationInstructionAlert is a FIX.5.0 format of the AllocationInstructionAlert message which maps the codecs into individual fields.
var FIX50AllocationInstructionAlert = f0.Format{
