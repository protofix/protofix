...
package fix50collateralresponse
...
var (
	FIX50CollateralResponseMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50CollateralResponse}
	FIX50CollateralResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50CollateralResponse}
)

// FIX50CollateralResponse is a FIX.5.0 format of the CollateralResponse message which maps the codecs into individual fields.
var FIX50CollateralResponse = f0.Format{
