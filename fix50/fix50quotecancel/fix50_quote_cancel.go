...
var (
	FIX50QuoteCancelMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50QuoteCancel}
	FIX50QuoteCancelUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50QuoteCancel}
)

// FIX50QuoteCancel is a FIX.5.0 format of the QuoteCancel message which maps the codecs into individual fields.
var FIX50QuoteCancel = f0.Format{
