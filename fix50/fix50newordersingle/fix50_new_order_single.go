...
var (
	FIX50NewOrderSingleMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50NewOrderSingle}
	FIX50NewOrderSingleUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50NewOrderSingle}
)

// FIX50NewOrderSingle is a FIX.5.0 format of the NewOrderSingle message which maps the codecs into individual fields.
var FIX50NewOrderSingle = f0.Format{
