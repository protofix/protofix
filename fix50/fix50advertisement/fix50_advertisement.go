...
var (
	FIX50AdvertisementMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50Advertisement}
	FIX50AdvertisementUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50Advertisement}
)

// FIX50Advertisement is a FIX.5.0 format of the Advertisement message which maps the codecs into individual fields.
var FIX50Advertisement = f0.Format{
