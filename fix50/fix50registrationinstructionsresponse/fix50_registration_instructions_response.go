...
package fix50registrationinstructionsresponse
...
var (
	FIX50RegistrationInstructionsResponseMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50RegistrationInstructionsResponse}
	FIX50RegistrationInstructionsResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50RegistrationInstructionsResponse}
)

// FIX50RegistrationInstructionsResponse is a FIX.5.0 format of the RegistrationInstructionsResponse message which maps the codecs into individual fields.
var FIX50RegistrationInstructionsResponse = f0.Format{
