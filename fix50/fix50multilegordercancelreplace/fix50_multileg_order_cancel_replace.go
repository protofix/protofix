...
package fix50multilegordercancelreplace
...
var (
	FIX50MultilegOrderCancelReplaceMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50MultilegOrderCancelReplace}
	FIX50MultilegOrderCancelReplaceUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50MultilegOrderCancelReplace}
)

// FIX50MultilegOrderCancelReplace is a FIX.5.0 format of the MultilegOrderCancelReplace message which maps the codecs into individual fields.
var FIX50MultilegOrderCancelReplace = f0.Format{
