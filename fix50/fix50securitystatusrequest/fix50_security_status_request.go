...
package fix50securitystatusrequest
...
var (
	FIX50SecurityStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50SecurityStatusRequest}
	FIX50SecurityStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50SecurityStatusRequest}
)

// FIX50SecurityStatusRequest is a FIX.5.0 format of the SecurityStatusRequest message which maps the codecs into individual fields.
var FIX50SecurityStatusRequest = f0.Format{
