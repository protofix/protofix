...
var (
	FIX50ExecutionReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50ExecutionReport}
	FIX50ExecutionReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50ExecutionReport}
)

// FIX50ExecutionReport is a FIX.5.0 format of the ExecutionReport message which maps the codecs into individual fields.
var FIX50ExecutionReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		OrderRestrictions529:                    f0.Fld{Opt, f0.ASCII, f0.String("1" /* PROGRAM_TRADE */, "2" /* INDEX_ARBITRAGE */, "3" /* NON_INDEX_ARBITRAGE */, "4" /* COMPETING_MARKET_MAKER */, "5" /* ACTING_AS_MARKET_MAKER_OR_SPECIALIST_IN_THE_SECURITY */, "6" /* ACTING_AS_MARKET_MAKER_OF_SPECIALIST_IN_THE_UNDERLYING_SECURITY_OF_A_DERIVATIVE_SEUCIRTY */, "7" /* FOREIGN_ENTITY */, "8" /* EXTERNAL_MARKET_PARTICIPANT */, "9" /* EXTNERAL_INTER_CONNECTED_MARKET_LINKAGE */, "A" /* RISKLESS_ARBITRAGE */), f0.Var{1, 65536}},
		...
		LastLiquidityInd851:                     f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* ADDED_LIQUIDITY */, 2 /* REMOVED_LIQUIDITY */, 3 /* LIQUIDITY_ROUTED_OUT */), f0.Var{1, 19}},
		...
		OrderCategory1115:                       f0.Fld{Opt, f0.ASCII, f0.String("1" /* ORDER */, "2" /* QUOTE */, "3" /* PRIVATELY_NEGOTIATED_TRADE */, "4" /* MULTILEG_ORDER */, "5" /* LINKED_ORDER */, "6" /* QUOTE_REQUEST */, "7" /* IMPLIED_ORDER */, "8" /* CROSS_ORDER */), f0.Con{1}},
		...
		PegScope840:                             f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* LOCAL */, 2 /* NATIONAL */, 3 /* GLOBAL */, 4 /* NATIONAL_XXCLUDING_LOCAL */), f0.Var{1, 19}},
		PegPriceType1094:                        f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* LAST_PEG */, 2 /* MID_PRICE_PEG */, 3 /* OPENING_PEG */, 4 /* MARKET_PEG */, 5 /* PRIMARY_PEG */, 6 /* FIXED_PEG_TO_LOCAL_BEST_BID_OR_OFFER_AT_TIME_OF_ORDER */, 7 /* PEG_TO_VWAP */, 8 /* TRAILING_STOP_PEG */, 9 /* PEG_TO_LIMIT_PRICE */), f0.Var{1, 19}},
