...
package fix50crossordercancelrequest
...
var (
	FIX50CrossOrderCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50CrossOrderCancelRequest}
	FIX50CrossOrderCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50CrossOrderCancelRequest}
)

// FIX50CrossOrderCancelRequest is a FIX.5.0 format of the CrossOrderCancelRequest message which maps the codecs into individual fields.
var FIX50CrossOrderCancelRequest = f0.Format{
