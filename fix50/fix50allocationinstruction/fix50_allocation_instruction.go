...
package fix50allocationinstruction
...
var (
	FIX50AllocationInstructionMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50AllocationInstruction}
	FIX50AllocationInstructionUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50AllocationInstruction}
)

// FIX50AllocationInstruction is a FIX.5.0 format of the AllocationInstruction message which maps the codecs into individual fields.
var FIX50AllocationInstruction = f0.Format{
