...
package fix50securitydefinitionupdatereport
...
var (
	FIX50SecurityDefinitionUpdateReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50SecurityDefinitionUpdateReport}
	FIX50SecurityDefinitionUpdateReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50SecurityDefinitionUpdateReport}
)

// FIX50SecurityDefinitionUpdateReport is a FIX.5.0 format of the SecurityDefinitionUpdateReport message which maps the codecs into individual fields.
var FIX50SecurityDefinitionUpdateReport = f0.Format{
