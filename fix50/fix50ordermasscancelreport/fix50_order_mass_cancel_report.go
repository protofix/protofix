...
package fix50ordermasscancelreport
...
var (
	FIX50OrderMassCancelReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50OrderMassCancelReport}
	FIX50OrderMassCancelReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50OrderMassCancelReport}
)

// FIX50OrderMassCancelReport is a FIX.5.0 format of the OrderMassCancelReport message which maps the codecs into individual fields.
var FIX50OrderMassCancelReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MassCancelResponse531:                   f0.Fld{Req, f0.ASCII, f0.String("0" /* CANCEL_REQUEST_REJECTED */, "1" /* CANCEL_ORDERS_FOR_A_SECURITY */, "2" /* CANCEL_ORDERS_FOR_AN_UNDERLYING_SECURITY */, "3" /* CANCEL_ORDERS_FOR_A_PRODUCT */, "4" /* CANCEL_ORDERS_FOR_A_CFICODE */, "5" /* CANCEL_ORDERS_FOR_A_SECURITYTYPE */, "6" /* CANCEL_ORDERS_FOR_A_TRADING_SESSION */, "7" /* CANCEL_ALL_ORDERS */), f0.Con{1}},
		MassCancelRejectReason532:               f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* MASS_CANCEL_NOT_SUPPORTED */, 1 /* INVALID_OR_UNKNOWN_SECURITY */, 2 /* INVALID_OR_UNKOWN_UNDERLYING_SECURITY */, 3 /* INVALID_OR_UNKNOWN_PRODUCT */, 4 /* INVALID_OR_UNKNOWN_CFICODE */, 5 /* INVALID_OR_UNKNOWN_SECURITYTYPE */, 6 /* INVALID_OR_UNKNOWN_TRADING_SESSION */, 99 /* OTHER */), f0.Var{1, 19}},
