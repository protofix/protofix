...
package fix50adjustedpositionreport
...
var (
	FIX50AdjustedPositionReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50AdjustedPositionReport}
	FIX50AdjustedPositionReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50AdjustedPositionReport}
)

// FIX50AdjustedPositionReport is a FIX.5.0 format of the AdjustedPositionReport message which maps the codecs into individual fields.
var FIX50AdjustedPositionReport = f0.Format{
