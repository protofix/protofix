...
var (
	FIX50EmailMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50Email}
	FIX50EmailUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50Email}
)

// FIX50Email is a FIX.5.0 format of the Email message which maps the codecs into individual fields.
var FIX50Email = f0.Format{
