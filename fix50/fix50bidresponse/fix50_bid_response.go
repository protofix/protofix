...
var (
	FIX50BidResponseMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50BidResponse}
	FIX50BidResponseUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50BidResponse}
)

// FIX50BidResponse is a FIX.5.0 format of the BidResponse message which maps the codecs into individual fields.
var FIX50BidResponse = f0.Format{
