...
package fix50contraryintentionreport
...
var (
	FIX50ContraryIntentionReportMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50ContraryIntentionReport}
	FIX50ContraryIntentionReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50ContraryIntentionReport}
)

// FIX50ContraryIntentionReport is a FIX.5.0 format of the ContraryIntentionReport message which maps the codecs into individual fields.
var FIX50ContraryIntentionReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ExpType982:                              f0.Fld{Opt, f0.ASCII, f0.IntDefault(1 /* AUTO_EXERCISE */, 2 /* NON_AUTO_EXERCISE */, 3 /* FINAL_WILL_BE_EXERCISED */, 4 /* CONTRARY_INTENTION */, 5 /* DIFFERENCE */), f0.Var{1, 19}},
