...
package fix50ordercancelrequest
...
var (
	FIX50OrderCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50OrderCancelRequest}
	FIX50OrderCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50OrderCancelRequest}
)

// FIX50OrderCancelRequest is a FIX.5.0 format of the OrderCancelRequest message which maps the codecs into individual fields.
var FIX50OrderCancelRequest = f0.Format{
