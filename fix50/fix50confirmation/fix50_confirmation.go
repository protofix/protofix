...
var (
	FIX50ConfirmationMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50Confirmation}
	FIX50ConfirmationUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50Confirmation}
)

// FIX50Confirmation is a FIX.5.0 format of the Confirmation message which maps the codecs into individual fields.
var FIX50Confirmation = f0.Format{
