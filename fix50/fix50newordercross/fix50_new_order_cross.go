...
var (
	FIX50NewOrderCrossMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50NewOrderCross}
	FIX50NewOrderCrossUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50NewOrderCross}
)

// FIX50NewOrderCross is a FIX.5.0 format of the NewOrderCross message which maps the codecs into individual fields.
var FIX50NewOrderCross = f0.Format{
