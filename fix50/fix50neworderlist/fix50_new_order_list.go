...
var (
	FIX50NewOrderListMarshaler   = marshfix.Marshal{Tag: "FIX50", Format: FIX50NewOrderList}
	FIX50NewOrderListUnmarshaler = marshfix.Unmarshal{Tag: "FIX50", Format: FIX50NewOrderList}
)

// FIX50NewOrderList is a FIX.5.0 format of the NewOrderList message which maps the codecs into individual fields.
var FIX50NewOrderList = f0.Format{
