...
var TESTSPECLogon = f0.Format{
	Fields: map[int]f0.Codec{
		BeginString8:           f0.Fld{Req, f0.ASCII, f0.StringDefault("FIX.0.1"), f0.Var{1, 65536}},
		...
		EncryptMethod98:        f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* NONEOTHER */), f0.Var{1, 19}},
	...
	CheckSum10:  f0.ChecksumStringFld{f0.ASCII, f0.ChecksumString(), f0.Var{1, 65536}},
	Unknown:     f0.UnknownFld{f0.ASCII, f0.Unknown(), f0.Var{1, 65536}},
	Sort: []int{
		BeginString8,           // STRING
		BodyLength9,            // LENGTH
		MsgType35,              // STRING
