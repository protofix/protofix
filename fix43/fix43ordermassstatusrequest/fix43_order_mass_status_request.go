...
package fix43ordermassstatusrequest
...
var (
	FIX43OrderMassStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43OrderMassStatusRequest}
	FIX43OrderMassStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43OrderMassStatusRequest}
)

// FIX43OrderMassStatusRequest is a FIX.4.3 format of the OrderMassStatusRequest message which maps the codecs into individual fields.
var FIX43OrderMassStatusRequest = f0.Format{
