...
package fix43businessmessagereject
...
var (
	FIX43BusinessMessageRejectMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43BusinessMessageReject}
	FIX43BusinessMessageRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43BusinessMessageReject}
)

// FIX43BusinessMessageReject is a FIX.4.3 format of the BusinessMessageReject message which maps the codecs into individual fields.
var FIX43BusinessMessageReject = f0.Format{
	Fields: map[int]f0.Codec{
		...
		BusinessRejectReason380:   f0.Fld{Req, f0.ASCII, f0.IntDefault(3 /* UNSUPPORTED_MESSAGE_TYPE */, 7 /* DELIVERTO_FIRM_NOT_AVAILABLE_AT_THIS_TIME */, 4 /* APPLICATION_NOT_AVAILABLE */, 6 /* NOT_AUTHORIZED */, 0 /* OTHER */, 5 /* CONDITIONALLY_REQUIRED_FIELD_MISSING */, 1 /* UNKOWN_ID */, 2 /* UNKNOWN_SECURITY */), f0.Var{1, 19}},
