...
var (
	FIX43BidRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43BidRequest}
	FIX43BidRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43BidRequest}
)

// FIX43BidRequest is a FIX.4.3 format of the BidRequest message which maps the codecs into individual fields.
var FIX43BidRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		BidRequestTransType374:    f0.Fld{Req, f0.ASCII, f0.String("N" /* NEW */, "C" /* CANCEL */), f0.Con{1}},
		...
		LiquidityIndType409:       f0.Fld{Opt, f0.ASCII, f0.IntDefault(3 /* NORMAL_MARKET_SIZE */, 4 /* OTHER */, 2 /* 20_DAY_MOVING_AVERAGE */, 1 /* 5DAY_MOVING_AVERAGE */), f0.Var{1, 19}},
		...
		IncTaxInd416:              f0.Fld{Opt, f0.ASCII, f0.IntDefault(2 /* GROSS */, 1 /* NET */), f0.Var{1, 19}},
		...
		TradeType418:              f0.Fld{Req, f0.ASCII, f0.String("G" /* VWAP_GUARANTEE */, "A" /* AGENCY */, "J" /* GUARANTEED_CLOSE */, "R" /* RISK_TRADE */), f0.Con{1}},
		BasisPxType419:            f0.Fld{Req, f0.ASCII, f0.String("8" /* VWAP_THROUGH_AN_AFTERNOON_SESSION */, "D" /* OPEN */, "Z" /* OTHERS */, "C" /* STRIKE */, "B" /* VWAP_THROUGH_AN_AFTERNOON_SESSION_EXCEPT_YORI */, "9" /* VWAP_THROUGH_A_DAY_EXCEPT_YORI */, "7" /* VWAP_THROUGH_A_MORNING_SESSION */, "6" /* VWAP_THROUGH_A_DAY */, "5" /* SQ */, "4" /* CURRENT_PRICE */, "3" /* CLOSING_PRICE */, "2" /* CLOSING_PRICE_AT_MORNING_SESSION */, "A" /* VWAP_THROUGH_A_MORNING_SESSION_EXCEPT_YORI */), f0.Con{1}},
