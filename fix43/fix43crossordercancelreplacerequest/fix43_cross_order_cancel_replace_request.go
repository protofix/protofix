...
package fix43crossordercancelreplacerequest
...
var (
	FIX43CrossOrderCancelReplaceRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43CrossOrderCancelReplaceRequest}
	FIX43CrossOrderCancelReplaceRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43CrossOrderCancelReplaceRequest}
)

// FIX43CrossOrderCancelReplaceRequest is a FIX.4.3 format of the CrossOrderCancelReplaceRequest message which maps the codecs into individual fields.
var FIX43CrossOrderCancelReplaceRequest = f0.Format{
