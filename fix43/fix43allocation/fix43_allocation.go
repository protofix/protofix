...
var (
	FIX43AllocationMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43Allocation}
	FIX43AllocationUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43Allocation}
)

// FIX43Allocation is a FIX.4.3 format of the Allocation message which maps the codecs into individual fields.
var FIX43Allocation = f0.Format{
	Fields: map[int]f0.Codec{
		...
		AllocTransType71:              f0.Fld{Req, f0.ASCII, f0.String("5" /* CALCULATED_WITHOUT_PRELIMINARY */, "4" /* CALCULATED */, "3" /* PRELIMINARY */, "2" /* CANCEL */, "1" /* REPLACE */, "0" /* NEW */), f0.Con{1}},
		AllocType626:                  f0.Fld{Req, f0.ASCII, f0.IntDefault(6 /* BUYSIDE_READY_TO_BOOK_6 */, 2 /* BUYSIDE_PRELIMINARY */, 3 /* SELLSIDE_CALCULATED_USING_PRELIMINARY */, 5 /* BUYSIDE_READY_TO_BOOK_5 */, 1 /* BUYSIDE_CALCULATED */, 4 /* SELLSIDE_CALCULATED_WITHOUT_PRELIMINARY */), f0.Var{1, 19}},
		...
		LegalConfirm650:               f0.Fld{Opt, f0.ASCII, f0.BoolDefault(true /* YES */, false /* NO */), f0.Con{1}},
