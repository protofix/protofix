...
package fix43ordermasscancelreport
...
var (
	FIX43OrderMassCancelReportMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43OrderMassCancelReport}
	FIX43OrderMassCancelReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43OrderMassCancelReport}
)

// FIX43OrderMassCancelReport is a FIX.4.3 format of the OrderMassCancelReport message which maps the codecs into individual fields.
var FIX43OrderMassCancelReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MassCancelResponse531:                   f0.Fld{Req, f0.ASCII, f0.String("6" /* CANCEL_ORDERS_FOR_A_TRADING_SESSION */, "0" /* CANCEL_REQUEST_REJECTED */, "7" /* CANCEL_ALL_ORDERS */, "3" /* CANCEL_ORDERS_FOR_A_PRODUCT */, "5" /* CANCEL_ORDERS_FOR_A_SECURITYTYPE */, "4" /* CANCEL_ORDERS_FOR_A_CFICODE */, "1" /* CANCEL_ORDERS_FOR_A_SECURITY */, "2" /* CANCEL_ORDERS_FOR_AN_UNDERLYING_SECURITY */), f0.Con{1}},
		MassCancelRejectReason532:               f0.Fld{Opt, f0.ASCII, f0.String("2" /* INVALID_OR_UNKNOWN_UNDERLYING */, "6" /* INVALID_OR_UNKNOWN_TRADING_SESSION */, "5" /* INVALID_OR_UNKNOWN_SECURITY_TYPE */, "3" /* INVALID_OR_UNKNOWN_PRODUCT */, "1" /* INVALID_OR_UNKNOWN_SECURITY */, "0" /* MASS_CANCEL_NOT_SUPPORTED */, "4" /* INVALID_OR_UNKNOWN_CFICODE */), f0.Con{1}},
