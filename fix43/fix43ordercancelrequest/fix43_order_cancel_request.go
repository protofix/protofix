...
package fix43ordercancelrequest
...
var (
	FIX43OrderCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43OrderCancelRequest}
	FIX43OrderCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43OrderCancelRequest}
)

// FIX43OrderCancelRequest is a FIX.4.3 format of the OrderCancelRequest message which maps the codecs into individual fields.
var FIX43OrderCancelRequest = f0.Format{
