...
var (
	FIX43EmailMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43Email}
	FIX43EmailUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43Email}
)

// FIX43Email is a FIX.4.3 format of the Email message which maps the codecs into individual fields.
var FIX43Email = f0.Format{
