...
var (
	FIX43QuoteMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43Quote}
	FIX43QuoteUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43Quote}
)

// FIX43Quote is a FIX.4.3 format of the Quote message which maps the codecs into individual fields.
var FIX43Quote = f0.Format{
