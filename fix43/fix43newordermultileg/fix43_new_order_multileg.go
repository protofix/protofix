...
var (
	FIX43NewOrderMultilegMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43NewOrderMultileg}
	FIX43NewOrderMultilegUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43NewOrderMultileg}
)

// FIX43NewOrderMultileg is a FIX.4.3 format of the NewOrderMultileg message which maps the codecs into individual fields.
var FIX43NewOrderMultileg = f0.Format{
