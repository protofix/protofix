...
var (
	FIX43MassQuoteMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43MassQuote}
	FIX43MassQuoteUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43MassQuote}
)

// FIX43MassQuote is a FIX.4.3 format of the MassQuote message which maps the codecs into individual fields.
var FIX43MassQuote = f0.Format{
