...
var (
	FIX43NewsMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43News}
	FIX43NewsUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43News}
)

// FIX43News is a FIX.4.3 format of the News message which maps the codecs into individual fields.
var FIX43News = f0.Format{
	Fields: map[int]f0.Codec{
		...
		Urgency61:                 f0.Fld{Opt, f0.ASCII, f0.String("1" /* FLASH */, "2" /* BACKGROUND */, "0" /* NORMAL */), f0.Con{1}},
