...
package fix43crossordercancelrequest
...
var (
	FIX43CrossOrderCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43CrossOrderCancelRequest}
	FIX43CrossOrderCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43CrossOrderCancelRequest}
)

// FIX43CrossOrderCancelRequest is a FIX.4.3 format of the CrossOrderCancelRequest message which maps the codecs into individual fields.
var FIX43CrossOrderCancelRequest = f0.Format{
