...
var (
	FIX43SecurityListMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43SecurityList}
	FIX43SecurityListUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43SecurityList}
)

// FIX43SecurityList is a FIX.4.3 format of the SecurityList message which maps the codecs into individual fields.
var FIX43SecurityList = f0.Format{
