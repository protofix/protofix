...
var (
	FIX43NewOrderListMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43NewOrderList}
	FIX43NewOrderListUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43NewOrderList}
)

// FIX43NewOrderList is a FIX.4.3 format of the NewOrderList message which maps the codecs into individual fields.
var FIX43NewOrderList = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ProgRptReqs414:            f0.Fld{Opt, f0.ASCII, f0.IntDefault(3 /* REAL_TIME_EXECUTION_REPORTS */, 2 /* SELLSIDE_PERIODICALLY_SENDS_STATUS_USING_LISTSTATUS_PERIOD_OPTIONALLY_SPECIFIED_IN_PROGRESSPERIOD */, 1 /* BUYSIDE_EXPLICITLY_REQUESTS_STATUS_USING_STATUSREQUEST */), f0.Var{1, 19}},
		BidType394:                f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* NON_DISCLOSED_STYLE */, 2 /* DISCLOSED_STYLE */, 3 /* NO_BIDDING_PROCESS */), f0.Var{1, 19}},
		...
		ListExecInstType433:       f0.Fld{Opt, f0.ASCII, f0.String("5" /* EXCHANGE_SWITCH_CIV_ORDER_BUY_DRIVEN_CASH_WITHDRAW */, "4" /* EXCHANGE_SWITCH_CIV_ORDER_BUY_DRIVEN_CASH_TOP_UP */, "2" /* WAIT_FOR_EXECUTE_INSTRUCTION */, "1" /* IMMEDIATE */, "3" /* EXCHANGE_SWITCH_CIV_ORDER_SELL_DRIVEN */), f0.Con{1}},
