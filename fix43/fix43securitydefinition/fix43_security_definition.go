...
package fix43securitydefinition
...
var (
	FIX43SecurityDefinitionMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43SecurityDefinition}
	FIX43SecurityDefinitionUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43SecurityDefinition}
)

// FIX43SecurityDefinition is a FIX.4.3 format of the SecurityDefinition message which maps the codecs into individual fields.
var FIX43SecurityDefinition = f0.Format{
