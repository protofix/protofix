...
package fix43tradingsessionstatusrequest
...
var (
	FIX43TradingSessionStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43TradingSessionStatusRequest}
	FIX43TradingSessionStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43TradingSessionStatusRequest}
)

// FIX43TradingSessionStatusRequest is a FIX.4.3 format of the TradingSessionStatusRequest message which maps the codecs into individual fields.
var FIX43TradingSessionStatusRequest = f0.Format{
