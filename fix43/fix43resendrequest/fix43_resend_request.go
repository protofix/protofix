...
var (
	FIX43ResendRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43ResendRequest}
	FIX43ResendRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43ResendRequest}
)

// FIX43ResendRequest is a FIX.4.3 format of the ResendRequest message which maps the codecs into individual fields.
var FIX43ResendRequest = f0.Format{
