...
package fix43securitylistrequest
...
var (
	FIX43SecurityListRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43SecurityListRequest}
	FIX43SecurityListRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43SecurityListRequest}
)

// FIX43SecurityListRequest is a FIX.4.3 format of the SecurityListRequest message which maps the codecs into individual fields.
var FIX43SecurityListRequest = f0.Format{
