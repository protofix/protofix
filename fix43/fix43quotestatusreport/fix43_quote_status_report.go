...
package fix43quotestatusreport
...
var (
	FIX43QuoteStatusReportMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43QuoteStatusReport}
	FIX43QuoteStatusReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43QuoteStatusReport}
)

// FIX43QuoteStatusReport is a FIX.4.3 format of the QuoteStatusReport message which maps the codecs into individual fields.
var FIX43QuoteStatusReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteStatus297:                f0.Fld{Opt, f0.ASCII, f0.IntDefault(6 /* REMOVED_FROM_MARKET */, 1 /* CANCELED_FOR_SYMBOL */, 10 /* PENDING */, 9 /* QUOTE_NOT_FOUND */, 8 /* QUERY */, 7 /* EXPIRED */, 5 /* REJECTED */, 4 /* CANCELED_ALL */, 3 /* CANCELED_FOR_UNDERLYING */, 2 /* CANCELED_FOR_SECURITY_TYPE */, 0 /* ACCEPTED */), f0.Var{1, 19}},
