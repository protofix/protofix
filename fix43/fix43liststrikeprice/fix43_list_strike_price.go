...
var (
	FIX43ListStrikePriceMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43ListStrikePrice}
	FIX43ListStrikePriceUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43ListStrikePrice}
)

// FIX43ListStrikePrice is a FIX.4.3 format of the ListStrikePrice message which maps the codecs into individual fields.
var FIX43ListStrikePrice = f0.Format{
