...
var (
	FIX43SecurityTypesMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43SecurityTypes}
	FIX43SecurityTypesUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43SecurityTypes}
)

// FIX43SecurityTypes is a FIX.4.3 format of the SecurityTypes message which maps the codecs into individual fields.
var FIX43SecurityTypes = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SecurityResponseType323:    f0.Fld{Req, f0.ASCII, f0.IntDefault(5 /* REJECT_SECURITY_PROPOSAL */, 1 /* ACCEPT_SECURITY_PROPOSAL_AS_IS */, 6 /* CAN_NOT_MATCH_SELECTION_CRITERIA */, 2 /* ACCEPT_SECURITY_PROPOSAL_WITH_REVISIONS_AS_INDICATED_IN_THE_MESSAGE */, 4 /* LIST_OF_SECURITIES_RETURNED_PER_REQUEST */, 3 /* LIST_OF_SECURITY_TYPES_RETURNED_PER_REQUEST */), f0.Var{1, 19}},
		TotalNumSecurityTypes557:   f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
...
const (
	...
	TotalNumSecurityTypes557   = 557 // INT
	Text58                     = 58  // STRING
