...
package fix43multilegordercancelreplacerequest
...
var (
	FIX43MultilegOrderCancelReplaceRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43MultilegOrderCancelReplaceRequest}
	FIX43MultilegOrderCancelReplaceRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43MultilegOrderCancelReplaceRequest}
)

// FIX43MultilegOrderCancelReplaceRequest is a FIX.4.3 format of the MultilegOrderCancelReplaceRequest message which maps the codecs into individual fields.
var FIX43MultilegOrderCancelReplaceRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MultiLegRptTypeReq563:         f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
