...
package fix43registrationinstructions
...
var (
	FIX43RegistrationInstructionsMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43RegistrationInstructions}
	FIX43RegistrationInstructionsUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43RegistrationInstructions}
)

// FIX43RegistrationInstructions is a FIX.4.3 format of the RegistrationInstructions message which maps the codecs into individual fields.
var FIX43RegistrationInstructions = f0.Format{
	Fields: map[int]f0.Codec{
		...
		RegistTransType514:        f0.Fld{Req, f0.ASCII, f0.String("2" /* CANCEL */, "0" /* NEW */, "1" /* REPLACE */), f0.Con{1}},
		...
		TaxAdvantageType495:       f0.Fld{Opt, f0.ASCII, f0.IntDefault(19 /* PROFIT_SHARING_PLAN */, 11 /* EMPLOYER */, 12 /* EMPLOYER_CURRENT_YEAR */, 13 /* NON_FUND_PROTOTYPE_IRA */, 14 /* NON_FUND_QUALIFIED_PLAN */, 15 /* DEFINED_CONTRIBUTION_PLAN */, 10 /* EMPLOYEE_CURRENT_YEAR */, 17 /* INDIVIDUAL_RETIREMENT_ACCOUNT_ROLLOVER */, 5 /* MINI_INSURANCE_ISA */, 16 /* INDIVIDUAL_RETIREMENT_ACCOUNT */, 9 /* EMPLOYEE */, 8 /* ASSET_TRANSFER */, 21 /* SELF_DIRECTED_IRA */, 6 /* CURRENT_YEAR_PAYMENT */, 20 /* 401K */, 4 /* MINI_STOCKS_AND_SHARES_ISA */, 3 /* MINI_CASH_ISA */, 2 /* TESSA */, 1 /* MAXI_ISA */, 0 /* NONE_NOT_APPLICABLE */, 7 /* PRIOR_YEAR_PAYMENT */, 23 /* 457 */, 24 /* ROTH_IRA_24 */, 25 /* ROTH_IRA_25 */, 26 /* ROTH_CONVERSION_IRA_26 */, 27 /* ROTH_CONVERSION_IRA_27 */, 28 /* EDUCATION_IRA_28 */, 29 /* EDUCATION_IRA_29 */, 18 /* KEOGH */, 22 /* 403 */), f0.Var{1, 19}},
		OwnershipType517:          f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{1}},
