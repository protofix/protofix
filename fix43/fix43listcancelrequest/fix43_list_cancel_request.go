...
package fix43listcancelrequest
...
var (
	FIX43ListCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43ListCancelRequest}
	FIX43ListCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43ListCancelRequest}
)

// FIX43ListCancelRequest is a FIX.4.3 format of the ListCancelRequest message which maps the codecs into individual fields.
var FIX43ListCancelRequest = f0.Format{
