...
package fix43marketdatarequestreject
...
var (
	FIX43MarketDataRequestRejectMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43MarketDataRequestReject}
	FIX43MarketDataRequestRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43MarketDataRequestReject}
)

// FIX43MarketDataRequestReject is a FIX.4.3 format of the MarketDataRequestReject message which maps the codecs into individual fields.
var FIX43MarketDataRequestReject = f0.Format{
	Fields: map[int]f0.Codec{
		...
		MDReqRejReason281:         f0.Fld{Opt, f0.ASCII, f0.String("7" /* UNSUPPORTED_AGGREGATEDBOOK */, "1" /* DUPLICATE_MDREQID */, "C" /* UNSUPPORTED_MDIMPLICITDELETE */, "B" /* UNSUPPORTED_OPENCLOSESETTLEFLAG */, "A" /* UNSUPPORTED_SCOPE */, "9" /* UNSUPPORTED_TRADINGSESSIONID */, "8" /* UNSUPPORTED_MDENTRYTYPE */, "6" /* UNSUPPORTED_MDUPDATETYPE */, "5" /* UNSUPPORTED_MARKETDEPTH */, "4" /* UNSUPPORTED_SUBSCRIPTIONREQUESTTYPE */, "2" /* INSUFFICIENT_BANDWIDTH */, "0" /* UNKNOWN_SYMBOL */, "3" /* INSUFFICIENT_PERMISSIONS */), f0.Con{1}},
