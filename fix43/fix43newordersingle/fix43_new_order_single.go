...
var (
	FIX43NewOrderSingleMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43NewOrderSingle}
	FIX43NewOrderSingleUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43NewOrderSingle}
)

// FIX43NewOrderSingle is a FIX.4.3 format of the NewOrderSingle message which maps the codecs into individual fields.
var FIX43NewOrderSingle = f0.Format{
