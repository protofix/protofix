...
package fix43marketdatasnapshotfullrefresh
...
var (
	FIX43MarketDataSnapshotFullRefreshMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43MarketDataSnapshotFullRefresh}
	FIX43MarketDataSnapshotFullRefreshUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43MarketDataSnapshotFullRefresh}
)

// FIX43MarketDataSnapshotFullRefresh is a FIX.4.3 format of the MarketDataSnapshotFullRefresh message which maps the codecs into individual fields.
var FIX43MarketDataSnapshotFullRefresh = f0.Format{
	Fields: map[int]f0.Codec{
		...
		TotalVolumeTradedDate449:      f0.Fld{Opt, f0.ASCII, f0.UTCDateOnlyTime(), f0.Con{8}},
		TotalVolumeTradedTime450:      f0.Fld{Opt, f0.ASCII, f0.UTCTimeOnlyMillisecondTime(), f0.Var{8, 12}},
	...
	Sort: []int{
		...
		TotalVolumeTradedDate449,      // UTCDATE
		TotalVolumeTradedTime450,      // UTCTIMEONLY
...
const (
	...
	TotalVolumeTradedDate449      = 449 // UTCDATE
	TotalVolumeTradedTime450      = 450 // UTCTIMEONLY
