...
var (
	FIX43AllocationAckMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43AllocationAck}
	FIX43AllocationAckUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43AllocationAck}
)

// FIX43AllocationAck is a FIX.4.3 format of the AllocationAck message which maps the codecs into individual fields.
var FIX43AllocationAck = f0.Format{
	Fields: map[int]f0.Codec{
		...
		AllocStatus87:             f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* REJECTED */, 2 /* PARTIAL_ACCEPT */, 3 /* RECEIVED */, 0 /* ACCEPTED */), f0.Var{1, 19}},
		AllocRejCode88:            f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* UNKNOWN_ACCOUNT */, 6 /* UNKNOWN_LISTID */, 3 /* UNKNOWN_EXECUTING_BROKER_MNEMONIC */, 5 /* UNKNOWN_ORDERID */, 7 /* OTHER */, 4 /* COMMISSION_DIFFERENCE */, 1 /* INCORRECT_QUANTITY */, 2 /* INCORRECT_AVERAGE_PRICE */), f0.Var{1, 19}},
