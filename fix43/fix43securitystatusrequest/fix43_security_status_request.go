...
package fix43securitystatusrequest
...
var (
	FIX43SecurityStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43SecurityStatusRequest}
	FIX43SecurityStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43SecurityStatusRequest}
)

// FIX43SecurityStatusRequest is a FIX.4.3 format of the SecurityStatusRequest message which maps the codecs into individual fields.
var FIX43SecurityStatusRequest = f0.Format{
