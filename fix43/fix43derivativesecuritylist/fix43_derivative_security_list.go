...
package fix43derivativesecuritylist
...
var (
	FIX43DerivativeSecurityListMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43DerivativeSecurityList}
	FIX43DerivativeSecurityListUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43DerivativeSecurityList}
)

// FIX43DerivativeSecurityList is a FIX.4.3 format of the DerivativeSecurityList message which maps the codecs into individual fields.
var FIX43DerivativeSecurityList = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SecurityRequestResult560:                f0.Fld{Req, f0.ASCII, f0.IntDefault(4 /* INSTRUMENT_DATA_TEMPORARILY_UNAVAILABLE */, 0 /* VALID_REQUEST */, 1 /* INVALID_OR_UNSUPPORTED_REQUEST */, 5 /* REQUEST_FOR_INSTRUMENT_DATA_NOT_SUPPORTED */, 3 /* NOT_AUTHORIZED_TO_RETRIEVE_INSTRUMENT_DATA */, 2 /* NO_INSTRUMENTS_FOUND_THAT_MATCH_SELECTION_CRITERIA */), f0.Var{1, 19}},
		TotalNumSecurities393:                   f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
