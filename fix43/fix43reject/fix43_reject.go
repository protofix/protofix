...
var (
	FIX43RejectMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43Reject}
	FIX43RejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43Reject}
)

// FIX43Reject is a FIX.4.3 format of the Reject message which maps the codecs into individual fields.
var FIX43Reject = f0.Format{
