...
package fix43tradecapturereportrequest
...
var (
	FIX43TradeCaptureReportRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43TradeCaptureReportRequest}
	FIX43TradeCaptureReportRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43TradeCaptureReportRequest}
)

// FIX43TradeCaptureReportRequest is a FIX.4.3 format of the TradeCaptureReportRequest message which maps the codecs into individual fields.
var FIX43TradeCaptureReportRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		TradeRequestType569:           f0.Fld{Req, f0.ASCII, f0.IntDefault(4 /* ADVISORIES_THAT_MATCH_CRITERIA */, 3 /* UNREPORTED_TRADES_THAT_MATCH_CRITERIA */, 2 /* UNMATCHED_TRADES_THAT_MATCH_CRITERIA */, 1 /* MATCHED_TRADES_MATCHING_CRITERIA_PROVIDED_ON_REQUEST */, 0 /* ALL_TRADES */), f0.Var{1, 19}},
