...
package fix43tradecapturereport
...
var (
	FIX43TradeCaptureReportMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43TradeCaptureReport}
	FIX43TradeCaptureReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43TradeCaptureReport}
)

// FIX43TradeCaptureReport is a FIX.4.3 format of the TradeCaptureReport message which maps the codecs into individual fields.
var FIX43TradeCaptureReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		TradeReportTransType487:       f0.Fld{Opt, f0.ASCII, f0.String("N" /* NEW */, "R" /* REPLACE */, "C" /* CANCEL */), f0.Con{1}},
...
const (
	...
	TradeReportTransType487       = 487 // CHAR
