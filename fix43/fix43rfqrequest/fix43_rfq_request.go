...
var (
	FIX43RFQRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43RFQRequest}
	FIX43RFQRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43RFQRequest}
)

// FIX43RFQRequest is a FIX.4.3 format of the RFQRequest message which maps the codecs into individual fields.
var FIX43RFQRequest = f0.Format{
