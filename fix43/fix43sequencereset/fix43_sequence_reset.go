...
var (
	FIX43SequenceResetMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43SequenceReset}
	FIX43SequenceResetUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43SequenceReset}
)

// FIX43SequenceReset is a FIX.4.3 format of the SequenceReset message which maps the codecs into individual fields.
var FIX43SequenceReset = f0.Format{
	Fields: map[int]f0.Codec{
		...
		GapFillFlag123:            f0.Fld{Opt, f0.ASCII, f0.BoolDefault(true /* YES */, false /* NO */), f0.Con{1}},
