...
var (
	FIX43TestRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43TestRequest}
	FIX43TestRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43TestRequest}
)

// FIX43TestRequest is a FIX.4.3 format of the TestRequest message which maps the codecs into individual fields.
var FIX43TestRequest = f0.Format{
