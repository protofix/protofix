...
package fix43quoterequestreject
...
var (
	FIX43QuoteRequestRejectMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43QuoteRequestReject}
	FIX43QuoteRequestRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43QuoteRequestReject}
)

// FIX43QuoteRequestReject is a FIX.4.3 format of the QuoteRequestReject message which maps the codecs into individual fields.
var FIX43QuoteRequestReject = f0.Format{
	Fields: map[int]f0.Codec{
		...
		QuoteRequestRejectReason658: f0.Fld{Req, f0.ASCII, f0.IntDefault(1 /* UNKNOWN_SYMBOL */, 2 /* EXCHANGE */, 3 /* QUOTE_REQUEST_EXCEEDS_LIMIT */, 4 /* TOO_LATE_TO_ENTER */, 5 /* INVALID_PRICE */, 6 /* NOT_AUTHORIZED_TO_REQUEST_QUOTE */), f0.Var{1, 19}},
