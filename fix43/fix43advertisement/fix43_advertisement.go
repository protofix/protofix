...
var (
	FIX43AdvertisementMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43Advertisement}
	FIX43AdvertisementUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43Advertisement}
)

// FIX43Advertisement is a FIX.4.3 format of the Advertisement message which maps the codecs into individual fields.
var FIX43Advertisement = f0.Format{
	Fields: map[int]f0.Codec{
		...
		AdvTransType5:                 f0.Fld{Req, f0.ASCII, f0.String("N" /* NEW */, "C" /* CANCEL */, "R" /* REPLACE */), f0.Var{1, 65536}},
		AdvRefID3:                     f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		AdvSide4:                      f0.Fld{Req, f0.ASCII, f0.String("B" /* BUY */, "S" /* SELL */, "X" /* CROSS */, "T" /* TRADE */), f0.Con{1}},
