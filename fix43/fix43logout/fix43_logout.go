...
var (
	FIX43LogoutMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43Logout}
	FIX43LogoutUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43Logout}
)

// FIX43Logout is a FIX.4.3 format of the Logout message which maps the codecs into individual fields.
var FIX43Logout = f0.Format{
