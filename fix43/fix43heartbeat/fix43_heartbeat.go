...
var (
	FIX43HeartbeatMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43Heartbeat}
	FIX43HeartbeatUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43Heartbeat}
)

// FIX43Heartbeat is a FIX.4.3 format of the Heartbeat message which maps the codecs into individual fields.
var FIX43Heartbeat = f0.Format{
