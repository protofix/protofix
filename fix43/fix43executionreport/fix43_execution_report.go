...
var (
	FIX43ExecutionReportMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43ExecutionReport}
	FIX43ExecutionReportUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43ExecutionReport}
)

// FIX43ExecutionReport is a FIX.4.3 format of the ExecutionReport message which maps the codecs into individual fields.
var FIX43ExecutionReport = f0.Format{
	Fields: map[int]f0.Codec{
		...
		OrdRejReason103:               f0.Fld{Opt, f0.ASCII, f0.IntDefault(2 /* EXCHANGE_CLOSED */, 1 /* UNKNOWN_SYMBOL */, 3 /* ORDER_EXCEEDS_LIMIT */, 4 /* TOO_LATE_TO_ENTER */, 5 /* UNKNOWN_ORDER */, 7 /* DUPLICATE_OF_A_VERBALLY_COMMUNICATED_ORDER */, 9 /* TRADE_ALONG_REQUIRED */, 10 /* INVALID_INVESTOR_ID */, 6 /* DUPLICATE_ORDER */, 11 /* UNSUPPORTED_ORDER_CHARACTERISTIC */, 12 /* SURVEILLENCE_OPTION */, 0 /* BROKER */, 8 /* STALE_ORDER */), f0.Var{1, 19}},
		ExecRestatementReason378:      f0.Fld{Opt, f0.ASCII, f0.IntDefault(7 /* CANCEL_ON_SYSTEM_FAILURE */, 0 /* GT_CORPORATE_ACTION */, 8 /* MARKET */, 6 /* CANCEL_ON_TRADING_HALT */, 5 /* PARTIAL_DECLINE_OF_ORDERQTY */, 4 /* BROKER_OPTION */, 3 /* REPRICING_OF_ORDER */, 1 /* GT_RENEWAL */, 2 /* VERBAL_CHANGE */), f0.Var{1, 19}},
		...
		OrdType40:                     f0.Fld{Opt, f0.ASCII, f0.String("D" /* PREVIOUSLY_QUOTED */, "2" /* LIMIT */, "3" /* STOP */, "4" /* STOP_LIMIT */, "5" /* MARKET_ON_CLOSE */, "6" /* WITH_OR_WITHOUT */, "7" /* LIMIT_OR_BETTER */, "8" /* LIMIT_WITH_OR_WITHOUT */, "9" /* ON_BASIS */, "A" /* ON_CLOSE */, "1" /* MARKET */, "C" /* FOREX_C */, "F" /* FOREX_F */, "E" /* PREVIOUSLY_INDICATED */, "G" /* FOREX_G */, "I" /* FUNARI */, "J" /* MARKET_IF_TOUCHED */, "K" /* MARKET_WITH_LEFTOVER_AS_LIMIT */, "L" /* PREVIOUS_FUND_VALUATION_POINT */, "M" /* NEXT_FUND_VALUATION_POINT */, "P" /* PEGGED */, "B" /* LIMIT_ON_CLOSE */, "H" /* FOREX_H */), f0.Con{1}},
		...
		LastCapacity29:                f0.Fld{Opt, f0.ASCII, f0.String("4" /* PRINCIPAL */, "3" /* CROSS_AS_PRINCIPAL */, "1" /* AGENT */, "2" /* CROSS_AS_AGENT */), f0.Con{1}},
		...
		ReportToExch113:               f0.Fld{Opt, f0.ASCII, f0.BoolDefault(true /* YES */, false /* NO */), f0.Con{1}},
		...
		ExDate230:                     f0.Fld{Opt, f0.ASCII, f0.UTCDateOnlyTime(), f0.Con{8}},
		...
		BasisFeatureDate259:           f0.Fld{Opt, f0.ASCII, f0.UTCDateOnlyTime(), f0.Con{8}},
		...
		SettlCurrFxRateCalc156:        f0.Fld{Opt, f0.ASCII, f0.String("D" /* DIVIDE */, "M" /* MULTIPLY */), f0.Con{1}},
		...
		ExecPriceType484:              f0.Fld{Opt, f0.ASCII, f0.String("S" /* SINGLE_PRICE */, "Q" /* OFFER_PRICE_MINUS_ADJUSTMENT_AMOUNT */, "P" /* OFFER_PRICE_MINUS_ADJUSTMENT */, "O" /* OFFER_PRICE */, "E" /* CREATION_PRICE_PLUS_ADJUSTMENT_AMOUNT */, "D" /* CREATION_PRICE_PLUS_ADJUSTMENT */, "C" /* CREATION_PRICE */, "B" /* BID_PRICE */), f0.Con{1}},
