...
var (
	FIX43ListExecuteMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43ListExecute}
	FIX43ListExecuteUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43ListExecute}
)

// FIX43ListExecute is a FIX.4.3 format of the ListExecute message which maps the codecs into individual fields.
var FIX43ListExecute = f0.Format{
