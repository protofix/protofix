...
package fix43orderstatusrequest
...
var (
	FIX43OrderStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43OrderStatusRequest}
	FIX43OrderStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43OrderStatusRequest}
)

// FIX43OrderStatusRequest is a FIX.4.3 format of the OrderStatusRequest message which maps the codecs into individual fields.
var FIX43OrderStatusRequest = f0.Format{
