...
var (
	FIX43QuoteRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43QuoteRequest}
	FIX43QuoteRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43QuoteRequest}
)

// FIX43QuoteRequest is a FIX.4.3 format of the QuoteRequest message which maps the codecs into individual fields.
var FIX43QuoteRequest = f0.Format{
