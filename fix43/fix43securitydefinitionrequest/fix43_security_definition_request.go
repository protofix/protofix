...
package fix43securitydefinitionrequest
...
var (
	FIX43SecurityDefinitionRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43SecurityDefinitionRequest}
	FIX43SecurityDefinitionRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43SecurityDefinitionRequest}
)

// FIX43SecurityDefinitionRequest is a FIX.4.3 format of the SecurityDefinitionRequest message which maps the codecs into individual fields.
var FIX43SecurityDefinitionRequest = f0.Format{
