...
package fix43quotestatusrequest
...
var (
	FIX43QuoteStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43QuoteStatusRequest}
	FIX43QuoteStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43QuoteStatusRequest}
)

// FIX43QuoteStatusRequest is a FIX.4.3 format of the QuoteStatusRequest message which maps the codecs into individual fields.
var FIX43QuoteStatusRequest = f0.Format{
