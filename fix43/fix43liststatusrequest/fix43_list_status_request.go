...
package fix43liststatusrequest
...
var (
	FIX43ListStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43ListStatusRequest}
	FIX43ListStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43ListStatusRequest}
)

// FIX43ListStatusRequest is a FIX.4.3 format of the ListStatusRequest message which maps the codecs into individual fields.
var FIX43ListStatusRequest = f0.Format{
