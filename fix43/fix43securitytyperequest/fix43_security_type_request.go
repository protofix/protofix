...
package fix43securitytyperequest
...
var (
	FIX43SecurityTypeRequestMarshaler   = marshfix.Marshal{Tag: "FIX43", Format: FIX43SecurityTypeRequest}
	FIX43SecurityTypeRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX43", Format: FIX43SecurityTypeRequest}
)

// FIX43SecurityTypeRequest is a FIX.4.3 format of the SecurityTypeRequest message which maps the codecs into individual fields.
var FIX43SecurityTypeRequest = f0.Format{
