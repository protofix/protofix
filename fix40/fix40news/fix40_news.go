...
var (
	FIX40NewsMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40News}
	FIX40NewsUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40News}
)

// FIX40News is a FIX.4.0 format of the News message which maps the codecs into individual fields.
var FIX40News = f0.Format{
