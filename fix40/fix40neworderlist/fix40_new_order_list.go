...
var (
	FIX40NewOrderListMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40NewOrderList}
	FIX40NewOrderListUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40NewOrderList}
)

// FIX40NewOrderList is a FIX.4.0 format of the NewOrderList message which maps the codecs into individual fields.
var FIX40NewOrderList = f0.Format{
