...
var (
	FIX40AllocationACKMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40AllocationACK}
	FIX40AllocationACKUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40AllocationACK}
)

// FIX40AllocationACK is a FIX.4.0 format of the AllocationACK message which maps the codecs into individual fields.
var FIX40AllocationACK = f0.Format{
	Fields: map[int]f0.Codec{
		...
		AllocStatus87:       f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* ACCEPTED */, 1 /* REJECTED */, 2 /* PARTIAL_ACCEPT */, 3 /* RECEIVED */), f0.Var{1, 19}},
		AllocRejCode88:      f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* UNKNOWN_ACCOUNT */, 1 /* INCORRECT_QUANTITY */, 2 /* INCORRECT_AVERAGE_PRICE */, 3 /* UNKNOWN_EXECUTING_BROKER_MNEMONIC */, 4 /* COMMISSION_DIFFERENCE */, 5 /* UNKNOWN_ORDERID */, 6 /* UNKNOWN_LISTID */, 7 /* OTHER */), f0.Var{1, 19}},
