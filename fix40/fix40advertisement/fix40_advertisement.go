...
var (
	FIX40AdvertisementMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40Advertisement}
	FIX40AdvertisementUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40Advertisement}
)

// FIX40Advertisement is a FIX.4.0 format of the Advertisement message which maps the codecs into individual fields.
var FIX40Advertisement = f0.Format{
	Fields: map[int]f0.Codec{
		...
		AdvId2:              f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		AdvTransType5:       f0.Fld{Req, f0.ASCII, f0.String("C" /* CANCEL */, "N" /* NEW */, "R" /* REPLACE */), f0.Con{1}},
		AdvRefID3:           f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
