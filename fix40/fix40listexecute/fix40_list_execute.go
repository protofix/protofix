...
var (
	FIX40ListExecuteMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40ListExecute}
	FIX40ListExecuteUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40ListExecute}
)

// FIX40ListExecute is a FIX.4.0 format of the ListExecute message which maps the codecs into individual fields.
var FIX40ListExecute = f0.Format{
