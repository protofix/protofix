...
var (
	FIX40HeartbeatMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40Heartbeat}
	FIX40HeartbeatUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40Heartbeat}
)

// FIX40Heartbeat is a FIX.4.0 format of the Heartbeat message which maps the codecs into individual fields.
var FIX40Heartbeat = f0.Format{
