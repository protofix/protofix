...
var (
	FIX40LogoutMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40Logout}
	FIX40LogoutUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40Logout}
)

// FIX40Logout is a FIX.4.0 format of the Logout message which maps the codecs into individual fields.
var FIX40Logout = f0.Format{
