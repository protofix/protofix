...
package fix40ordercancelreplacerequest
...
var (
	FIX40OrderCancelReplaceRequestMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40OrderCancelReplaceRequest}
	FIX40OrderCancelReplaceRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40OrderCancelReplaceRequest}
)

// FIX40OrderCancelReplaceRequest is a FIX.4.0 format of the OrderCancelReplaceRequest message which maps the codecs into individual fields.
var FIX40OrderCancelReplaceRequest = f0.Format{
