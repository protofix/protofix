...
package fix40ordercancelreject
...
var (
	FIX40OrderCancelRejectMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40OrderCancelReject}
	FIX40OrderCancelRejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40OrderCancelReject}
)

// FIX40OrderCancelReject is a FIX.4.0 format of the OrderCancelReject message which maps the codecs into individual fields.
var FIX40OrderCancelReject = f0.Format{
