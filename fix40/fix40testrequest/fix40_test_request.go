...
var (
	FIX40TestRequestMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40TestRequest}
	FIX40TestRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40TestRequest}
)

// FIX40TestRequest is a FIX.4.0 format of the TestRequest message which maps the codecs into individual fields.
var FIX40TestRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		TestReqID112:        f0.Fld{Req, f0.ASCII, f0.String(), f0.Con{1}},
