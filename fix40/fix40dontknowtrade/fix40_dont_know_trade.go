...
var (
	FIX40DontKnowTradeMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40DontKnowTrade}
	FIX40DontKnowTradeUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40DontKnowTrade}
)

// FIX40DontKnowTrade is a FIX.4.0 format of the DontKnowTrade message which maps the codecs into individual fields.
var FIX40DontKnowTrade = f0.Format{
	Fields: map[int]f0.Codec{
		...
		ExecID17:            f0.Fld{Opt, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
