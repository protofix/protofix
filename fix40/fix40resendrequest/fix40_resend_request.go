...
var (
	FIX40ResendRequestMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40ResendRequest}
	FIX40ResendRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40ResendRequest}
)

// FIX40ResendRequest is a FIX.4.0 format of the ResendRequest message which maps the codecs into individual fields.
var FIX40ResendRequest = f0.Format{
