...
var (
	FIX40QuoteRequestMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40QuoteRequest}
	FIX40QuoteRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40QuoteRequest}
)

// FIX40QuoteRequest is a FIX.4.0 format of the QuoteRequest message which maps the codecs into individual fields.
var FIX40QuoteRequest = f0.Format{
	Fields: map[int]f0.Codec{
		...
		Side54:              f0.Fld{Opt, f0.ASCII, f0.String("1" /* BUY */, "2" /* SELL */, "3" /* BUY_MINUS */, "4" /* SELL_PLUS */, "5" /* SELL_SHORT */, "6" /* SELL_SHORT_EXEMPT */), f0.Con{1}},
