...
var (
	FIX40SequenceResetMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40SequenceReset}
	FIX40SequenceResetUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40SequenceReset}
)

// FIX40SequenceReset is a FIX.4.0 format of the SequenceReset message which maps the codecs into individual fields.
var FIX40SequenceReset = f0.Format{
