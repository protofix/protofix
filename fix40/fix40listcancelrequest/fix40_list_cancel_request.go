...
package fix40listcancelrequest
...
var (
	FIX40ListCancelRequestMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40ListCancelRequest}
	FIX40ListCancelRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40ListCancelRequest}
)

// FIX40ListCancelRequest is a FIX.4.0 format of the ListCancelRequest message which maps the codecs into individual fields.
var FIX40ListCancelRequest = f0.Format{
