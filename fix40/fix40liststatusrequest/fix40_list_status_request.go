...
package fix40liststatusrequest
...
var (
	FIX40ListStatusRequestMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40ListStatusRequest}
	FIX40ListStatusRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40ListStatusRequest}
)

// FIX40ListStatusRequest is a FIX.4.0 format of the ListStatusRequest message which maps the codecs into individual fields.
var FIX40ListStatusRequest = f0.Format{
