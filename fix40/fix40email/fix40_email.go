...
var (
	FIX40EmailMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40Email}
	FIX40EmailUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40Email}
)

// FIX40Email is a FIX.4.0 format of the Email message which maps the codecs into individual fields.
var FIX40Email = f0.Format{
	Fields: map[int]f0.Codec{
		...
		RelatdSym46:         f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{1}},
		OrderID37:           f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{1}},
		ClOrdID11:           f0.Fld{Opt, f0.ASCII, f0.String(), f0.Con{1}},
		LinesOfText33:       f0.Fld{Req, f0.ASCII, f0.IntDefault(), f0.Var{1, 19}},
		Text58:              f0.Fld{Req, f0.ASCII, f0.String(), f0.Con{1}},
