...
var (
	FIX40ListStatusMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40ListStatus}
	FIX40ListStatusUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40ListStatus}
)

// FIX40ListStatus is a FIX.4.0 format of the ListStatus message which maps the codecs into individual fields.
var FIX40ListStatus = f0.Format{
