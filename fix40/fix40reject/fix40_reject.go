...
var (
	FIX40RejectMarshaler   = marshfix.Marshal{Tag: "FIX40", Format: FIX40Reject}
	FIX40RejectUnmarshaler = marshfix.Unmarshal{Tag: "FIX40", Format: FIX40Reject}
)

// FIX40Reject is a FIX.4.0 format of the Reject message which maps the codecs into individual fields.
var FIX40Reject = f0.Format{
