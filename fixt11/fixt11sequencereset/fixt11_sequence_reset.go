...
var (
	FIXT11SequenceResetMarshaler   = marshfix.Marshal{Tag: "FIXT11", Format: FIXT11SequenceReset}
	FIXT11SequenceResetUnmarshaler = marshfix.Unmarshal{Tag: "FIXT11", Format: FIXT11SequenceReset}
)

// FIXT11SequenceReset is a FIXT.1.1 (transport)  format of the SequenceReset message which maps the codecs into individual fields.
var FIXT11SequenceReset = f0.Format{
	Fields: map[int]f0.Codec{
		...
		GapFillFlag123:            f0.Fld{Opt, f0.ASCII, f0.BoolDefault(), f0.Con{1}},
		NewSeqNo36:                f0.Fld{Req, f0.ASCII, f0.SeqNum(), f0.Var{1, 19}},
...
const (
	...
	GapFillFlag123            = 123  // BOOLEAN
	NewSeqNo36                = 36   // SEQNUM
