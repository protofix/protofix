...
var (
	FIXT11RejectMarshaler   = marshfix.Marshal{Tag: "FIXT11", Format: FIXT11Reject}
	FIXT11RejectUnmarshaler = marshfix.Unmarshal{Tag: "FIXT11", Format: FIXT11Reject}
)

// FIXT11Reject is a FIXT.1.1 (transport)  format of the Reject message which maps the codecs into individual fields.
var FIXT11Reject = f0.Format{
	Fields: map[int]f0.Codec{
		...
		SessionRejectReason373:    f0.Fld{Opt, f0.ASCII, f0.IntDefault(0 /* INVALID_TAG_NUMBER */, 1 /* REQUIRED_TAG_MISSING */, 10 /* SENDINGTIME_ACCURACY_PROBLEM */, 11 /* INVALID_MSGTYPE */, 12 /* XML_VALIDATION_ERROR */, 13 /* TAG_APPEARS_MORE_THAN_ONCE */, 14 /* TAG_SPECIFIED_OUT_OF_REQUIRED_ORDER */, 15 /* REPEATING_GROUP_FIELDS_OUT_OF_ORDER */, 16 /* INCORRECT_NUMINGROUP_COUNT_FOR_REPEATING_GROUP */, 17 /* NON_DATA_VALUE_INCLUDES_FIELD_DELIMITER */, 2 /* TAG_NOT_DEFINED_FOR_THIS_MESSAGE_TYPE */, 3 /* UNDEFINED_TAG */, 4 /* TAG_SPECIFIED_WITHOUT_A_VALUE */, 5 /* VALUE_IS_INCORRECT */, 6 /* INCORRECT_DATA_FORMAT_FOR_VALUE */, 7 /* DECRYPTION_PROBLEM */, 8 /* SIGNATURE_PROBLEM */, 9 /* COMPID_PROBLEM */, 99 /* OTHER */), f0.Var{1, 19}},
