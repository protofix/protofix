...
var (
	FIXT11HeartbeatMarshaler   = marshfix.Marshal{Tag: "FIXT11", Format: FIXT11Heartbeat}
	FIXT11HeartbeatUnmarshaler = marshfix.Unmarshal{Tag: "FIXT11", Format: FIXT11Heartbeat}
)

// FIXT11Heartbeat is a FIXT.1.1 (transport)  format of the Heartbeat message which maps the codecs into individual fields.
var FIXT11Heartbeat = f0.Format{
