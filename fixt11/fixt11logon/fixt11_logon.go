...
var (
	FIXT11LogonMarshaler   = marshfix.Marshal{Tag: "FIXT11", Format: FIXT11Logon}
	FIXT11LogonUnmarshaler = marshfix.Unmarshal{Tag: "FIXT11", Format: FIXT11Logon}
)

// FIXT11Logon is a FIXT.1.1 (transport)  format of the Logon message which maps the codecs into individual fields.
var FIXT11Logon = f0.Format{
	Fields: map[int]f0.Codec{
		...
		EncryptMethod98:           f0.Fld{Req, f0.ASCII, f0.IntDefault(0 /* NONE_OTHER */, 1 /* PKCS */, 2 /* DES */, 3 /* PKCS_DES */, 4 /* PGP_DES */, 5 /* PGP_DES_MD5 */, 6 /* PEM_DES_MD5 */), f0.Con{1}},
		...
		TestMessageIndicator464:   f0.Fld{Opt, f0.ASCII, f0.BoolDefault(), f0.Con{1}},
		Username553:               f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		Password554:               f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		DefaultApplVerID1137:      f0.Fld{Req, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		RefMsgType372:             f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		MsgDirection385:           f0.Fld{Opt, f0.ASCII, f0.String("R" /* RECEIVE */, "S" /* SEND */), f0.Con{1}},
		RefApplVerID1130:          f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
		RefCstmApplVerID1131:      f0.Fld{Opt, f0.ASCII, f0.String(), f0.Var{1, 65536}},
	...
	Sort: []int{
		...
		Username553,               // STRING
		Password554,               // STRING
		DefaultApplVerID1137,      // STRING
		RefMsgType372,             // STRING
		MsgDirection385,           // CHAR
		RefApplVerID1130,          // STRING
		RefCstmApplVerID1131,      // STRING
...
const (
	...
	DefaultApplVerID1137      = 1137 // STRING
	RefMsgType372             = 372  // STRING
	MsgDirection385           = 385  // CHAR
	RefApplVerID1130          = 1130 // STRING
	RefCstmApplVerID1131      = 1131 // STRING
