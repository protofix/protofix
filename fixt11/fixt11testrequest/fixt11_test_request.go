...
var (
	FIXT11TestRequestMarshaler   = marshfix.Marshal{Tag: "FIXT11", Format: FIXT11TestRequest}
	FIXT11TestRequestUnmarshaler = marshfix.Unmarshal{Tag: "FIXT11", Format: FIXT11TestRequest}
)

// FIXT11TestRequest is a FIXT.1.1 (transport)  format of the TestRequest message which maps the codecs into individual fields.
var FIXT11TestRequest = f0.Format{
