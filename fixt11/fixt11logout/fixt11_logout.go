...
var (
	FIXT11LogoutMarshaler   = marshfix.Marshal{Tag: "FIXT11", Format: FIXT11Logout}
	FIXT11LogoutUnmarshaler = marshfix.Unmarshal{Tag: "FIXT11", Format: FIXT11Logout}
)

// FIXT11Logout is a FIXT.1.1 (transport)  format of the Logout message which maps the codecs into individual fields.
var FIXT11Logout = f0.Format{
